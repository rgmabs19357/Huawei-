...
#define			dma_reg_write_mask_on(reg, value)	writel(value | readl(reg), reg)
#define			dma_reg_write_mask_off(reg, value)	writel(value & readl(reg), reg)
