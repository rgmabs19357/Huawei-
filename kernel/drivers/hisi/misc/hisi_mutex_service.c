...
static struct device_attribute attributes[] = {
    ...
    __ATTR(notify_preempt_msg_mirror, 0664, notify_preempt_to_app_mirror, NULL ),
    __ATTR(notify_preempt_msg_wifi_display, 0664, notify_preempt_to_app_wifidisplay, NULL ),
    __ATTR(notify_preempt_msg_hmp, 0664, notify_preempt_to_app_hmp, NULL ),
    __ATTR(notify_app_alive_mirror, 0664, NULL, notify_alive_to_app_mirror ),
    __ATTR(notify_app_alive_wifi_display, 0664, NULL,  notify_alive_to_app_wifidisplay ),
    __ATTR(notify_app_alive_hmp, 0664, NULL,  notify_alive_to_app_hmp ),
};
...
/*****************************************************************************
 Description : 注册中心初始化函数
  ...
  1.Date: 2013/11/22
    ...
    Modification : Created function
*****************************************************************************/
static int __devinit mutex_service_probe(struct platform_device *pdev)
{
    int i = 0;
...
/*****************************************************************************
 Description : 注册中心退出函数
  ...
  1.Date: 2013/11/22
    ...
    Modification : Created function
*****************************************************************************/
static int __devexit mutex_service_remove(struct platform_device *pdev)
{
