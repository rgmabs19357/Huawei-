...
typedef struct _CCORE_IMAGE_SEC_STRU_TAG
{
    ...
    unsigned long                       uwSrcOffset;        /* 在文件中的偏移, bytes */
    unsigned long                       uwDesOffset;        /* 加载目的地址, bytes */
    unsigned long                       uwSize;             /* 段长度, bytes */
...
typedef struct _CCORE_IMAGE_HEAD_STRU_TAG
{
    ...
    unsigned long                       uwImageSize;                            /* 镜像文件大小, bytes */
    unsigned long                       uwSecNum;                               /* 文件包含段数目 */
