                ...
                unsigned int write_lvl)
{
    ...
    qos_cfg0 = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_QOSCFG0_ADDR(SOC_DDRC_AXI_BASE_ADDR, port));
    read_pri = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_RDPRI_ADDR(SOC_DDRC_AXI_BASE_ADDR, port));
    write_pri = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_WRPRI_ADDR(SOC_DDRC_AXI_BASE_ADDR, port));
...
int ddrc_set_rd_pri_apt(ddrc_port_id port, unsigned int clk_num)
{
    ...
    qos_cfg1 = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_QOSCFG1_ADDR(SOC_DDRC_AXI_BASE_ADDR, port));
                ...
                unsigned int qosh_tout)
{
    ...
    qos_timeout = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_WRQOS_ADDR(SOC_DDRC_AXI_BASE_ADDR, port));
                ...
                unsigned int qosh_tout)
{
    ...
    qos_timeout = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_RDQOS_ADDR(SOC_DDRC_AXI_BASE_ADDR, port));
                ...
                unsigned int ovfl_lvl)
{
    ...
    flux0 = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_FLUX0_ADDR(SOC_DDRC_AXI_BASE_ADDR, port));
...
int ddrc_set_ostd_mode(ddrc_port_id port, ddrc_qos_ostd_mode mode)
{
    ...
    ostdcfg2 = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_OSTDCFG2_ADDR(SOC_DDRC_AXI_BASE_ADDR));
...
int ddrc_set_ostd_lvl(ddrc_port_id port, unsigned int  port_ostd_lvl)
{
    ...
    ostdcfg0 = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_OSTDCFG0_ADDR(SOC_DDRC_AXI_BASE_ADDR, port));
...
int ddrc_set_dmc_ostd_lvl(unsigned int dmc_ostd_lvl)
{
    ...
    ostdcfg1 = DDRC_REG_MAP(SOC_MDDRC_AXI_AXI_OSTDCFG1_ADDR(SOC_DDRC_AXI_BASE_ADDR));
