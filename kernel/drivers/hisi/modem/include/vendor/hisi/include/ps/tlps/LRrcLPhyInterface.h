...
enum LRRC_LPHY_MSG_ID_ENUM
{
    ...
    /* MTC NOTCH add begin */
    ID_LRRC_LPHY_NOTCH_REQ                       = (ERRC_LPHY_MSG_HDR + 0x22), /* _H2ASN_MsgChoice LRRC_LPHY_NOTCH_BYPASS_REQ_STRU */
    /* MTC NOTCH add end */
...
{
    LRRC_LPHY_DRX_PAGING_GROUP_0          = 0,                                    /* 0：表示4个寻呼周期 */
    LRRC_LPHY_DRX_PAGING_GROUP_1,                                                 /* 1：表示2个寻呼周期 */
    LRRC_LPHY_DRX_PAGING_GROUP_2,                                                 /* 2：表示1个寻呼周期 */
    LRRC_LPHY_DRX_PAGING_GROUP_3,                                                 /* 3：表示1/2个寻呼周期 */
    LRRC_LPHY_DRX_PAGING_GROUP_4,                                                 /* 4：表示1/4个寻呼周期 */
    LRRC_LPHY_DRX_PAGING_GROUP_5,                                                 /* 5：表示1/8个寻呼周期 */
    LRRC_LPHY_DRX_PAGING_GROUP_6,                                                 /* 6：表示1/16个寻呼周期 */
    LRRC_LPHY_DRX_PAGING_GROUP_7,                                                 /* 7：表示1/32个寻呼周期 */
...
{
    LRRC_LPHY_CONN_MEAS_TYPE_INTRA        = 41,              /* Connected测量同频邻小区 */
    LRRC_LPHY_CONN_MEAS_TYPE_INTER,                          /* Connected测量异频邻小区 */
...
typedef struct
{
    ...
    LRRC_LPHY_PARA_ENABLE_ENUM_UINT16     enSpsConfigDlEnabled;                 /* SPS-ConfigurationDL有效标识 */
...
typedef struct
{
    ...
    VOS_UINT16                          ausCellIdList[LRRC_LPHY_MAX_FREQ_CELL_NUM];
...
typedef struct
{
    ...
    LRRC_LPHY_CELL_MEAS_RESULT_STRU     astCellMeasResult[LRRC_LPHY_MAX_FREQ_CELL_NUM];
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : LRRC_LPHY_CQI_CONFIG_REQ_STRU数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
