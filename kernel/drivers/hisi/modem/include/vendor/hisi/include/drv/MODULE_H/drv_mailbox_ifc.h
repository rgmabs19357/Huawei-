...
long name(_IFC_DECL##x(__VA_ARGS__) unsigned long timeout ){return 0;}

#define __IFC_GEN_EXECx(x, name, ...)		  \
long IFC_GEN_EXEC_NAME(name)(struct ifc_head * ifc_h) {return 0;}
