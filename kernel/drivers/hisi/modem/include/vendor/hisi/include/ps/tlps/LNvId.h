 ...
 ******************************************************************************
  File Name       : LNvId.h
  Description     : LNvId.h header file
  History           :
...
enum NV_ITEM_ID_ENUM
{
    ...
    EN_NV_ID_PS_BEARER_CNTXT_PARA10                 = 0xD21d,
    EN_NV_ID_UE_USIM_FEATURE                        = 0xD21e,

    EN_NV_ID_CELL_MEAS_THREDHOLD                    = 0xD220,
    EN_NV_ID_GET_SIB_THRESHOLD                      = 0xD221,
    /* CMCC-BEGIN */
    EN_NV_ID_IRAT_REDIR_SWITCH                      = 0xD222,
    /* CMCC-END */
    /* MTC add by k0228722 begin */
    EN_NV_ID_LTE_SPAC_BAND_INFO                     = 0xD223,
    EN_NV_ID_LTE_ABANDON_BAND_INFO                  = 0xD224,
    /* MTC add by k0228722 end */
    /* MTC NOTCH add by begin */
    EN_NV_ID_LTE_MTC_NOTCH_FEATURE_INFO             = 0xD225,
    /* MTC NOTCH add by end */
    EN_NV_ID_LTE_IRAT_TDS_CAPABILITY_INFO           = 0xD226,
    /* adapt filter begin */
...
/* filter the serve cell end*/
    ...
    /* MTC AREA LOST Begin */
    EN_NV_ID_TDS_AREA_LOST_THSD                     = 0xD310,
    /* MTC AREA LOST End */

    EN_NV_ID_TDS_AREA_LOST_TIMER                    = 0xD311,

    EN_NV_ID_TDS_FEATHURE_PARA                      = 0xD312,
    ...
    /* modify by h00218138, DSP NV拆分*/
    /*EN_NV_ID_DSP_RF_CFG_PARA                        = 0xD3D0,*/
    NV_ID_LPHY_RFIC_INIT_CFG_PARA                        = 0xD3D0,
    NV_ID_LPHY_RFLINECTRL_COMN_PARA                        = 0xD3D1,
    NV_ID_LPHY_RFLINECTRL_PRIV_PARA                        = 0xD3D2,
    /* end by h00218138, DSP NV拆分*/
...
/* 非标频段begin */
    ...
    EN_NV_ID_LPHY_TUNER_NV_PARA                     = 0xD3E5,
    EN_NV_ID_LTE_DRX_PARA                           = 0xD3E6,
	EN_NV_ID_DCXO_NV_ENABLE_STRU					= 0xD3E7,
	EN_NV_ID_DCXO_NV_TEMP_ADC_TABLE_STRU			= 0xD3E8,
	EN_NV_ID_DCXO_NV_TEMP_COEF_TABLE_STRU			= 0xD3E9,
	EN_NV_ID_DCXO_NV_TEMP_AFC_PARA_STRU  			= 0xD3EA,
										  
	EN_NV_ID_LPHY_LWCOEX_INIT_PARA_STRU				= 0xD3EB,
	EN_NV_ID_LPHY_TX_CMP_STRU       				    = 0xD3EC,
