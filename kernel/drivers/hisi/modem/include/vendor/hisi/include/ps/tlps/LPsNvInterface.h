...
/* gaojishan-CMAS-End */
/*y00151394-LMAC提前1ms调度*/
#define LPS_NV_LMAC_1MS_SCHED_FLG_BIT            (0x00000010)
/* lwurc 频段限制指示开关 */
...
typedef struct
{
   ...
   /*外场测试桩代码开关 0:关闭  1:打开.默认为关闭*/
    ...
    /* GCF开关组 */
    /* stPsGcfFlag01:bit0 最低位表示GCF测试开关 : 1 - 打开 0-关闭
     stPsGcfFlag01:bit1 TAU消息加密开关，0为加密，1为不加密

     stPsGcfFlag01:bit2 SR取消开关,0按协议实现,1按规避方案实现
     stPsGcfFlag01:bit3 GCF是否支持24.301 Table D.1.1中建链原因设置 1,支持，0不支持
     依次在此增加开关的说明
    */
    /* stPsGcfFlag01:bit4 用来指示安全功能是否支持测试模式，测试模式支持空完整性算法 1,支持，0不支持 */
    LPS_NV_LONG_BIT_STRU                 stPsGcfFlag01;
    LPS_NV_LONG_BIT_STRU                 stPsGcfFlag02;

    /* PS功能开关组 */
    /* stPsFunFlag01: bit0 最低位表示Band64开关 1-支持 0 -不支持
       stPsFunFlag01: bit1 表示ZZZZ开关
       依次在此增加开关的说明
    */
...
{
    /*
    stTpsLayFliterFlag01:bit0 层间消息OP_HL1_SCHEDULE_IND过滤开关: 0-过滤 1-不过滤
    stTpsLayFliterFlag01:bit1 层间消息OP_T_RRC_trafficMeasPeriod过滤开关: 0-过滤 1-不过滤
    stTPsGCFFlag01:bit0 GCF中CS语音环回控制开关: 0-关闭  1-开启
    */
...
typedef struct
{
    ...
    VOS_UINT8               ucMTCTimerLen;    /* LTE的PS迁移过程的定时器长度,取值单位:s */
    VOS_INT16               sMtcThresRsrp; /*能量门限，-141~0 */
