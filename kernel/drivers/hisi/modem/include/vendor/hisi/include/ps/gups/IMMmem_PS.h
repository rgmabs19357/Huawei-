...
#define IMM_MemAlloc(ucPoolId, ulLen)\
    IMM_MemAlloc_Debug(THIS_FILE_ID, __LINE__, (ucPoolId), (ulLen))

extern void IMM_MemFree_Debug(unsigned short usFileID, unsigned short usLineNum, IMM_MEM_STRU **pstMem);
