...
typedef struct
{
    TAF_PH_CMD_TYPE                     ucCmdType;                              /* 命令模式，0：设置命令；1：查询命令*/
    TAF_PH_ROAM_MODE                    ucRoam;                                 /* 漫游能力，0：开启国内国际漫游；1：开启国内漫游，关闭国际漫游；
                                                                                   2：关闭国内漫游，开启国际漫游；3：关闭国内国际漫游*/
...
TAF_UINT32 TAF_PhonePlmnUserSel ( MN_CLIENT_ID_T           ClientId,
                                          MN_OPERATION_ID_T        OpId,
...
/*****************************************************************************
结构名    : TAF_MMA_COPN_INFO_QUERY_REQ_STRU
结构说明  : AT+COPN查询请求结构
...
/*****************************************************************************
结构名    : TAF_MMA_COPN_INFO_QUERY_CNF_STRU
结构说明  : AT+COPN查询请求回复结构
修改历史      :
  1.日    期   : 2013年05月06日
    修改内容   : SS FDN&Call Control项目，支持+COPN命令
