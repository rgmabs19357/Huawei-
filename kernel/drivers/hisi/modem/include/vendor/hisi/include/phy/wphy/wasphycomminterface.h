...
enum PHYITF_BG_SEARCH_REQ_TYPE_ENUM
{
    PHYITF_BG_SEARCH_W_PRIORITY_PLMN            = 0,            /* _H2ASN_MsgChoice PHYITF_BG_SEARCH_W_FREQ_LIST_STRU */
    PHYITF_BG_SEARCH_G_PRIORITY_PLMN            = 1,            /* _H2ASN_MsgChoice PHYITF_BG_SEARCH_G_FREQ_LIST_STRU */

    PHYITF_BG_SEARCH_BUTT
};
typedef  VOS_UINT16 PHYITF_BG_SEARCH_REQ_TYPE_ENUM_UINT16;


enum PHYITF_BG_SEARCH_RESULT_TYPE_ENUM
{
    PHYITF_BG_SEARCH_W_SEARCH_RESULT            = 0,            /* _H2ASN_MsgChoice PHYITF_BG_SEARCH_W_CELL_INFO_STRU */
    PHYITF_BG_SEARCH_G_SEARCH_RESULT            = 1,            /* _H2ASN_MsgChoice PHYITF_BG_SEARCH_G_CELL_INFO_STRU */

    PHYITF_BG_SEARCH_RESULT_BUTT
};
typedef  VOS_UINT16 PHYITF_BG_SEARCH_RESULT_TYPE_ENUM_UINT16;

enum PHYITF_BG_SEARCH_STOP_REASON_TYPE_ENUM
{
    PHYITF_BG_SEARCH_STOP           = 0,
    PHYITF_BG_SEARCH_SUSPEND        = 1,

    PHYITF_BG_SEARCH_STOP_REASON_BUTT
};
typedef  VOS_UINT16 PHYITF_BG_SEARCH_STOP_REASON_TYPE_ENUM_UINT16;
...
enum    RRC_PHY_MSG_ID_ENUM
{
    ...
    ID_RRC_PHY_DIRECT_TRANSF_DATA_REQ                       = 0x1016,   /* _H2ASN_MsgChoice RRC_PHY_DIRECT_TRANSF_DATA_REQ_STRU */
    ...
    ID_RRC_PHY_DSP_LOAD_BEFORE_PRACH                        = 0x1030,   /* _H2ASN_MsgChoice RRC_PHY_LOAD_DSP_BEFORE_PRACH_REQ_STRU */
    ...
    /* 周期接收SIB7新增接口------ end */
    ID_RRC_PHY_L_BG_SEARCH_REQ                              = 0x1035,   /* _H2ASN_MsgChoice RRC_PHY_L_BG_SEARCH_REQ_STRU */
    /* DSP低功耗需求 */
    ...
    ID_PHY_RRC_BSIC_VERIFIED_IND                            = 0x0004,   /* _H2ASN_MsgChoice PHY_RRC_BSIC_VERIFIED_IND_STRU */
...
/* V3 R7_7C1 End */
    ...
    ID_PHY_RRC_DSP_LOAD_BEFORE_PRACH_CNF                    = 0x3225,   /* _H2ASN_MsgChoice PHY_RRC_DSP_LOAD_BEFORE_PRACH_CNF_STRU */
    ...
    ID_PHY_RRC_DIRECT_TRANSF_DATA_IND                       = 0x3508,   /* _H2ASN_MsgChoice PHY_RRC_DIRECT_TRANSF_DATA_IND_STRU */
    ID_PHY_RRC_WCDMA_CELL_TIMING_IND                        = 0x3509,   /* _H2ASN_MsgChoice PHY_RRC_WCDMA_CELL_TIMING_IND_STRU */
    ID_PHY_RRC_L_BG_SEARCH_CNF                              = 0x350A,   /* _H2ASN_MsgChoice PHY_RRC_L_BG_SEARCH_CNF_STRU */
...
typedef struct
{
    ...
    PHYITF_FREQ_LIST_STRU                       stFreqList;             /* 当原因值为PSCH时，需要携带需要做细扫的频点 */
...
typedef struct
{
    ...
    VOS_UINT16                                  usDLFreqInfo;
    VOS_UINT16                                  usReserve1;
}PHYITF_BG_SEARCH_W_FREQ_STRU;

typedef struct
{
    PHYITF_BG_SEARCH_W_FREQ_STRU                astWFreqInfo[RRC_PHY_MAX_W_BG_SEARCH_FREQ_NUM];
}PHYITF_BG_SEARCH_W_FREQ_LIST_STRU;

typedef struct
{
    VOS_UINT16                                  usFreqInfo;
    VOS_UINT16                                  usFreqBandInd;           /*频段号，取值:dcs1800BandUsed, pcs1900BandUsed*/
}PHYITF_BG_SEARCH_G_FREQ_STRU;

typedef struct
{
    PHYITF_BG_SEARCH_G_FREQ_STRU                astGFreqInfo[RRC_PHY_MAX_G_BG_SEARCH_FREQ_NUM];
}PHYITF_BG_SEARCH_G_FREQ_LIST_STRU;
...
typedef struct
{
    ...
    RRC_PHY_MSG_ID_ENUM_UINT16                  enMsgID;                /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                                  usOPID;                 /* 操作标识 */
    VOS_INT16                                   sRSCPThreshold;         /* 背景搜W高优先级plmn的RSCP最低门限 */
    VOS_INT16                                   sECNOThreshold;         /* 背景搜W高优先级plmn的ECNO最低门限 */
    VOS_INT16                                   sGsmRSSIThreshold;      /* 背景搜G高优先级plmn的RSSI最低门限 */
    VOS_UINT16                                  usFreqCnt;              /* 频率列表中频点的数目*/
    VOS_UINT16                                  usReserve1;
    PHYITF_BG_SEARCH_REQ_TYPE_ENUM_UINT16       enBgSearchTypeChoice;  /* _H2ASN_IeChoice_Export PHYITF_BG_SEARCH_REQ_TYPE_ENUM_UINT16 */
    union           /*_H2ASN_Skip*/
    {               /*_H2ASN_Skip*/
        PHYITF_BG_SEARCH_W_FREQ_LIST_STRU       stWFreqInfoList;  /*_H2ASN_Skip*/
        PHYITF_BG_SEARCH_G_FREQ_LIST_STRU       stGFreqInfoList;
        /******************************************************************************************************
            _H2ASN_IeChoice_When        PHYITF_BG_SEARCH_REQ_TYPE_ENUM_UINT16
        ******************************************************************************************************/
    } u;                                                            /* _H2ASN_Skip */

}RRC_PHY_BG_SEARCH_REQ_STRU;
...
typedef struct
{
    ...
    RRC_PHY_MSG_ID_ENUM_UINT16                          enMsgID;              /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                                          usOPID;               /* 操作标识 */
    PHYITF_BG_RESULT_TYPE_ENUM_UINT16                   usResult;             /* 搜索结果，返回结果为false即为DRX周期不支持背景搜 */
    VOS_UINT16                                          usReserve1;
}PHY_RRC_BG_SEARCH_CNF_STRU;
#endif

typedef struct
{
    VOS_UINT16                          usFreqInfo;                 /* W背景搜成功，搜到的频点信息*/
    VOS_UINT16                          usPrimaryScramCode;         /* W背景搜成功，搜到的扰码信息*/
    VOS_INT16                           sCpichRscp;                 /* W背景搜成功，搜到的小区CPICH RSCP测量值 */
    VOS_INT16                           sCpichEcN0;                 /* W背景搜成功，搜到的小区CPICH EcN0测量值 */
}PHYITF_BG_SEARCH_W_CELL_INFO_STRU;

typedef struct
{
    VOS_UINT16                          usFreqInfo;                 /* G背景搜成功，搜到的频点信息*/
    VOS_UINT16                          usFreqBandInd;              /*频带指示*/
    VOS_INT16                           sGSMRssi;                 /* G背景搜成功，搜到的小区CPICH RSCP测量值 */
    VOS_UINT16                          usReserve1;
}PHYITF_BG_SEARCH_G_CELL_INFO_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                                          usOPID;                   /* 操作标识 */
    PHYITF_BG_RESULT_TYPE_ENUM_UINT16                   usResult;                 /* 搜索结果 */
    PHYITF_BG_SEARCH_RESULT_TYPE_ENUM_UINT16            enBgSearchResultTypeChoice;  /* _H2ASN_IeChoice_Export PHYITF_BG_SEARCH_RESULT_TYPE_ENUM_UINT16 */
    union                                                                       /* _H2ASN_Skip */
    {                                                                           /* _H2ASN_Skip */
        PHYITF_BG_SEARCH_W_CELL_INFO_STRU    stWCellInfo;
        PHYITF_BG_SEARCH_G_CELL_INFO_STRU    stGCellInfo;
        /******************************************************************************************************
            _H2ASN_IeChoice_When        PHYITF_BG_SEARCH_RESULT_TYPE_ENUM_UINT16
        ******************************************************************************************************/
    } u;                                                                        /* _H2ASN_Skip */
}PHY_RRC_BG_SEARCH_IND_STRU;
...
typedef struct
{
    ...
    RRC_PHY_MSG_ID_ENUM_UINT16          enMsgID;                /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                          usOPID;                 /* 操作标识 */
}RRC_PHY_LOAD_DSP_BEFORE_PRACH_REQ_STRU;


/*****************************************************************************
 结构名    : PHY_RRC_DSP_LOAD_BEFORE_PRACH_CNF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 加载PRACH物理层响应
*****************************************************************************/
...
}PHY_RRC_DSP_LOAD_BEFORE_PRACH_CNF_STRU;
