...
typedef struct
{
    UCOM_NV_RF_CONFIG_STRU              astGsmRxRfBandConfig[UCOM_NV_G_BAND_NUM];           /* 包括了2G RX 所有频段 */

    UCOM_NV_RF_CONFIG_STRU              astGsmTxRfBandConfig[UCOM_NV_G_BAND_NUM];           /* 包括了2G TX 频段 */
...
typedef struct
{
    PHY_UINT16                           uhwGsmVirtualBand;                     /* 0-不支持; 1-支持 */
