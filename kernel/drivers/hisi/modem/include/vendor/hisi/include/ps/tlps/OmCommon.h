...
typedef struct
{
    ...
    /*More to add*/
    VOS_UINT8                                 ucScellConfigType[TL_OM_LMAC_CA_MAX_RPT_CELL_NUM];
    VOS_UINT8                                 ucScellStatusType[TL_OM_LMAC_CA_MAX_RPT_CELL_NUM];
    VOS_UINT32                                ulScellDeactTimer[TL_OM_LMAC_CA_MAX_RPT_CELL_NUM];
