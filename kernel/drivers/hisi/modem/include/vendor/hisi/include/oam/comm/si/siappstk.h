...
#define SI_AT_CMD_SETUP_MENU            0
#define SI_AT_CMD_DISPLAY_TEXT          1
#define SI_AT_CMD_GET_INKEY             2
#define SI_AT_CMD_GET_INPUT             3
#define SI_AT_CMD_SETUP_CALL            4
#define SI_AT_CMD_PLAY_TONE             5
#define SI_AT_CMD_SELECT_ITEM           6
#define SI_AT_CMD_REFRESH               7
#define SI_AT_CMD_SEND_SS               8
#define SI_AT_CMD_SEND_SMS              9
#define SI_AT_CMD_SEND_USSD             10
#define SI_AT_CMD_LAUNCH_BROWSER        11
#define SI_AT_CMD_SETUP_IDLE_MODE_TEXT  12
#define SI_AT_CMD_LANGUAGENOTIFICATION  20   /*暂时定为20，待APP开发该SAT功能后确认接口*/
#define SI_AT_CMD_SETFRAMES             21   /*暂时定为21，待APP开发该SAT功能后确认接口*/
#define SI_AT_CMD_GETFRAMESSTATUS       22   /*暂时定为22，待APP开发该SAT功能后确认接口*/
#define SI_AT_CMD_END_SESSION           99
...
typedef SI_UINT8 STK_CALLBACK_EVENT;
...
typedef SI_UINT32 SI_STK_EVENT_TYPE;
...
typedef SI_UINT32 SI_STK_ENVELOPE_TYPE;
...
typedef SI_UINT32 SI_STK_CMD_TYPE;
...
typedef SI_UINT8 SI_STK_RESULT;
...
typedef SI_UINT8 SI_STK_ADD_INFO_TERMINAL_PROBLEM_ENUM8;
...
typedef SI_UINT8 SI_STK_ADD_INFO_WITH_CALL_CONTROL_ENUM8;
...
typedef SI_UINT8 SI_STK_ADD_INFO_WITH_NETWORK_PROBLEM_ENUM8;
...
typedef SI_UINT8 SI_STK_ADD_INFO_FOR_SS_USSD_SMS_PROBLEM_ENUM8;
...
typedef SI_UINT32 SI_SEND_DATA_TYPE;
...
typedef SI_UINT32   SI_STK_CTRL_RESULT;
...
typedef SI_UINT8   SI_STK_ME_STATUS;
...
typedef struct
{
    SI_UINT8                ucCommandNum;
    SI_UINT8                ucCommandType;
    SI_UINT8                ucCommandQua;
    SI_UINT8                ucRsv;
...
typedef struct
{
    SI_UINT8                ucIconlistQua;
    SI_UINT8                ucLen;
    SI_UINT8                aucRsv[2];
    SI_UINT8*               pucIconIdlist;
...
{
    SI_UINT32               ulLen;
    SI_UINT8*               pucProvsionRef;
}SI_STK_PRO_REFERENCE_FILE_STRU;

typedef struct
{
    SI_UINT8                ucBearerType;
    SI_UINT8                ucLen;
    SI_UINT8                aucRsv[2];
    SI_UINT8*               pucBearer;
...
{
    SI_UINT32               ulLen;
    SI_UINT8*               pucChannelData;
}SI_STK_CHANNEL_DATA_STRU;

typedef struct
{
    SI_UINT8                aucBufferSize[2];
    SI_UINT8                aucRsv[2];
...
{
    SI_UINT32               ulLen;
    SI_UINT8*               pucNetworkAccessName;
}SI_STK_NETWORK_ACCESS_ANME_STRU;

typedef struct
{
    SI_UINT32               ulLen;
    SI_UINT8*               pucBufferReader;
}SI_STK_BUFFER_CARD_READER_IDENTIFIER_STRU;

typedef struct
{
    SI_UINT8                ucTransType;
    TAF_UINT8               ucPortNum[2];
    SI_UINT8                ucRsv;
}SI_STK_UICC_TERMINAL_TRANLEVEL_STRU;

typedef struct
{
    SI_UINT8                ucBarerTech;
    SI_UINT8                ucLen;
    SI_UINT8                aucRsv[2];
    SI_UINT8*               pucDeviceFilter;
}SI_STK_DEVICE_FILTER_STRU;

typedef struct
{
    SI_UINT8                ucLocBerTechID;
    SI_UINT8                ucLen;
    SI_UINT8                aucRsv[2];
    SI_UINT8*               pucServRecord;
...
typedef struct
{
    SI_UINT8                ucChannelLen;
    SI_UINT8                aucRsv[3];
}SI_STK_CHANNEL_DATA_LENGTH_STRU;

typedef struct
{
    SI_UINT8                ucChannelStatus[2];
    SI_UINT8                aucRsv[2];
...
{
    SI_UINT32               ucLen;
    SI_UINT8*               pucBrowseStatus;
}SI_STK_BROWSING_STATUS_STRU;

typedef struct
{
    SI_UINT32               ulLen;
    SI_UINT8*               pucOplmnList;
...
{
    SI_UINT32                       OP_Text:1;
    SI_UINT32                       OP_IconId:1;
    SI_UINT32                       OP_Duration:1;
    SI_UINT32                       OP_TextAttr:1;
    SI_UINT32                       OP_ImmediateRsp:1;
    SI_UINT32                       OP_FrameId:1;
    SI_UINT32                       OP_Reserved:26;
...
{
    SI_UINT32                       OP_Text:1;
    SI_UINT32                       OP_RpLen:1;
    SI_UINT32                       OP_DefaultText:1;
    SI_UINT32                       OP_IconId:1;
    SI_UINT32                       OP_TextAttr:1;
    SI_UINT32                       OP_FrameId:1;
    SI_UINT32                       OP_Reserved:26;
...
{
    SI_UINT32                               OP_AlphaID:1;
    SI_UINT32                               OP_INAIndicator:1;
    SI_UINT32                               OP_IconId:1;
    SI_UINT32                               OP_IIIlist:1;
    SI_UINT32                               OP_TextAttr:1;
    SI_UINT32                               OP_ITAList:1;
    SI_UINT32                               OP_Item:1;
    SI_UINT32                               OP_Reserved:25;
...
typedef struct
{
    ...
    SI_UINT32                               OP_TextAttr:1;
    SI_UINT32                               OP_ITAList:1;
    SI_UINT32                               OP_ItemIDTag:1;
    SI_UINT32                               OP_FrameId:1;
    SI_UINT32                               OP_ItemId:1;
    SI_UINT32                               OP_Reserved:23;
...
{
    SI_UINT32                       OP_AlphaId:1;
    SI_UINT32                       OP_SSStr:1;
    SI_UINT32                       OP_IconId:1;
    SI_UINT32                       OP_TextAttr:1;
    SI_UINT32                       OP_Reserved:28;
...
typedef struct
{
    SI_UINT32                       OP_AlphaId:1;
    SI_UINT32                       OP_Addr:1;
    SI_UINT32                       OP_CCPara:1;
    SI_UINT32                       OP_Subaddr:1;
    SI_UINT32                       OP_Duration:1;
    SI_UINT32                       OP_IconId:1;
    SI_UINT32                       OP_TextAttr:1;
    SI_UINT32                       OP_AlphaId2:1;
    SI_UINT32                       OP_IconId2:1;
    SI_UINT32                       OP_TextAttr2:1;
    SI_UINT32                       OP_FrameId:1;
    SI_UINT32                       OP_Reserved:21;
...
typedef struct
{
    SI_UINT32                       OP_FileList:1;
    SI_UINT32                       OP_AID:1;
    SI_UINT32                       OP_Alpha:1;
    SI_UINT32                       OP_IconID:1;
    SI_UINT32                       OP_TextAttr:1;
    SI_UINT32                       OP_FrameId:1;
    SI_UINT32                       OP_OplmnList:1;
    SI_UINT32                       OP_Reserved:25;
...
typedef struct
{
    SI_UINT32                       OP_TimerID:1;
    SI_UINT32                       OP_TimerValue:1;
    SI_UINT32                       OP_Reserved:30;
...
typedef struct
{
    SI_UINT32                       OP_BrowserId:1;
    SI_UINT32                       OP_URL:1;
    SI_UINT32                       OP_Bearer:1;
    SI_UINT32                       OP_Texstr:1;
    SI_UINT32                       OP_AlphaId:1;
    SI_UINT32                       OP_IconId:1;
    SI_UINT32                       OP_TextAttr:1;
    SI_UINT32                       OP_FrameId:1;
    SI_UINT32                       OP_PFRef:1;
    SI_UINT32                       OP_Reserved:23;
...
typedef struct
{
    ...
    SI_UINT32                           OP_Addr:1;
    SI_UINT32                           OP_Subaddr:1;
    SI_UINT32                           OP_Duration1:1;
    SI_UINT32                           OP_BearerDesp:1;
    SI_UINT32                           OP_BufSize:1;
    SI_UINT32                           OP_NetworkAccName:1;
    SI_UINT32                           OP_Textstr1:1;
    SI_UINT32                           OP_UTITLevel:1;
    SI_UINT32                           OP_TextAttr:1;
    SI_UINT32                           OP_OtherAddr1:1;
    SI_UINT32                           OP_FrameId:1;
    SI_UINT32                           OP_Duration2:1;
    SI_UINT32                           OP_Textstr2:1;
    SI_UINT32                           OP_OtherAddr2:1;
    SI_UINT32                           OP_Reserved:16;
...
typedef struct
{
    SI_UINT32                       OP_AlphaId:1;
    SI_UINT32                       OP_IconId:1;
    SI_UINT32                       OP_Service:1;
    SI_UINT32                       OP_DeviceFilter:1;
    SI_UINT32                       OP_TextAttr:1;
    SI_UINT32                       OP_FrameId:1;
    SI_UINT32                       OP_Reserved:26;
...
typedef struct
{
    SI_UINT32                           OP_FrameLayout:1;
    SI_UINT32                           OP_FrameId1:1;
    SI_UINT32                           OP_FrameId2:1;
    SI_UINT32                           OP_Reserved:29;
...
typedef struct
{
    SI_UINT32                           OP_AlphaId:1;
    SI_UINT32                           OP_IconId:1;
    SI_UINT32                           OP_MMRef:1;
    SI_UINT32                           OP_FileList:1;
    SI_UINT32                           OP_MMCId:1;
    SI_UINT32                           OP_MMId:1;
    SI_UINT32                           OP_TextAttr:1;
    SI_UINT32                           OP_Reserved:25;
...
typedef struct
{
    SI_UINT32                       OP_LocInfo:1;
    SI_UINT32                       OP_IMEI:1;
    SI_UINT32                       OP_NMResults:1;
    SI_UINT32                       OP_DTTZone:1;
    SI_UINT32                       OP_Language:1;
    SI_UINT32                       OP_AccessTech:1;
    SI_UINT32                       OP_ESN:1;
    SI_UINT32                       OP_IMEISV:1;
    SI_UINT32                       OP_NSMode:1;
    SI_UINT32                       OP_BatteryState:1;
    SI_UINT32                       OP_Reserved:22;
...
typedef struct
{
    SI_UINT32                                 OP_CCRAction:1;
    SI_UINT32                                 OP_Result2:1;
    SI_UINT32                                 OP_TestStr2:1;
    SI_UINT32                                 OP_Reserved:29;
...
typedef struct
{
    SI_UINT32                                 OP_ReadStatus:1;
    SI_UINT32                                 OP_ReadId:1;
    SI_UINT32                                 OP_Reserved:30;
...
typedef struct
{
    SI_UINT32                           OP_ChannelStatus:1;
    SI_UINT32                           OP_BearerDesp:1;
    SI_UINT32                           OP_BufferSize:1;
    SI_UINT32                           OP_OtherAddr:1;
    SI_UINT32                           OP_Reserved:28;
...
{
    SI_UINT32                           OP_ServiceRecord:1;
    SI_UINT32                           OP_REAddr:1;
    SI_UINT32                           OP_UTITlevel:1;
    SI_UINT32                           OP_RETLAddr:1;
    SI_UINT32                           OP_Reserved:28;
...
typedef struct
{
    SI_UINT32                           OP_LocaInfo:1;
    SI_UINT32                           OP_RauInfo:1;
    SI_UINT32                           OP_TauInfo:1;
    SI_UINT32                           OP_AccTech:1;
    SI_UINT32                           OP_UpdateAttachType:1;
    SI_UINT32                           OP_RejCauseCode:1;
    SI_UINT32                           OP_Reserved:26;
...
typedef struct
{
    SI_UINT32                       OP_Capability1:1;
    SI_UINT32                       OP_Subaddr:1;
    SI_UINT32                       OP_LocInfo:1;
    SI_UINT32                       OP_Capability2:1;
    SI_UINT32                       OP_BCRepInd:1;
    SI_UINT32                       OP_SepcialData:1;
    SI_UINT32                       OP_Reserved:26;
...
typedef struct
{
    SI_UINT32                       OP_Addr1:1;
    SI_UINT32                       OP_Addr2:1;
    SI_UINT32                       OP_Local:1;
    SI_UINT32                       OP_Reserved:29;
...
typedef struct
{
    SI_UINT32                           OP_MMSNotify:1;
    SI_UINT32                           LastEnvelope:1;
    SI_UINT32                           OP_Reserved:30;
...
typedef struct
{
    SI_UINT8                            ucNumType;
    SI_UINT8                            ucAddrLen;
    SI_UINT8                            aucAddr[SI_STK_ADDR_MAX_LEN];
...
typedef struct
{
    SI_UINT32                           ulAlphaLen;
    SI_UINT8                            aucAlphaId[SI_STK_DATA_MAX_LEN];
...
typedef struct
{
    ...
    SI_STK_ENVELOPE_TYPE                EnvelopeType;
    SI_UINT32                           Result;
...
typedef struct
{
    ...
    SI_UINT8                CmdQualify;
    SI_UINT32               DataLen;
    SI_UINT8                aucData[STK_PRINT_MAX_LEN];
...
extern VOS_UINT32 SI_STK_EnvelopeRsp_Decode(SI_STK_ENVELOPE_TYPE enDataType,VOS_UINT32 ulDataLen,VOS_UINT8 *pucCmdData,SI_STK_ENVELOPE_RSP_STRU *pstRspData);

extern VOS_VOID SI_STK_EnvelopeRspDataFree(SI_STK_ENVELOPE_RSP_STRU *pstData);

extern SI_UINT32 SI_STK_MenuSelection(MN_CLIENT_ID_T ClientId,MN_OPERATION_ID_T OpId,SI_STK_ENVELOPE_STRU *pstENStru);

extern SI_UINT32 SI_STK_GetMainMenu(MN_CLIENT_ID_T ClientId, MN_OPERATION_ID_T OpId);

extern SI_UINT32 SI_STK_GetSTKCommand(MN_CLIENT_ID_T ClientId,MN_OPERATION_ID_T OpId,SI_STK_CMD_TYPE CmdType);

extern SI_UINT32 SI_STK_QuerySTKCommand(MN_CLIENT_ID_T ClientId,MN_OPERATION_ID_T OpId);

extern SI_UINT32 SI_STK_TerminalResponse(MN_CLIENT_ID_T ClientId,MN_OPERATION_ID_T OpId,SI_STK_TERMINAL_RSP_STRU* pstTRStru);

/*透传参数小于0x10000为tAF模块，其余的为STK模块*/
extern SI_UINT32 SI_STK_EnvelopeDownload(VOS_UINT32 ulSenderPid,VOS_UINT32 ulSendPara,SI_STK_ENVELOPE_STRU* pstENStru);

extern SI_UINT32 SI_STK_DataSendSimple(MN_CLIENT_ID_T ClientId,MN_OPERATION_ID_T OpId, SI_SEND_DATA_TYPE SendType,SI_UINT32 ulDataLen,SI_UINT8 *paucData);

extern SI_UINT32 SI_STKDualIMSIChangeReq(MN_CLIENT_ID_T ClientId, MN_OPERATION_ID_T OpId);
...
extern SI_UINT32 WuepsSTKPidInit(enum VOS_INIT_PHASE_DEFINE InitPhrase);

extern SI_UINT32 SI_STK_CLSndTrMsg(SI_UINT32 ulDataLen, SI_UINT8 *pucData);
...
/*****************************************************************************
函 数 名  : SI_STK_EnvelopeDownload_Instance
功能描述  : STK功能ENVELOP下载函数
输入参数  : enModemID:Modem ID
            ucClientId:调用者ID
            ulSendPara:调用参数
            pstENStru:EnvelopeDownload的数据
输出参数  : 无
返 回 值  : SI_UINT32 函数执行结果
修订记录  :
1. 日    期   : 2013年5月27日
   修改内容   : Creat
*****************************************************************************/
extern SI_UINT32 SI_STK_EnvelopeDownload_Instance(
    MODEM_ID_ENUM_UINT16                enModemID,
