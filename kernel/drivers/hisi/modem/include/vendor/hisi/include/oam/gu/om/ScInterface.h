...
/*****************************************************************************
 函 数 名  : SC_PERS_NvRead
 功能描述  : 读取NV,增加IMEI验证(返回值为:SC_ERROR_CODE_NO_ERROR,读取NV内容可用，否则不可用)
 输入参数  : enModemID : 卡0或者卡1
             usID      : Nv id
             ulLength  : Nv 长度
 ...
 修改历史      :
  1.日    期   : 2013年5月25日
    修改内容   : IMEI验证
*****************************************************************************/
extern SC_ERROR_CODE_ENUM_UINT32 SC_PERS_NvRead(MODEM_ID_ENUM_UINT16                enModemID,
                                                VOS_UINT16                          usID,
                                                VOS_VOID                           *pItem,
                                                VOS_UINT32                          ulLength);
