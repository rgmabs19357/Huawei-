...
#define ID_MSG_FTM_ISMCOEXSET_REQ       (0x000109BB)
#define ID_MSG_FTM_ISMCOEXSET_CNF       (0x000109BC)
...
#define FTM_MAX_COMM_CMD_LEN 2000 /* 通用AT命令最大长度 */
...
typedef struct
{
    ...
    VOS_CHAR   cData[FTM_MAX_COMM_CMD_LEN];
