...
/* END:   Added by l00131321, 2011/6/28 */
...
typedef enum __LPHY_REQ_MSGID_UL__
{
    ...
    /* END:   Added by l00131321, 2011/6/7 */
...
typedef struct __LPHY_REQ_UL_UCI_TEST_STRU__
{
    ...
    UINT16 usBitMap;       /*bit0:   0:ACK信息无效;1:ACK信息有效
...
typedef enum __LPHY_IND_MSGID_UL__
{
    ...
    /* END:   Added by l00131321, 2011/6/8 */
...
typedef struct __LPHY_IND_UL_BASIC_INFO_STRU__
{
    ...
    UL_SRS_SYMBOL_IND_ENUM_UINT16 enSRSSymbInd;/*指示SRS在那个符号发送*/
    UINT16 usUCIInd;                           /*指示UCI的内容:Bit0:表示包含CQI报告;Bit1:表示包含ACK;Bit2:表示包含SR*/
    UINT16 usPuccdFormat;                      /*PUCCH格式*/
    UINT16 usPuschMcs;                         /*PUSCH调制方式：0:BPSK;1:QPSK;2:16QAM;3:64QAM*/
    UINT16 usPuschTB;                          /*UL-SCH的TB块长度*/
    INT16  sPucchPuschTxPower;                 /*PUCCH、PUSCH或者PRACH的发射功率，单位dBm*/
    INT16  sSRSTxPower;
...
typedef struct
{
    ...
    UL_VALID_ENUM_UINT16  enSrsSchedValid; /*SRS调度有效标识*/
...
typedef struct __LPHY_IND_UL_CTRL_INFO_STRU__
{
    ...
    UL_CUR_UCI_STRU stCurUciInfo ;      /*UCI信息结构*/
    UINT16 ausRsvd[32];
...
/* END:   Added by c00174696, 2011/11/24 */
...
typedef struct __LPHY_IND_UL_ACK_INFO_STRU__
{
    ...
    union
    {
        UL_CUR_TDD_ACK_STRU stUlCurTddAck;
        UL_CUR_FDD_ACK_STRU stUlCurFddAck;
    }unCurAck;
...
typedef struct
{
    ...
    UINT32 ulRiSchedValidCount;         /*RI调度有效计数*/
...
typedef struct
{
    ...
    /*PUCCH2_SCRAMBL_REG*/
    UINT32 ulPUCCH2_SCRAMBL   :31;                       /*PUCCH格式2扰码初相*/
    UINT32                    :1;
...
typedef struct __LPHY_IND_UL_PUSCH_CAPTURE_INFO_STRU__
{
    ...
    /* END:   Added by l00131321, 2011/8/24 */
    INT16 sPuschTransPwr;
    UINT16 usRev;
    /* END:   Added by x00195453,2012/3/21 */
    UL_OM_PUSCH_CAPTURE_PARA_STRU stPuschCaptruePara;
