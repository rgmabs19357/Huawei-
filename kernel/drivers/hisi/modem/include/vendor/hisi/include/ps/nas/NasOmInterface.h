...
typedef enum
{
    ...
    NAS_OTA_MSG_CC_RELEASE_DOWN                   = 0x0402,
    NAS_OTA_MSG_CC_RELEASE_UP                     = 0x0403,
    NAS_OTA_MSG_CC_RELEASE_COMPLETE_DOWN          = 0x0404,
    NAS_OTA_MSG_CC_RELEASE_COMPLETE_UP            = 0x0405,
    NAS_OTA_MSG_CC_CALL_PROCEEDING                = 0x0406,
    NAS_OTA_MSG_CC_ALERTING_DOWN                  = 0x0407,
    NAS_OTA_MSG_CC_ALERTING_UP                    = 0x0408,
    NAS_OTA_MSG_CC_CONNECT_DOWN                   = 0x0409,
    NAS_OTA_MSG_CC_CONNECT_UP                     = 0x040A,
    NAS_OTA_MSG_CC_CONNECT_ACK_UP                 = 0x040B,
    NAS_OTA_MSG_CC_CONNECT_ACK_DOWN               = 0x040C,
    NAS_OTA_MSG_CC_DISCONNECT_DOWN                = 0x040D,
    NAS_OTA_MSG_CC_DISCONNECT_UP                  = 0x040E,
    NAS_OTA_MSG_CC_NOTIFY                         = 0x040F,
    NAS_OTA_MSG_CC_HOLD_ACK                       = 0x0410,
    NAS_OTA_MSG_CC_HOLD_REJ                       = 0x0411,
    NAS_OTA_MSG_CC_RETREIVE_ACK                   = 0x0412,
    NAS_OTA_MSG_CC_RETREIVE_REJ                   = 0x0413,
    NAS_OTA_MSG_CC_MODIFY_DOWN                    = 0x0414,
    NAS_OTA_MSG_CC_MODIFY_UP                      = 0x0415,
    NAS_OTA_MSG_CC_MODIFY_COMPLETE_DOWN           = 0x0416,
    NAS_OTA_MSG_CC_MODIFY_COMPLETE_UP             = 0x0417,
    NAS_OTA_MSG_CC_MODIFY_REJ_DOWN                = 0x0418,
    NAS_OTA_MSG_CC_MODIFY_REJ_UP                  = 0x0419,
    NAS_OTA_MSG_CC_PROGRESS                       = 0x041A,
    NAS_OTA_MSG_CC_FACILITY_DOWN                  = 0x041B,
    NAS_OTA_MSG_CC_FACILITY_UP                    = 0x041C,
    NAS_OTA_MSG_CC_START_DTMF_ACK                 = 0x041D,
    NAS_OTA_MSG_CC_START_DTMF_REJ                 = 0x041E,
    NAS_OTA_MSG_CC_STOP_DTMF_ACK                  = 0x041F,
    NAS_OTA_MSG_CC_STATUS_ENQUIRY                 = 0x0420,
    NAS_OTA_MSG_CC_STATUS_DOWN                    = 0x0421,
    NAS_OTA_MSG_CC_STATUS_UP                      = 0x0422,
    NAS_OTA_MSG_CC_START_DTMF                     = 0x0423,
    NAS_OTA_MSG_CC_STOP_DTMF                      = 0x0424,
    NAS_OTA_MSG_CC_CALL_CONFIRM                   = 0x0425,
    NAS_OTA_MSG_CC_HOLD                           = 0x0426,
    NAS_OTA_MSG_CC_RETREIVE                       = 0x0427,
    NAS_OTA_MSG_CC_CCBS_ESTABLISHMENT             = 0x0428,
    NAS_OTA_MSG_CC_CCBS_EST_CNF                   = 0x0429,
    NAS_OTA_MSG_CC_CCBS_RECALL                    = 0x042A,
...
typedef struct
{
    VOS_UINT8                           ucFuncType;                             /* 对于消息跟踪，功能类型固定填写4       */
    VOS_UINT8                           ucReserve;                              /* 保留字节                                 */
    VOS_UINT16                          usLength;                               /* 下一字节至包尾的长度，单位为Byte       */
...
extern VOS_VOID OM_AddSNTime(VOS_UINT32 *pulSN, VOS_UINT32 *pulTimeStamp);
