...
/*****************************************************************************
  2 宏定义
*****************************************************************************/
#define RRC_MAX_FORBLA_NUM              (16)                /* 禁止注册区的最大的个数 */
...
/* MM发给AS的原语 */
    ...
    GRRGMM_GPRS_PROC_IND                = 0x0040,   /* _H2ASN_MsgChoice GRRGMM_GPRS_PROC_IND_ST */
    ...
    RRMM_REL_CS_PS_ALL_CONN_REQ         = 0x0076,   /* _H2ASN_MsgChoice RRMM_REL_CS_PS_ALL_CONN_REQ_STRU */
...
/* Begin: Added by s46746, 2006-4-30  for A32D03210*/
    MMC_RESUME_GPRS_SUSPENSION          = 0x02,
/* End:   Added by s46746, 2006-4-30 */
...
/*****************************************************************************
 枚举名    : GRRGMM_GPRS_PROC_TYPE_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : GPRS启动过程描述
*****************************************************************************/
enum GRRGMM_GPRS_PROC_TYPE_ENUM
{
    GRRGMM_GPRS_PROC_TYPE_ATTACH        = 0, /*注册, 包括单独PS注册和组合注册*/
    GRRGMM_GPRS_PROC_TYPE_NORMAL_RAU    = 1, /*正常路由区更新,包含单独PS路由区更新和组合路由区更新*/
    GRRGMM_GPRS_PROC_TYPE_PERIOD_RAU    = 2, /*周期性路由区更新,包含单独PS路由区更新和组合路由区更新*/
    GRRGMM_GPRS_PROC_TYPE_INVALID       = 3  /*无效的类型*/
};

typedef VOS_UINT16 GRRGMM_GPRS_PROC_TYPE_ENUM_UINT16;

/*****************************************************************************
 枚举名    : GRRGMM_GPRS_PROC_RESULT_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : GPRS过程类型描述
*****************************************************************************/
enum GRRGMM_GPRS_PROC_FLAG_ENUM
{
    GRRGMM_GPRS_PROC_FLAG_START       = 0, /*注册, 包括单独PS注册和组合注册*/
    GRRGMM_GPRS_PROC_FLAG_FINISH      = 1, /*正常路由区更新,包含单独PS路由区更新和组合路由区更新*/
    GRRGMM_GPRS_PROC_FLAG_INVALID     = 2  /*无效值*/
};

typedef VOS_UINT16 GRRGMM_GPRS_PROC_FLAG_ENUM_UINT16;
...
/*07-01-26 L57086 added for A32D08574 begin*/
...
/*07-01-26 L57086 added for A32D08574 end*/
#endif
...
/***********************GAS新增接口MM－>GAS********************************/
/* 7.3.12 消息 GRRGMM_GPRS_PROC_IND_ST 的结构体 */
...
{
    MSG_HEADER_STRU                     MsgHeader;          /* 消息头 */        /*_H2ASN_Skip*/
    GRRGMM_GPRS_PROC_TYPE_ENUM_UINT16   usGprsProcType;     /* GPRS过程类型 */
    GRRGMM_GPRS_PROC_FLAG_ENUM_UINT16   usGprsProcFlag;     /* GPRS过程标志 */
}GRRGMM_GPRS_PROC_IND_ST;
typedef struct
{
    MSG_HEADER_STRU                     MsgHeader;          /* 消息头 */        /*_H2ASN_Skip*/
...
/*****************************************************************************
 ...
 History        : ---
  1.Date        : ---
    Modification: ---
*****************************************************************************/
extern VOS_UINT32  GMM_GetSecurityInfo(MM_CSPS_INFO_ST *pPsInfo);
...
/*****************************************************************************
  10 函数声明
*****************************************************************************/
/*DELETE by h41410  for A32D13034 begin*/
/*
extern VOS_BOOL  RRC_GET_DrxFlag (VOS_VOID);
*/
/*DELETE by h41410  for A32D13034 END*/
