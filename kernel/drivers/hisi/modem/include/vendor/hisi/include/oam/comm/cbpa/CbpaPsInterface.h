...
enum CBPCA_MSG_TYPE_ENUM
{
    ...
    CBPCA_CSIMA_DATA_IND                = 0x10000000,       /* CBPCA向CSIMA转发的数据 */

    CMMCA_CBPCA_DATA_REQ                = 0x00000001,       /* CMMCA向CBPCA发送的数据请求 */
    CBPCA_CMMCA_DATA_IND                = 0x10000001,       /* CBPCA向CMMCA转发的数据 */

    CSIMA_CBPCA_MODEM_RESET_IND         = 0x00000002,       /* CSIMA向CBPCA发送VIA Modem复位状态指示 */

    CBPCA_MTC_DATA_IND                  = 0x10000003,       /* CBPCA向MTC转发的数据 */
