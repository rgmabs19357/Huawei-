...
/*#define ARM_DSP_R7_SHARE_MEM_CTRL_BASE_ADDR          (ECS_ARM_DSP_BUFFER_BASE_ADDR)
 */

#define ARM_DSP_R7_SHARE_MEM_DATA_BASE_ADDR          (ECS_ARM_DSP_BUFFER_BASE_ADDR)
...
/******************************************************************************
  8 结构定义
******************************************************************************/
extern VOS_UINT32 APM_GetBootInfoAddr(VOS_UINT32 *puwLen);
