...
extern VOS_UINT16 SHPA_LoadPhy( VOS_RATMODE_ENUM_UINT32 enMode, MODEM_ID_ENUM_UINT16 enModemId,UPHY_OAM_BUSINESS_TYPE_ENUM_UINT16  enBusiness );

extern VOS_UINT32 SHPA_GetRateType(MODEM_ID_ENUM_UINT16 enModemID);

extern VOS_UINT32 APM_ConfigDspNv(VOS_BOOL bNeedReReadNV);

extern VOS_UINT32 APM_ConfigGDsp1Nv(VOS_BOOL bNeedReReadNV);
