...
enum HIFI_OM_MSG_ID_ENUM
{
    ...
    ID_OM_CODEC_OM_DISCONNECT_CMD         = 0x80B3,
    ...
    ID_CODEC_OM_LOG_INFO_IND              = 0x4804,                                             /* _H2ASN_MsgChoice CODEC_OM_LOG_IND_STRU */
    ID_CODEC_OM_LOG_WARNING_IND           = 0x4805,                                             /* _H2ASN_MsgChoice CODEC_OM_LOG_IND_STRU */
    ID_CODEC_OM_LOG_ERR_IND               = 0x4806,                                             /* _H2ASN_MsgChoice CODEC_OM_LOG_IND_STRU */
...
enum OM_CODEC_EXT_CMD_ENUM
{
    ...
    OM_CODEC_EXT_AUDIO_ENHANCE_START_VOIP,
    OM_CODEC_EXT_AUDIO_ENHANCE_STOP_VOIP,
    OM_CODEC_EXT_AUDIO_ENHANCE_SET_DEVICE,
    OM_CODEC_EXT_AUDIO_ENHANCE_START_DEFAULT,
    OM_CODEC_EXT_AUDIO_ENHANCE_STOP_DEFAULT,
    OM_CODEC_EXT_AUDIO_RECORDER_START,
    OM_CODEC_EXT_AUDIO_RECORDER_STOP,
