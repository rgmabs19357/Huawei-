...
/*****************************************************************************
 ...
 枚举说明  : Client Id
  ...
  1.日    期   : 2011年10月15日
    修改内容   : 定义AT的Clientid
  2.日    期   : 2012年06月28日
    修改内容   : V7R1C50 A-GPS项目，增加定义AT HSIC 通道 4对应的端口ID值
  3.日    期   : 2012年11月23日
    修改内容   : DSDA Phase I, 增加VCOM AT的Clientid
...
/*****************************************************************************
 ...
 枚举说明  : 每个client在gastAtClientTab中index值
  ...
  2.日    期   : 2012年06月28日
    修改内容   : V7R1C50 A-GPS项目，增加定义AT HSIC 通道 4对应的index值
  3.日    期   : 2012年11月23日
    修改内容   : 增加VCOM AT每个Client对应的index值
*****************************************************************************/
