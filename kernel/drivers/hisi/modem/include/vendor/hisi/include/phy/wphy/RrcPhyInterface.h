...
#define  PHY_RRC_MAX_REPORT_INTER_RAT_CELL             (32) /*异系统测量上报时，携带的最多小区个数*/

/*End of Add by W50455*/
#define  PHY_RRC_MAX_REPORT_SEC_UL_FREQ_CELL_NUM       (32) /*同频测量上报时，携带的Second UL Freq小区最多个数*/


#define  RRC_PHY_MAX_GSM_RPT_NUM                (8)
...
#define RRC_PHY_REL_MEAS_TYPE_SLAVE_WCDMA                     0x0010
#define RRC_PHY_REL_MEAS_TYPE_SLAVE_GSM                       0x0020
...
enum    PHYITF_IDLE_MEAS_TYPE_ENUM
{
    ...
    PHYITF_IDLE_MEAS_TYPE_SLAVE_WCDMA     = 4,    /* W从模时WCDMA测量信息 */  /* _H2ASN_MsgChoice PHYITF_SLAVE_WCDMA_CELL_INFO_STRU */
    PHYITF_IDLE_MEAS_TYPE_SLAVE_GSM       = 5,    /* W从模时GSM测量信息 */  /* _H2ASN_MsgChoice PHYITF_SLAVE_GSM_CELL_INFO_STRU */
...
enum    PHYITF_CONN_MEAS_TYPE_ENUM
{
    ...
    PHYITF_CONN_MEAS_TYPE_SLAVE_WCDMA     = 4,    /* FACH态，从模测量WCDMA测量信息 */  /* _H2ASN_MsgChoice PHYITF_SLAVE_WCDMA_CELL_INFO_STRU*/
    PHYITF_CONN_MEAS_TYPE_SLAVE_GSM       = 5,    /* FACH态，从模测量GSM测量信息 */  /* _H2ASN_MsgChoice PHYITF_SLAVE_GSM_CELL_INFO_STRU*/
...
enum PHYITF_CONNECT_MEAS_REQ_TYPE_ENUM
{
    ...
    PHYITF_CONNECT_MEAS_REQ_INTERRAT        = 45,                               /* _H2ASN_MsgChoice PHYITF_INTER_RAT_MEASURE_STRU */
    ...
    PHYITF_CONNECT_MEAS_REQ_SLAVE_WCDMA     = 48,                               /* _H2ASN_MsgChoice PHYITF_SLAVE_WCDMA_CELL_INFO_STRU */
    PHYITF_CONNECT_MEAS_REQ_SLAVE_GSM       = 49,                               /* _H2ASN_MsgChoice PHYITF_SLAVE_GSM_CELL_INFO_STRU */
...
enum PHYITF_CONNECT_MEAS_IND_TYPE_ENUM
{
    ...
    PHYITF_CONNECT_MEAS_IND_INTER_RAT_CELL      = 55,           /* _H2ASN_MsgChoice PHYITF_INTER_RAT_REPORT_STRU  */
    PHYITF_CONNECT_MEAS_IND_SLAVE_WCDMA         = 56,           /* _H2ASN_MsgChoice PHYITF_SLAVE_WCDMA_MEAS_REPORT_STRU  */
    PHYITF_CONNECT_MEAS_IND_SLAVE_GSM           = 57,           /* _H2ASN_MsgChoice PHYITF_SLAVE_GSM_MEAS_REPORT_STRU */
...
/*****************************************************************************
 结构名    : PHYITF_GSM_CELL_INFO_ITEM_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM 小区信息
 *****************************************************************************/
typedef struct
{
    VOS_INT16                           sCellID;                    /*小区ID*/
    VOS_UINT16                          usFreqBandInd;              /*频带指示*/
    VOS_UINT16                          usBcchArfcn;                /*GSM的载频号*/
    VOS_INT16                           sOffset1;
    VOS_INT16                           sOffset2;
    VOS_INT16                           sQrxlevmincompensation;

    VOS_UINT16                          usFreqPriority;         /* 当W为从模时，此值为0. */
    VOS_UINT16                          usReserve1;
}PHYITF_GSM_CELL_INFO_ITEM_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                          usReserve1;
    PHYITF_GSM_CELL_INFO_ITEM_STRU      astGSMCellInfo[RRC_PHY_MAX_INTER_RAT_CELL];
...
typedef struct
{
    ...
    PHYITF_INTER_FREQ_CELL_INFO_ITEM_STRU       astInterFreqCell[RRC_PHY_MAX_SLAVE_WCDMA_CARRIER_NUM];
}PHYITF_SLAVE_WCDMA_CELL_INFO_STRU;

/*****************************************************************************
 结构名    : PHYITF_SLAVE_GSM_CELL_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : W为从模时，LTE测量GSM小区信息

*****************************************************************************/
typedef struct
{
    VOS_UINT16                              usArfcnNum;     /*需要测量的GSM频点数量 */
    VOS_UINT16                              usMgsmNum;

    PHYITF_GSM_CELL_INFO_ITEM_STRU          astGSMCellInfo[RRC_PHY_MAX_SLAVE_GSM_CARRIER_NUM];
}PHYITF_SLAVE_GSM_CELL_INFO_STRU;
...
typedef struct
{
    ...
    {/*_H2ASN_Skip*/
        ...
        PHYITF_INTER_RAT_LTE_CELL_INFO_STRU stInterRatLteCellEntity;            /* _H2ASN_Skip W为主模时，测量LTE邻区 */
        PHYITF_SLAVE_WCDMA_CELL_INFO_STRU   stSlaveWcdmaCellEntity;             /* _H2ASN_Skip W为从模时，LTE IDLE下测量W小区的内容 */
        PHYITF_SLAVE_GSM_CELL_INFO_STRU     stSlaveGsmCellEntity;               /* W为从模时，LTE IDLE下测量G小区的内容 */
        /******************************************************************************************************
...
/*****************************************************************************
 结构名    : PHYITF_GSM_CELL_RESULT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 每个GSM小区测量结果
 *****************************************************************************/
typedef struct
{
    ...
    VOS_UINT16                          usFreqBandInd;        /* GSM的频带指示 */
} PHYITF_GSM_CELL_RESULT_STRU;

/*****************************************************************************
 结构名    : PHYITF_INTER_RAT_RESULT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 异系统测量结果
 *****************************************************************************/
typedef struct
{
    VOS_UINT16                          usGSMCarrierNum;      /*物理层测量得到GSM载波的数量*/
    VOS_UINT16                          usReserve1;
    PHYITF_GSM_CELL_RESULT_STRU         astGSMCellResult[PHY_RRC_MAX_REPORT_INTER_RAT_CELL];   /*GSM小区的测量结果*/

}PHYITF_INTER_RAT_RESULT_STRU;


/*****************************************************************************
 结构名    : PHYITF_SLAVE_WCDMA_MEAS_RESULT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : W从模时WCDMA小区测量结果
 *****************************************************************************/
typedef struct
{
    VOS_UINT16                          usFreqNum;                              /* 报告中频间频点的个数 */
    VOS_UINT16                          usReserve1;

    PHYITF_INTER_FREQ_RESULT_ITEM_STRU  astInterFreqReport[RRC_PHY_MAX_SLAVE_WCDMA_CARRIER_NUM];
}PHYITF_SLAVE_WCDMA_MEAS_RESULT_STRU;

/*****************************************************************************
 结构名    : PHYITF_SLAVE_GSM_MEAS_RESULT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : W从模时GSM测量结果
 *****************************************************************************/
typedef struct
{
    VOS_UINT16                          usGSMCarrierNum;      /*物理层测量得到GSM载波的数量*/
    VOS_UINT16                          usReserve1;
    PHYITF_GSM_CELL_RESULT_STRU         astGSMCellResult[RRC_PHY_MAX_SLAVE_GSM_CARRIER_NUM];   /*GSM小区的测量结果*/
}PHYITF_SLAVE_GSM_MEAS_RESULT_STRU;
/*****************************************************************************
...
typedef struct
{
    ...
    #define     PHYITF_IDLE_MEAS_IND_INTER_RAT_CELL_CHOSEN  3
    #define     PHYITF_IDLE_MEAS_IND_SLAVE_WCDMA_CELL_CHOSEN   4
    #define     PHYITF_IDLE_MEAS_IND_SLAVE_GSM_CELL_CHOSEN     5
    ...
    union
    {
        ...
        PHYITF_INTER_RAT_RESULT_STRU        stInterRatResult;       /* 异系统GSM小区测量结果 */
        PHYITF_SLAVE_WCDMA_MEAS_RESULT_STRU stSlaveWcdmaMeasResult;             /* W从模时WCDMA小区测量结果 */
        PHYITF_SLAVE_GSM_MEAS_RESULT_STRU   stSlaveGsmMeasResult;               /* W从模时GSM小区测量结果 */
...
typedef struct
{
    ...
    {                                                                         /* _H2ASN_Skip */
        ...
        PHYITF_INTER_RAT_LTE_CELL_INFO_STRU stInterRatLteCellEntity;  /* _H2ASN_Skip W为主模PCH态时，测量LTE邻区 */
        PHYITF_SLAVE_WCDMA_CELL_INFO_STRU   stSlaveWcdmaCellEntity;         /* _H2ASN_Skip GU为从模时，TDS FACH态下测量W小区的内容 */
        PHYITF_SLAVE_GSM_CELL_INFO_STRU     stSlaveGsmCellEntity;           /* GU为从模时，TDS FACH态下测量G小区的内容 */
    /******************************************************************************************************
...
/*****************************************************************************
 结构名    : PHYITF_INTER_RAT_MEASURE_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 连接状态下的异系统测量结构
 *****************************************************************************/
typedef struct
{
    VOS_UINT16                          usGsmAllCellNum;                            /*知道的GSM小区的数量*/
    VOS_UINT16                          usMinIntraCellNum;                          /*可以测量的最小同频小区的数量*/
    PHYITF_GSM_CELL_INFO_ITEM_STRU      astGsmCellInfoList[RRC_PHY_MAX_INTER_RAT_CELL];   /*知道的GSM小区信息列表*/

}PHYITF_INTER_RAT_MEASURE_STRU;
...
typedef struct
{
    ...
    {                                                                                                       /* _H2ASN_Skip */
        ...
        PHYITF_INTER_RAT_MEASURE_STRU       stInterRatMeasureEntity;                /* 系统间测量的参数   */    /* _H2ASN_Skip */
        PHYITF_ADJACENT_FREQ_MEASURE_STRU   stAdjacentFreqMeasureEntity;            /* 邻频测量的参数     */    /* _H2ASN_Skip */
        PHYITF_INTER_RAT_LTE_CELL_INFO_STRU     stInterRatLteCellEntity;        /* W为主模时，测量LTE邻区 */        /* _H2ASN_Skip */
        PHYITF_SLAVE_WCDMA_CELL_INFO_STRU       stSlaveWcdmaCellEntity;         /* W为从模时，LTE下测量W小区的内容 *//* _H2ASN_Skip */
        PHYITF_SLAVE_GSM_CELL_INFO_STRU         stSlaveGsmCellEntity;           /* W为从模时，LTE下测量G小区的内容 */
        /******************************************************************************************************
...
typedef struct
{
    ...
    #define PHYITF_CELL_SEL_REPORT_INTER_RAT_CELL_CHOSEN    3
    #define PHYITF_CELL_SEL_REPORT_SLAVE_WCDMA              4
    #define PHYITF_CELL_SEL_REPORT_SLAVE_GSM                5
    ...
    union
    {
        ...
        PHYITF_INTER_RAT_RESULT_STRU    stInterRatResult;    /* 系统间小区测量结果*/
        PHYITF_SLAVE_WCDMA_MEAS_RESULT_STRU     stSlaveWcdmaMeasRpt;
        PHYITF_SLAVE_GSM_MEAS_RESULT_STRU       stSlaveGsmMeasRpt;              /* GU作为从模，TD FACH态测量G小区的测量结果 */
    }unReportResult;
...
/*****************************************************************************
 结构名    : PHYITF_INTER_RAT_REPORT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 连接状态下的异系统测量报告
 *****************************************************************************/
typedef struct
{
    VOS_UINT16                          usGsmCarrierNum;   /*报告的GSM小区的数量*/
    VOS_UINT16                          usReserve1;

    PHYITF_GSM_CELL_RESULT_STRU         astGsmCellResult[PHY_RRC_MAX_REPORT_INTER_RAT_CELL];   /*GSM小区的测量结果*/

}PHYITF_INTER_RAT_REPORT_STRU;
...
typedef struct
{
    ...
    PHYITF_INTER_FREQ_REPORT_ITEM_STRU  astInterFreqReport[RRC_PHY_MAX_SLAVE_WCDMA_CARRIER_NUM];
...
}PHYITF_SLAVE_GSM_MEAS_REPORT_STRU;
...
typedef struct
{
    ...
    {                                                                           /* _H2ASN_Skip */
        ...
        PHYITF_CELL_SEL_REPORT_STRU             stCellSelRpt;                   /* _H2ASN_Skip */
        PHYITF_INTER_RAT_REPORT_STRU            stInterRatRpt;                  /* _H2ASN_Skip */
        PHYITF_SLAVE_WCDMA_MEAS_REPORT_STRU     stSlaveWcdmaMeasRpt;            /* _H2ASN_Skip */
        PHYITF_SLAVE_GSM_MEAS_REPORT_STRU       stSlaveGsmMeasRpt;
        /******************************************************************************************************
...
/*******************************BSIC Verify 过程数据结构**************************/
/*****************************************************************************
 结构名    : PHYITF_GSM_CARRIER_INFO_STRU
 协议表格  :
 ASN.1描述 :
...
{
    VOS_INT16                           sCellID; /* 小区的ID */
    VOS_UINT16                          usObservedTimeDiffToGSMCellInd;
    VOS_UINT16                          usBcchArfcn;
    VOS_UINT16                          usFreqBandInd;

}PHYITF_GSM_CARRIER_INFO_STRU;
...
*****************************************************************************/
enum PHYITF_VERIFY_TIME_INDEX_ENUM
{
    PHYITF_VERIFY_TIME_INDEX_0                          = 0,
    PHYITF_VERIFY_TIME_INDEX_1                             ,
    PHYITF_VERIFY_TIME_INDEX_2                             ,
    PHYITF_VERIFY_TIME_INDEX_3                             ,
    PHYITF_VERIFY_TIME_INDEX_4                             ,
    PHYITF_VERIFY_TIME_INDEX_5                             ,
    PHYITF_VERIFY_TIME_INDEX_6                             ,
    PHYITF_VERIFY_TIME_INDEX_7                             ,
    PHYITF_VERIFY_TIME_INDEX_8                             ,

     PHYITF_VERIFY_TIME_INDEX_BUTT
};
typedef VOS_UINT16 PHYITF_VERIFY_TIME_INDEX_ENUM_UINT16;

/*****************************************************************************
 结构名    : RRC_PHY_BSIC_VERIFIED_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : BSIC VERIFIED 请求消息数据结构
...
typedef struct
{
    ...
    PHYITF_VERIFY_TIME_INDEX_ENUM_UINT16    enVerifyTimeIdx;
    PHYITF_GSM_CARRIER_INFO_STRU        astGSMCarrierInfo[RRC_PHY_MAX_GSM_RPT_NUM];
...
/*****************************************************************************
 结构名    : PHYITF_RRC_BSIC_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : BSIC Verify 指示中的BSIC信息
 *****************************************************************************/
typedef struct
{
    VOS_UINT16                          usNCC;              /* INTEGER(0..8)  GSM Network Colour Code           */
    VOS_UINT16                          usBCC;              /* INTEGER(0..8)  GSM Base Station Colour Code      */

} PHYITF_RRC_BSIC_INFO_STRU;


/*****************************************************************************
 结构名    : PHYITF_GSM_CARRIER_RESULT_STRU
 协议表格  :
 ASN.1描述 :
...
typedef struct
{
    VOS_INT16                           sCellID; /* 小区的ID */
    VOS_UINT16                          usReserve1;
    VOS_UINT16                          usObservedTimeDiffToGSMCell;
    VOS_UINT16                          usBcchArfcn;
    VOS_UINT16                          usFreqBandInd;
    VOS_UINT16                          usTimeAlignmt;
    PHYITF_RRC_BSIC_INFO_STRU           stBsic;
    VOS_INT32                           lFNOffset;

} PHYITF_GSM_CARRIER_RESULT_STRU;



/*****************************************************************************
 结构名    : PHY_RRC_BSIC_VERIFIED_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : BSIC VERIFIED 指示消息数据结构
...
typedef struct
{
    ...
    VOS_UINT16                          usOPID;
    VOS_UINT16                          usGsmCarrierNum;
    VOS_UINT16                          usRefActPnPrimary; /*Integer(0..511),参考激活集小区的主扰码*/
    PHYITF_GSM_CARRIER_RESULT_STRU      astGSMCarrierResult[RRC_PHY_MAX_GSM_RPT_NUM];
    PHYITF_BOOL_ENUM_UINT16             enBsicEndFlg;                           /* bsic是否验证完的标记 */
    VOS_UINT16                          ausReserve1;

} PHY_RRC_BSIC_VERIFIED_IND_STRU;
...
/*****************************************************************************
 结构名    : RRC_PHY_DATA_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : WAS透传的GAS发给WDSP的消息
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                      /*_H2ASN_Skip*/
    RRC_PHY_MSG_ID_ENUM_UINT16                  enMsgID;                /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                                  usOPID;                 /* 操作标识 */
    VOS_UINT16                                  usGasMsgSize;           /* [1,RR_PHY_MAX_MSG_SIZE],Byte */
    VOS_UINT16                                  usReserved;
    VOS_UINT16                                  ausGasMsg[RR_PHY_MAX_MSG_SIZE];   /* 需要发送给W物理层的GAS消息 */
}RRC_PHY_DIRECT_TRANSF_DATA_REQ_STRU;

/*****************************************************************************
 结构名    : PHY_RRC_DIRECT_TRANSF_DATA_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : WAS透传的WDSP发给GAS的消息
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
    RRC_PHY_MSG_ID_ENUM_UINT16                  enMsgID;                        /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                                  usOPID;                         /* 操作标识 */
    VOS_UINT16                                  usWphyMsgSize;                  /* [1,PHY_RR_MAX_MSG_SIZE],Byte */
    VOS_UINT16                                  usReserved;
    VOS_UINT16                                  ausWphyMsg[PHY_RR_MAX_MSG_SIZE];    /* 需要接收的来自W物理层发送给GAS的消息 */
}PHY_RRC_DIRECT_TRANSF_DATA_IND_STRU;
...
/* DC HSUPA END */
/*****************************************************************************
 枚举名    : PHYITF_RAT_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  : 模式类型
*****************************************************************************/
enum    PHYITF_RAT_ENUM
{
    PHYITF_RAT_WCDMA        = 0,
    PHYITF_RAT_GSM          = 1,
    PHYITF_RAT_LTE          = 2,
    PHYITF_RAT_TDSCDMA      = 3,
    PHYITF_RAT_BUTT
};
typedef VOS_UINT16 PHYITF_RAT_ENUM_UINT16;

/*****************************************************************************
 枚举名    : PHYITF_UTRAN_MODE_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  : UTRAN模式是FDD或TDD
*****************************************************************************/
enum    PHYITF_UTRAN_MODE_ENUM
{
    PHYITF_UTRAN_FDD        = 0,
    PHYITF_UTRAN_TDD        = 1,
    PHYITF_UTRAN_BUTT
};
typedef VOS_UINT16 PHYITF_UTRAN_MODE_ENUM_UINT16;


/*****************************************************************************
 枚举名    : PHYITF_REL_REASON_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  : 转发LRRC/TRRC发送过来的释放原因
*****************************************************************************/
enum PHYITF_REL_REASON_ENUM
{
    PHYITF_REL_REASON_OTHER             = 0,
    PHYITF_REL_REASON_TO_GSM            = 1,
    PHYITF_REL_REASON_BUTT
};
typedef VOS_UINT16 PHYITF_REL_REASON_ENUM_UINT16;
...
typedef struct
{
    ...
    PHYITF_RAT_ENUM_UINT16              enMasterMode;
    PHYITF_RAT_ENUM_UINT16              enSlaveMode;
    PHYITF_UTRAN_MODE_ENUM_UINT16       enUtranRatMode;         /* UTRAN模式是FDD或TDD */
    PHYITF_REL_REASON_ENUM_UINT16       enSlaveRelReason;       /* 从模测量释放原因 */
...
typedef struct
{
    ...
    VOS_UINT16                          usFreqBandNo;             /* 频段号:1,2,3,4,5,6*/
    VOS_UINT16                          usTxRxFreqSeparation;     /* 收发频差*/
    PHYITF_BOOL_ENUM_UINT16             enCellFrameExistFlg;      /* 小区帧头存在的标记 */
    PHYITF_TX_DIVER_IND_ENUM_UINT16     enPcpichTDIndicator;      /* L2W切换时Pcpich分集方式 */

    PHY_RRC_RAT_TIMING_INFO_STRU        stRatTiming;              /* 不同接入技术的定时关系 */
    PHY_RRC_WCDMA_CELL_FRAME_INFO_STRU  stCellFrameInfo;          /* 驻留小区的定时信息 */
}RRC_PHY_CAMPED_MAINCELL_REQ_STRU;
enum  PHYITF_L_BG_SEARCH_ENUM
{
    PHYITF_L_BG_SEARCH_START                                  = 0,                  /* _H2ASN_MsgChoice RRC_PHY_RL_SETUP_REQ_STRU */
    PHYITF_L_BG_SEARCH_STOP                                      ,                  /* _H2ASN_MsgChoice RRC_PHY_RL_MODIFY_REQ_STRU */
    PHYITF_L_BG_SEARCH_BUTT
};
typedef VOS_UINT16 PHYITF_L_BG_SEARCH_ENUM_UINT16;
...
typedef struct
{
    ...
    RRC_PHY_MSG_ID_ENUM_UINT16                  enMsgID;                        /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                                  usOPID;                         /* 操作标识 */
    PHYITF_L_BG_SEARCH_ENUM_UINT16              enCtrlCmd;                      /* 主模控制命令 */
    VOS_UINT16                                  usReserve;
}RRC_PHY_L_BG_SEARCH_REQ_STRU;
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
    RRC_PHY_MSG_ID_ENUM_UINT16                  enMsgID;                        /* 原语类型 */ /*_H2ASN_Skip*/
