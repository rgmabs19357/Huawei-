...
enum AT_INTER_MSG_ID_ENUM
{
    ...
    ID_AT_CMD_MODEM                     = ID_AT_CMD_BASE_ID + 0x03,             /* _H2ASN_MsgChoice AT_MSG_STRU */
    ID_AT_CMD_NDIS                      = ID_AT_CMD_BASE_ID + 0x04,             /* _H2ASN_MsgChoice AT_MSG_STRU */
    ...
    ID_AT_MNTN_RESULT_MODEM             = ID_AT_MNTN_RESULT_BASE_ID + 0x03,     /* _H2ASN_MsgChoice AT_MSG_STRU */
    ID_AT_MNTN_RESULT_NDIS              = ID_AT_MNTN_RESULT_BASE_ID + 0x04,     /* _H2ASN_MsgChoice AT_MSG_STRU */
    ...
    ID_AT_MNTN_RESULT_BROADCAST_MODEM_0 = ID_AT_MNTN_RESULT_BASE_ID + 0xFE,     /* _H2ASN_MsgChoice AT_MSG_STRU */
    ID_AT_MNTN_RESULT_BROADCAST_MODEM_1 = ID_AT_MNTN_RESULT_BASE_ID + 0xFF,     /* _H2ASN_MsgChoice AT_MSG_STRU */
