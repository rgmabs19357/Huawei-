...
enum TAF_CS_CAUSE_ENUM
{
    ...
    /* TAF_CS_CAUSE_DOMAIN_SELECTION_POWER_OFF删除，统一用TAF_CS_CAUSE_POWER_OFF */
...
typedef struct
{
    ...
    VOS_UINT32                          ulMcc;                                  /* MCC,3 bytes */
    MN_CALL_BCD_NUM_STRU                stEccNum;                               /* 紧急呼号码 */
    /* MN_CALL_BCD_NUM_STRU结构没有四字节对齐，下面两个字节为了填补空洞 */
    VOS_UINT8                           auReserve[2];
