...
#define SEARCH_SEND_FREQ_INFO_NUM                   ( 10 )                      /* 频点搜索时，使用原语MPH_RXLEV_CNF_STRU一次上报的最大频点数目 */
...
typedef enum
{
    ...
    ID_MPH_WCDMA_MEAS_IND                           =   0x780c,                 /* _H2ASN_MsgChoice  MPH_WCDMA_MEAS_IND_STRU */
...
/*****************************************************************************
 ...
 功能描述  :  物理层进行GAS频点的背景搜索测量的结果上报，GDSP每次最多上报10个
 修改历史  :
  1.日    期    : 2009年10月23日
    修改内容    : 新生成结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                              /* _H2ASN_Skip */ /* 消息头 */
    PHY_GAS_MSG_ID_ENUM_UINT16              usMsgID;                            /* _H2ASN_Skip */ /* 原语类型 */
    VOS_UINT16                              usFreqNum;                          /* 结果列表中的数目{0,10}*/
    RXLEV_MEAS_STRU                         astRxlevResult[SEARCH_SEND_FREQ_INFO_NUM];    /* 10个 */
