...
#if 0
/*****************************************************************************
 结构名    : APP_ESM_SET_BEARER_PROC_STATE_REQ_STRU
 结构说明  : 设置承载当前是否允许处理
*****************************************************************************/
typedef struct
{
    ...
    APP_ESM_PARA_SET_ENUM_UINT32        enSetType;
}APP_ESM_SET_BEARER_PROC_STATE_REQ_STRU;

typedef  APP_ESM_PARA_SET_CNF_STRU APP_ESM_SET_BEARER_PROC_STATE_CNF_STRU;
#endif
