...
enum WTTFVOICE_MSG_TYPE_ENUM
{
    ...
    ID_MAC_VOICE_AMR_DATA_IND           = 0x1101,           /* 未使用 */
    ID_VOICE_MAC_AMR_DATA_REQ           = 0x3101,

    WTTFVOICE_MSG_TYPE_BUTT
} ;
...
typedef struct
{
    ...
    WTTFVOICE_AMR_BANDWIDTH_TYPE_ENUM_UINT16 enCodecType;           /*0: NB;   1:WB*/
...
typedef struct
{
    ...
    WTTFVOICE_MSG_TYPE_ENUM_UINT16           enMsgName;             /* 消息ID */ /*_H2ASN_Skip*/
    VOS_UINT16                               usOpId;                /*操作标识*/
    WTTFVOICE_RSLT_ENUM_UINT16               enResult;              /*返回结果[0,1] 0:= PS_SUCC , 1:= PS_FAIL */
    ...
    WTTFVOICE_AMR_TYPE_ENUM_UINT16           enAmrType;             /*enCodecType=NB时，AMR 语音类型[0,1] 0: AMR2, 1: AMR；enCodecType=WB时此参数无意义 */
    VOS_UINT16                               ausRsv[1];
...
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
    WTTFVOICE_MSG_TYPE_ENUM_UINT16              enMsgName;          /* 消息ID */ /*_H2ASN_Skip*/
    WTTFVOICE_AMR_TYPE_ENUM_UINT16              enAmrType;          /*AMR 语音类型[0,1,2] 0: AMR2, 1: AMR, 2: AMRWB */
    VOS_UINT16                                  ausRsv[2];
