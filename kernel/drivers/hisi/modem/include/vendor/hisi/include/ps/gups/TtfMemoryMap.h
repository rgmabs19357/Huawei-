...
#define TTF_UL_CIPHER_PARA_NODE_ADDR(BaseAddr)  TTF_GET_32BYTE_ALIGN_VALUE(TTF_HDLC_MASTER_END_ADDR(BaseAddr))/* 该参数要求8字节对齐 */
#else
#define TTF_UL_CIPHER_PARA_NODE_ADDR(BaseAddr) TTF_GET_8BYTE_ALIGN_VALUE(BaseAddr) /* 该参数要求8字节对齐 */
#endif
#endif
