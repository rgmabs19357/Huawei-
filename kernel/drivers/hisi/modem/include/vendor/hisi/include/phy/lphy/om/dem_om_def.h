...
{
   DEM_PDSCH_SFBC_ALG_ADAPTIVE = 0,
   DEM_PDSCH_SFBC_ALG_FIX_MMSE,
...
typedef struct __LPHY_IND_DEM_PDSCH_MIMO_SWITCH_RPT_STRU__
{
    ...
    UINT16 usReportCnt;  
    UINT16 usReserved;    
    UINT32 ulMimoSwitchStatArray[7];
...
typedef struct __LPHY_IND_DEM_PDSCH_MCS_RB_STAT_RPT_STRU__
{
    ...
    UINT16 usReserved;
    UINT32 ulTotalRBNum;
    MCS_RB_CNT_STRU stMcsRbStatArray[32];
...
/* BEGIN: Added by wujing, 2012/9/12   PN:CMCC_DT*/
#define LPHY_DT_PDSCH_TM_MODE_INFO_REQ_DEFAULT {LPHY_OFF,200}
/* END:   Added by wujing, 2012/9/12 */
typedef struct __LPHY_DT_PDSCH_TM_MODE_INFO_REQ_STRU__
{
    OM_REQ_ENABLE_ENUM_UINT16   enEna;
    UINT16  usRptPeriod;   /* 参数修改 by wujing, 2012/9/12 */
