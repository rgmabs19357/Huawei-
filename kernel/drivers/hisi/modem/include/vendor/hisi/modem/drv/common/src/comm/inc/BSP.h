...
#else
#ifdef CHIP_BB_HI6758/*address transfer */
...
/*************************TRACE BEGIN*****************************/
void BSP_traceProcessInit(void); 
...
*                                   或者静态分配的地址
*           sciATRInfo              USIM Manager指定的Buffer，SCI Driver将ATR
*                                   Info拷贝到本Buffer。
*
*
* 返 回 值  : OK
...
/*****************************************************************************
 ...
 输入参数  : BSP_U32 regAddr --- 待读寄存器地址,ABB地址位宽为9bit,32bit留作扩展
 输出参数  : BSP_U32 * getData --- 存放寄存器值,ABB数据位宽为8bit,32bit留作扩展
...
*****************************************************************************/
BSP_S32 BSP_ABB_RegGet( BSP_U32 regAddr, BSP_U32 * getData );
/*****************************************************************************
 函 数 名  : BSP_ABB_RegSet
 功能描述  : set ABB register data
 输入参数  : BSP_U32 regAddr --- 待设置寄存器地址,ABB地址位宽为9bit,32bit留作扩展
             BSP_U32 setData --- 设置的值,ABB数据位宽为8bit,32bit留作扩展
 输出参数  : 无
 返 回 值  : BSP_OK    - successful
             BSP_ERROR - unsuccessful
...
*****************************************************************************/
BSP_S32 BSP_ABB_RegSet( BSP_U32 regAddr, BSP_U32 setData );
#endif
/*************************HKADC END***********************************/
...
/*****************************************************************************
 ...
 返 回 值  : void
*****************************************************************************/
extern void BSP_CACHE_DataCacheFlush(void * addr, int size);
#ifdef CHIP_BB_HI6620
/*****************************************************************************
...
/*****************************************************************************
 ...
 输入参数  : enModeId: PWC_COMM_MODE_WCDMA/PWC_COMM_MODE_GSM/PWC_COMM_MODE_LTE,
             enModuleId:PWC_COMM_MODULE_PA/PWC_COMM_MODULE_RF/PWC_COMM_MODULE_BBP/PWC_COMM_MODULE_DSP/PWC_COMM_MODULE_ABB,
 输出参数  : None
 返 回 值  : RET_OK/RET_ERR
*****************************************************************************/
/*V3R2 CS f00164371，这个接口暂时不隔离，因为HIFI加载需要，在函数内部进行了隔离*/
extern BSP_S32 BSP_PWRCTRL_PwrUp (PWC_COMM_MODE_E enModeId, PWC_COMM_MODULE_E enModuleId, PWC_COMM_MODEM_E enModemId);
...
*****************************************************************************/
/*V3R2 CS f00164371，这个接口暂时不隔离，因为HIFI加载需要，在函数内部进行了隔离*/
extern BSP_S32 BSP_PWRCTRL_PwrDown (PWC_COMM_MODE_E enModeId, PWC_COMM_MODULE_E enModuleId, PWC_COMM_MODEM_E enModemId);

/*****************************************************************************
 函 数 名  : BSP_PWRCTRL_PllEnable
 功能描述  : W模、G模、L模下PA、DSP、ABB的PLL使能。
 输入参数  : enModeId: PWC_COMM_MODE_WCDMA/PWC_COMM_MODE_GSM/PWC_COMM_MODE_LTE,
             enModuleId:PWC_COMM_MODULE_PA/PWC_COMM_MODULE_DSP/PWC_COMM_MODULE_ABB,
 输出参数  : None
 返 回 值  : RET_OK/RET_ERR
*****************************************************************************/
extern BSP_S32 BSP_PWRCTRL_PllEnable (PWC_COMM_MODE_E enModeId, PWC_COMM_MODULE_E enModuleId, PWC_COMM_MODEM_E enModemId);
...
/*****************************************************************************
 ...
 返 回 值  : RET_OK/RET_ERR
*****************************************************************************/
extern BSP_S32 BSP_PWRCTRL_PllDisable (PWC_COMM_MODE_E enModeId, PWC_COMM_MODULE_E enModuleId, PWC_COMM_MODEM_E enModemId);
...
/*****************************************************************************
 ...
 输入参数  : enModeId: PWC_COMM_MODE_WCDMA/PWC_COMM_MODE_GSM/PWC_COMM_MODE_LTE,
             enModuleId:PWC_COMM_MODULE_PA/PWC_COMM_MODULE_DSP/PWC_COMM_MODULE_ABB,
 输出参数  : None
 返 回 值  : PWRCTRL_COMM_ON/PWRCTRL_COMM_OFF/RET_ERR
*****************************************************************************/
extern BSP_S32 BSP_PWRCTRL_PllStatusGet (PWC_COMM_MODE_E enModeId, PWC_COMM_MODULE_E enModuleId, PWC_COMM_MODEM_E enModemId);
...
*****************************************************************************/
extern BSP_S32 BSP_PWRCTRL_SleepVoteLock(PWC_CLIENT_ID_E enClientId);
...
/*****************************************************************************
 ...
 返 回 值  : PWC_PARA_INVALID/PWC_SUCCESS
*****************************************************************************/
extern BSP_S32 BSP_PWRCTRL_SleepVoteUnLock(PWC_CLIENT_ID_E enClientId);
...
/*****************************************************************************
Function:   BSP_PWRCTRL_SleepInSocCB
Description:
Input:
Output:     None;
Return:
Others:
*****************************************************************************/
extern int BSP_PWRCTRL_SleepInSocCB(PWC_DS_SOCP_CB_STRU stFunc);
...
/*****************************************************************************
 ...
 返 回 值  : PWRCTRL_COMM_ON/PWRCTRL_COMM_OFF/RET_ERR
*****************************************************************************/
extern  BSP_S32 BSP_PWRCTRL_PwrStatusGet(PWC_COMM_MODE_E enModeId, PWC_COMM_MODULE_E enModuleId, PWC_COMM_MODEM_E enModemId);
...
/*****************************************************************************
 ...
 返 回 值  : RET_OK         成功
             RET_ERR        失败
*****************************************************************************/
extern BSP_S32 PWRCTRL_BbpClkEnable(PWC_COMM_MODE_E enModeId, PWC_COMM_MODULE_E enModuleId, PWC_COMM_MODEM_E enModemId);

/*****************************************************************************
 函 数 名  : PWRCTRL_BbpClkDisable
 功能描述  : 关闭通信模块时钟
 输入参数  : enModeId     通信模式
             enModuleId   通信模块
             enModemId    卡号
 ...
 返 回 值  : RET_OK         成功
             RET_ERR        失败
*****************************************************************************/
extern BSP_S32 PWRCTRL_BbpClkDisable(PWC_COMM_MODE_E enModeId, PWC_COMM_MODULE_E enModuleId, PWC_COMM_MODEM_E enModemId);
/*************************DPM END*************************************/
...
/*****************************************************************************
 ...
 返 回 值  : BSP_OK          设置成功
             BSP_ERROR       设置失败
*****************************************************************************/
extern BSP_S32 bsp_modem_voltage_set( EM_MODEM_CONSUMER_ID consumer_id, BSP_U32 voltage_mv );
/*****************************************************************************
 ...
 返 回 值  : BSP_OK          获取成功
             BSP_ERROR       获取失败
*****************************************************************************/
extern BSP_S32 bsp_modem_voltage_get( EM_MODEM_CONSUMER_ID consumer_id, BSP_U32 *voltage_mv );
...
/*****************************************************************************
 ...
 返 回 值  : BSP_OK          获取成功
             BSP_ERROR       获取失败
*****************************************************************************/
extern BSP_S32 bsp_modem_voltage_list(EM_MODEM_CONSUMER_ID consumer_id,BSP_U16 **list, BSP_U32 *size);
/*****************************************************************************
