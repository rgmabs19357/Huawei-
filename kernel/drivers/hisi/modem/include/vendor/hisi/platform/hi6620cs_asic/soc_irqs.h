...
#define IRQ_TSENSOR1 (IRQ_GIC_START + 8)
...
#define IRQ_UART5 (IRQ_GIC_START + 41)
#define IRQ_UART6 (IRQ_GIC_START + 42)
#define IRQ_CM3UART (IRQ_GIC_START + 43)
...
#define IRQ_I2C4 (IRQ_GIC_START + 48)
#define IRQ_I2C5 (IRQ_GIC_START + 49)
#define IRQ_SSP0 (IRQ_GIC_START + 50)
#define IRQ_SSP1 (IRQ_GIC_START + 51)
...
#define IRQ_EDC0_SEC (IRQ_GIC_START + 79)
#define IRQ_EDC1_SEC (IRQ_GIC_START + 80)
#define IRQ_AEDMAC0 (IRQ_GIC_START + 81)
#define IRQ_SECENG (IRQ_GIC_START + 82)
#define IRQ_L2CC (IRQ_GIC_START + 83)
#define IRQ_AEDMAC_SEC (IRQ_GIC_START + 84)
#define IRQ_MEDMAC0 (IRQ_GIC_START + 85)
...
#define IRQ_TS (IRQ_GIC_START + 91)
#define IRQ_TZ (IRQ_GIC_START + 92)
#define IRQ_DDRC_INT (IRQ_GIC_START + 93)
#define IRQ_IPC0_S (IRQ_GIC_START + 94)
#define IRQ_IPC1_S (IRQ_GIC_START + 95)
#define IRQ_BBE16_GPIO0 (IRQ_GIC_START + 96)
#define IRQ_NOC (IRQ_GIC_START + 96)
...
#define IRQ_G3D (IRQ_GIC_START + 109)
#define IRQ_G2D (IRQ_GIC_START + 110)
#define IRQ_VDEC (IRQ_GIC_START + 111)
#define IRQ_VENC (IRQ_GIC_START + 112)
#define IRQ_VPP (IRQ_GIC_START + 113)
#define IRQ_EDC0 (IRQ_GIC_START + 114)
#define IRQ_EDC0_LDI (IRQ_GIC_START + 115)
#define IRQ_MIPI_DSI (IRQ_GIC_START + 116)
#define IRQ_EDC1 (IRQ_GIC_START + 117)
#define IRQ_EDC1_LDI (IRQ_GIC_START + 118)
#define IRQ_HDMI_MHL (IRQ_GIC_START + 119)
#define IRQ_ISP (IRQ_GIC_START + 120)
#define IRQ_MIPI_CSI0 (IRQ_GIC_START + 121)
#define IRQ_MIPI_CSI1 (IRQ_GIC_START + 122)
#define IRQ_ASP (IRQ_GIC_START + 123)
