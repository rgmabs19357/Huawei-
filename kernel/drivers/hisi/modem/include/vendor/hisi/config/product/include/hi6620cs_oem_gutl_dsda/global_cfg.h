 ...
 * File Name    : secure.h
 * Created      : 2012/9/13
 * Description  : head file for secure boot
 *
 *****************************************************************************
...
/* HKADC channel */
#define ADC_BOARDID0		 (0x03)
#define ADC_BOARDID1		 (0x04)
#define ADC_BOARDID2		 (0x0A)
#define ADC_UNUSE0			 (0x00)
#define ADC_UNUSE1			 (0x01)
#define ADC_VBATMON			 (0x0D)
#define ADC_VCOINMON		 (0x05)
#define ADC_RTMP			 (0x02)
...
#define GPIO_VOLUME_UP           GPIO_4_2
#define GPIO_VOLUME_DOWN         GPIO_4_3
#define GPIO_MENU                GPIO_3_2
