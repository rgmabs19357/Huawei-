...
#define MEMORY_RAM_CORESHARE_LOAD_HIFI_ADDR         (MEMORY_RAM_CORESHARE_MEMMGR_ADDR + MEMORY_RAM_CORESHARE_MEMMGR_SIZE)
...
#define MEMORY_AXI_IPF_ADDR                         IPF_SRAM_ADDR
#define MEMORY_AXI_IPF_SIZE                         IPF_SRAM_SIZE

/* 使用物理地址 */
#define CORESHARE_MEM_WAN_ADDR                      (MEMORY_RAM_CORESHARE_MEM_WAN_ADDR - GLOBAL_MEM_CORE_SHARE_ADDR + GLOBAL_MEM_CORE_SHARE_ADDR)
