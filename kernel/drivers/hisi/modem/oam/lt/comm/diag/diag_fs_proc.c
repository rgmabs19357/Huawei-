...
VOS_UINT32  diag_FsGetDirInfo(VOS_CHAR *pDirName, VOS_UINT32 *pulTotalNum)
{
    ...
    /*打开目录*/
    /*lint --e{628}*/
    dir_handle = (VOS_INT32)DIAG_FS_OPENDIR((VOS_CHAR*)pDirName,DIAG_FS_RDONLY|DIAG_FS_DIRECTORY,0); /*lint !e628 */ /* [false alarm]:屏蔽Fortify */
    /*lint +e628*/
    if(dir_handle < 0)
    {
        return VOS_ERR;
...
VOS_UINT32 diag_FsGetItemInfo(VOS_CHAR *pDirectory,DIAG_DIR_FILE_INFO_STRU *pstDirFileInfo)
{
    ...
    /*再次打开目录*/
    /*lint -e628*/
    dir_handle = (VOS_INT32)DIAG_FS_OPENDIR(pDirectory,DIAG_FS_RDONLY|DIAG_FS_DIRECTORY,0); /*lint !e628 */  /* [false alarm]:屏蔽Fortify */
    /*lint +e628*/
    if(dir_handle < 0)
    {
        return VOS_ERR;
