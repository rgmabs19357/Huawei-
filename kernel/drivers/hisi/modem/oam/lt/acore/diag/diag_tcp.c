...
/*****************************************************************************
 函 数 名  : diag_TcpPortLock
 功能描述  : 解锁TCP端口
 输入参数  : DIAG_TCPIP_PORT_ENUM enTcpPort
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : diag_ListenDoneNeedAcceptSet
 功能描述  : 设定已执行 listen()需要accept() 操作的套接字集合
 输入参数  : fd_set *fdListen
             VOS_SOCKET *maxSocket
             DIAG_TCPIP_PORT_STRU *astTcpPort
 输出参数  : 无
 返 回 值  : static VOS_INT32
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : diag_AcceptDoneNeedRecvSet
 功能描述  :  设定 已执行accept()需要recv() 操作的套接字集合
 输入参数  : fd_set *fdReceive
             VOS_SOCKET *maxSocket
             DIAG_TCPIP_PORT_STRU *astTcpPort
 输出参数  : 无
 返 回 值  : static VOS_INT32
...
/*****************************************************************************
 函 数 名  : diag_AcceptOnSocket
 功能描述  : 对基于 TCP 的 socket 通道执行 accept() 操作
 输入参数  : VOS_UINT8 ucTcpPort
             DIAG_TCPIP_PORT_STRU *astTcpPort
 输出参数  : 无
...
/*****************************************************************************
 函 数 名  : diag_CloseSocket
 功能描述  : 关闭socket,置描述符为无效
 输入参数  : DIAG_TCPIP_PORT_ENUM enTcpPort
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
...
/*****************************************************************************
 函 数 名  : diag_TcpRcvData
 功能描述  : 调用recv()接收数据
 输入参数  : VOS_SOCKET rxSocket
             VOS_UINT8 ulTcpPort
...
/*****************************************************************************
 函 数 名  : diag_TcpSendData
 功能描述  : 调用send()进行数据发送
 输入参数  : DIAG_TCPIP_PORT_ENUM enTcpPort
             VOS_UINT8 *pcData
             VOS_UINT32 usDataLen
             OUT VOS_UINT32 * pusWrtLen
 输出参数  : 无
 返 回 值  : VOS_UINT32
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : diag_BindListenTcpSocket
 功能描述  : 创建、绑定、监听基于TCP 的socket
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : static VOS_VOID
 调用函数  :
...
/*****************************************************************************
 函 数 名  : diag_AcceptRecvFromSocket
 功能描述  : 使用accept连接socket通道，调用recv接收数据
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : static VOS_VOID
 调用函数  :
