...
/*****************************************************************************
 函 数 名  : GU_OamCtrlSendData
 功能描述  : 将输入的数据通过USB(Ctrl口)发送给PC侧
 输入参数  : pucData:   传递的数据
                            ulDataLen: 数据长度
 输出参数  : 无
 返 回 值  : VOS_ERROR/VOS_OK
...
/*****************************************************************************
 函 数 名  : GU_OamAppWriteDataCB
 功能描述  : 用于处理App口的异步发送数据的回调
 输入参数  : pucData:   需要发送的数据内容
             ulDataLen: 数据长度
 输出参数  : 无
 返 回 值  : 无
...
/*****************************************************************************
 函 数 名  : GU_OamCtrlWriteDataCB
 功能描述  : 用于处理Ctrl口的异步发送数据的回调
 输入参数  : pucData:   需要发送的数据内容
             ulDataLen: 数据长度
 输出参数  : 无
 返 回 值  : 无
...
/*****************************************************************************
 函 数 名  : GU_OamAppCloseProc
 功能描述  : App 端口已经消失，需要关闭USB端口
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : GU_OamCtrlPortClose
 功能描述  : Ctrl 端口已经消失，需要关闭USB端口
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : GU_OamHsicPortClose
 功能描述  : Hsic 端口已经消失，需要关闭USB端口
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : GU_OamAppPortInit
 功能描述  : 用于USB APP口通道的初始化
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : GU_OamCtrlPortInit
 功能描述  : 用于USB Ctrl 口通道的初始化
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : GU_OamPortInit
 功能描述  : 用于USB 使用的端口通道的初始化
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
VOS_VOID OM_AcpuReadNVLog(VOS_VOID)
{
    ...
    VOS_CHAR                  acLogPath[] = "/data/modemlog/A_NV_OmLog.bin";
