...
typedef struct
{
    VOS_UINT32                          ulMailBoxAddr;      /* 保存邮箱头地址 */
    VOS_UINT32                          ulBufPhyAddr;       /* 邮箱内容的物理地址 */
    VOS_UINT32                          ulBufVirtAddr;      /* 邮箱内容的虚拟地址 */
...
/*****************************************************************************
 Prototype       : OM_PcvInitRbuf
 Description     : ringbuf init
 Input           : pstRingId  --- ringbuf id
                   ulAddr    --- AHB addr
                   ulbytes   --- memory size
 Output          : None
...
/*****************************************************************************
 Prototype       : OM_PcvGetRBufOffset
 Description     : get ringbuf write and read addr
 Input           : pstRingId  --- ringbuf id
                   ulAddr     --- AHB addr
 Output          : pstRingId  --- ringbuf id
 Return Value    : VOS_UINT32
...
/*****************************************************************************
 Prototype       : OM_PcvComRecv
 Description     : receive data from USB
 Input           : ulPort    --- port number
                   pucData   --- data pointer
                   usLen     --- data length
 Output          : None
 Return Value    : VOS_UINT32
...
/*****************************************************************************
 Prototype       : OM_PcvOpen
 Description     : open PC-voice transmission channel
 Input           : ulPort    --- port number
 Output          : None
 Return Value    : VOS_UINT32
...
/*****************************************************************************
 Prototype       : OM_PcvSwitch
 Description     : switch PC-voice transmission channel
 Input           : ulPort    --- port number
 Output          : None
 Return Value    : VOS_UINT32
...
/*****************************************************************************
 Prototype       : OM_PcvClose
 Description     : close PC-voice transmission channel
 Input           : ulPort    --- port number
 Output          : None
 Return Value    : VOS_UINT32
...
/*****************************************************************************
 Prototype       : OM_PcvTransStatus
 Description     : control PC-voice transmission channel
 Input           : ulStatus  --- command type
                   ulPort    --- port number
 Output          : None
 Return Value    : VOS_UINT32
...
/*****************************************************************************
 Prototype       : OM_PcvTransmitTaskEntry
 Description     : downlink task entry
 Input           : None
 Output          : None
 Return Value    : None
