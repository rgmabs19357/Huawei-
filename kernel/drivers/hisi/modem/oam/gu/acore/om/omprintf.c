...
/*****************************************************************************
 函 数 名  : OM_PrintfSetModuleIdLev
 功能描述  : 设置模块ID及打印级别
 输入参数  : ulModuleId - 模块ID
             ulLev - 打印级别
 输出参数  : 无
 返 回 值  : OM_OK - 设置成功
             OM_ERR_UNVALIDPARA - 参数非法
             VOS_ERR            - 设置失败
...
/*****************************************************************************
 函 数 名  : OM_PrintfSetOutLev
 功能描述  : 设置打印级别
 输入参数  : pstLogIdLevel - 指向PC->OM请求数据包用来打印级别的结构体指针
             ulLength - 数据长度
 输出参数  : 无
 返 回 值  : VOS_VOID
...
/*****************************************************************************
 函 数 名  : OM_PrintfMsgProc
 功能描述  : 根据SDT消息动态配置OM Printf输出端口或设置模块及打印级别
...
/*****************************************************************************
 函 数 名  : OM_PrintfDataPut
 功能描述  : 将格式化字符串及参数转换为字符串存入ringbuffer
 输入参数  : pcformat -- 格式化字符串
 输出参数  : 无
 返 回 值  : OM_OK - 成功
             OM_ERR_INPUTTOOLONG - 输入格式化字符串太长
             OM_ERR_UNKNOWN - 不可知错误
             OM_ERR_FAILTAKESEM - 获取信号量失败
             OM_ERR_NOBUF - ringbuffer空间不足
             OM_ERR_FAILPUTDATA - 数据放入ringbuffer失败
 修改历史      :
  1.日    期   : 2010年11月03日
    修改内容   : 新生成函数
...
/*****************************************************************************
 函 数 名  : OM_SndPrintfToOm
 功能描述  : 当输出端口为SDT时，将数据分发到OM链路buffer
 输入参数  : pcData - 指向数据的指针
             ulLength - 数据长度
 输出参数  : 无
 返 回 值  : VOS_VOID
...
/*****************************************************************************
 函 数 名  : OM_PrintfTask
 功能描述  : 根据输出端口将OM Printf ringbuffer中数据进行分发的自处理任务
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : VOS_VOID
