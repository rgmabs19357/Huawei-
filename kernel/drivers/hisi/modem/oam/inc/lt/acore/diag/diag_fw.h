...
extern VOS_UINT32 diag_FwCmdTimeOutProc(VOS_VOID * pstRxinfo);
...
extern VOS_VOID diag_FwDealTimeOutCmdEntry(VOS_VOID* pstRxinfo);
extern VOS_UINT32 diag_FwDecodeDataCheck(VOS_UINT8 * pDataBuf);
extern VOS_VOID diag_FwDelCmdNode(DIAG_FW_RX_INFO_STRU* pstCmdNode);
...
extern VOS_UINT32 diag_FwSendDecodeCmdToFw(VOS_UINT8 * pDataBuf, VOS_UINT16 ulLen);
