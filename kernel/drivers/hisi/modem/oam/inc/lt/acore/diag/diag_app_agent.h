...
extern VOS_UINT32 diag_NvExportFileInfo(VOS_UINT32 ulType,NVIM_EXPORT_FILE_INFO_STRU *pstExportFileInfo);
extern VOS_UINT32 diag_NvExportProc(VOS_UINT8* pstReq,VOS_UINT32 ulCmdId);
extern VOS_UINT32 diag_NvImportProc(VOS_UINT8* pstReq,VOS_UINT32 ulCmdId);
