...
typedef struct
{
    ...
    VOS_UINT32                  ulWritePort;
    VOS_BOOL                    bFlag;          /* 是否检测0x7E包头标志(避免插入USB后有应用程序乱发字符) */
...
typedef struct
{
	...
	VOS_UINT64	   StorageTotalSize;
	VOS_UINT64		MaxFileSize;
	VOS_UINT32		ulFileNum;
	VOS_UINT32		ulCurrenFileSize;
	VOS_INT32       CurrentFileFd;
