...
/* 复位卡后等待卡状态所起的callback定时器名字及时长定义 */
#define USIMM_CB_TIMER_NAME_GET_CARD_STATUS     (1)
#define USIMM_CB_TIMER_LEN_GET_CARD_STATUS      (20)

/* g_ulUSIMMGetCardStatSemID信号量保护时长 */
#define USIMM_GET_CARD_STATUS_SEM_LEN           (1000)
