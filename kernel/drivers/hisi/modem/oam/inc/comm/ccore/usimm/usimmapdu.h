...
*****************************************************************************/
/*SW check定义*/
#define USIMM_SIMSW_MAXNUMBER      (23)
#define USIMM_USIMSW_MAXNUMBER     (39)
...
extern VOS_UINT32 USIMM_Authentication_APDU(VOS_UINT8 ucMode, VOS_UINT8 *pucData, VOS_UINT32 ulDataLen);
