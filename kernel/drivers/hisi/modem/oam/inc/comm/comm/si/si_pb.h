...
#define SI_PB_MAX_NUMBER        5  /*最多支持电话本个数*/
...
#define PB_INFO_LOG(string)             PS_LOG(ACPU_PID_PB, 0, PS_PRINT_INFO,   string)
#define PB_NORMAL_LOG(string)           PS_LOG(ACPU_PID_PB, 0, PS_PRINT_NORMAL, string)
#define PB_WARNING_LOG(string)          PS_LOG(ACPU_PID_PB, 0, PS_PRINT_WARNING,string)
#define PB_ERROR_LOG(string)            PS_LOG(ACPU_PID_PB, 0, PS_PRINT_ERROR,  string)

#define PB_INFO1_LOG(string, para1)     PS_LOG1(ACPU_PID_PB, 0, PS_PRINT_INFO,   string, para1)
#define PB_NORMAL1_LOG(string, para1)   PS_LOG1(ACPU_PID_PB, 0, PS_PRINT_NORMAL, string, para1)
#define PB_WARNING1_LOG(string, para1)  PS_LOG1(ACPU_PID_PB, 0, PS_PRINT_WARNING,string, para1)
#define PB_ERROR1_LOG(string, para1)    PS_LOG1(ACPU_PID_PB, 0, PS_PRINT_ERROR,  string, para1)
#endif

#if(OSA_CPU_CCPU == VOS_OSA_CPU)
#define PB_INFO_LOG(string)             PS_LOG(MAPS_PB_PID, 0, PS_PRINT_INFO,   string)
#define PB_NORMAL_LOG(string)           PS_LOG(MAPS_PB_PID, 0, PS_PRINT_NORMAL, string)
#define PB_WARNING_LOG(string)          PS_LOG(MAPS_PB_PID, 0, PS_PRINT_WARNING,string)
#define PB_ERROR_LOG(string)            PS_LOG(MAPS_PB_PID, 0, PS_PRINT_ERROR,  string)

#define PB_INFO1_LOG(string, para1)     PS_LOG1(MAPS_PB_PID, 0, PS_PRINT_INFO,   string, para1)
#define PB_NORMAL1_LOG(string, para1)   PS_LOG1(MAPS_PB_PID, 0, PS_PRINT_NORMAL, string, para1)
#define PB_WARNING1_LOG(string, para1)  PS_LOG1(MAPS_PB_PID, 0, PS_PRINT_WARNING,string, para1)
#define PB_ERROR1_LOG(string, para1)    PS_LOG1(MAPS_PB_PID, 0, PS_PRINT_ERROR,  string, para1)
#endif
...
#else
#define PB_MALLOC(LENGTH)               BSP_SMalloc((BSP_U32)LENGTH, MEM_ICC_DDR_POOL)
#define PB_FREE(MEMADDR)                BSP_SFree(MEMADDR)
#endif
...
enum SI_PB_REQ_ENUM
{
    ...
    SI_PB_REFRESH_REQ   = 6,        /* 号码本更新请求           */
    SI_PB_SEARCH_REQ    = 7,        /* 号码本查找请求           */
    SI_PB_SREAD_REQ     = 8,        /* 复合号码本读取请求       */
    SI_PB_SMODIFY_REQ   = 9,        /* 复合号码本修改请求       */
    SI_PB_SADD_REQ      = 10,       /* 复合号码本添加请求       */
    SI_PB_UPDATE_AGOBAL = 11,       /* 更新Acpu的全局变量内容   */
    SI_PB_UPDATE_CURPB  = 12,       /* 更新当前电话本设置       */
    SI_PB_FDN_CHECK_REQ = 13,
    SI_PB_REQ_BUTT
};
...
typedef struct
{
    ...
    PS_PB_FDN_NUM_STRU          stFDNNum;           /* FDN号码结构 */
...
extern VOS_UINT32 SI_PB_EMLContentProc(PS_USIM_GET_FILE_CNF_STRU *pstPBMsg, VOS_UINT8 ucSuffix, VOS_UINT16 usEmailIndex);
...
extern VOS_UINT32 SI_PB_UpdataXDNFile(VOS_UINT8 ucPBOffset, VOS_UINT16 usFileId, VOS_UINT16 usExtFileId,
                                        VOS_UINT8 ucRecord,SI_PB_RECORD_STRU *pstRecord);

extern VOS_UINT32 SI_PB_UpdataSPBFile(SI_PB_SPB_UPDATE_STRU *pstPBFid,
                                        SI_PB_RECORD_STRU *pstRecord);

extern VOS_UINT32 SI_PB_UpdataEML(SI_PB_RECORD_STRU *pstRecord,USIMM_SPB_API_STRU *pstSPBReq,SI_PB_SPB_UPDATE_STRU *pstPBFid);

extern VOS_UINT32 SI_PB_UpdataANR(SI_PB_RECORD_STRU *pstRecord,
                            USIMM_SPB_API_STRU *pstSPBReq,
                            VOS_UINT16 *pusExtUsedNum,
                            SI_PB_SPB_UPDATE_STRU *pstPBFid);

extern VOS_UINT32 SI_PB_UpdataADN(SI_PB_RECORD_STRU *pstRecord,
                                   USIMM_SPB_API_STRU *pstSPBReq,
                                   VOS_UINT16 *pusExtUsedNum,
                                   SI_PB_SPB_UPDATE_STRU *pstPBFid);

extern VOS_UINT32 SI_PB_DeleteHandle(VOS_UINT16 usFileId, VOS_UINT8 ucRecord,
...
extern VOS_VOID SI_PB_PihRefreshIndProc(PS_USIM_REFRESH_IND_STRU *pstMsg);
