...
#define STK_INFO_LOG(string)            PS_LOG(MAPS_STK_PID, 0, PS_PRINT_INFO,   string)
#define STK_NORMAL_LOG(string)          PS_LOG(MAPS_STK_PID, 0, PS_PRINT_NORMAL, string)
#define STK_WARNING_LOG(string)         PS_LOG(MAPS_STK_PID, 0, PS_PRINT_WARNING,string)
#define STK_ERROR_LOG(string)           PS_LOG(MAPS_STK_PID, 0, PS_PRINT_ERROR,  string)

#define STK_INFO_LOG1(string, para1)    PS_LOG1(MAPS_STK_PID, 0, PS_PRINT_INFO,   string, para1)
#define STK_NORMAL_LOG1(string, para1)  PS_LOG1(MAPS_STK_PID, 0, PS_PRINT_NORMAL, string, para1)
#define STK_WARNING_LOG1(string, para1) PS_LOG1(MAPS_STK_PID, 0, PS_PRINT_WARNING,string, para1)
#define STK_ERROR_LOG1(string, para1)   PS_LOG1(MAPS_STK_PID, 0, PS_PRINT_ERROR,  string, para1)
...
#define STK_TERMINAL_RSP_LEN            12  /*返回的TR数据长度，按照结果只有一个字节计算*/
...
#define STK_PROTECT_TIMER_NAME          0
#define STK_TIMER_MANAGEMENT_TIMER1     1
#define STK_TIMER_MANAGEMENT_TIMER2     2
#define STK_TIMER_MANAGEMENT_TIMER3     3
#define STK_TIMER_MANAGEMENT_TIMER4     4
#define STK_TIMER_MANAGEMENT_TIMER5     5
#define STK_TIMER_MANAGEMENT_TIMER6     6
#define STK_TIMER_MANAGEMENT_TIMER7     7
#define STK_TIMER_MANAGEMENT_TIMER8     8
#define STK_IND_TIMER_NAME              9
#define STK_REFRESH_TIMER_NAME          10
#define STK_GETTA_TIMER_NAME            11

#define STK_SETUP_CALL_DURATION_TIMER_NAME      12
#define STK_DTMF_PAUSE_TIMER_NAME               13

#define STK_NMR_TIMER_NAME                      (14)

#define STK_LOCIEVENT_TIMER_NAME        (15)
#define STK_ACCEVENT_TIMER_NAME         (16)
...
#define STK_RESEND_TIMER_START(TimerId, TimerName, Length)  VOS_StopRelTimer(TimerId);\
                                                            VOS_StartRelTimer(TimerId, MAPS_STK_PID,\
...
#define STK_BCD2HEX(x) ((SI_UINT8)((SI_UINT8)(((x) & 0xF0)>>4) + (SI_UINT8)(((x) & 0x0F)*0x0A)))

#define STK_HEX2BCD(x) (((x) < 10)?(SI_UINT8)((x)<<4):((SI_UINT8)((SI_UINT8)(((x)/10) & 0x0F) + (SI_UINT8)(((x)%10)<<4))))
...
enum SI_STK_MSG_ENUM
{
    ...
    SI_STK_ENVELOPETAF              = 0x0B,     /*主菜单选中下发，TAF发送*/
    SI_STK_VIA_TRDOWN               = 0x0C,
    SI_STK_MSG_BUTT
};
typedef VOS_UINT32 SI_STK_MSG_ENUM_UINT32;
...
typedef struct
{
    ...
    SI_STK_MSG_ENUM_UINT32          enSTKEventType;
...
typedef struct
{
    SI_UINT32                       OP_MTCall:1;
    SI_UINT32                       OP_CallConnect:1;
    SI_UINT32                       OP_CallDisconnet:1;
    SI_UINT32                       OP_LociStatus:1;
    SI_UINT32                       OP_AccChange:1;
    SI_UINT32                       OP_NetSearchChg:1;
    SI_UINT32                       OP_NetRej:1;
...
1.日    期  : 2013年07月11日
  修改内容  : Create
*****************************************************************************/
extern VOS_VOID STK_UpdateCurRat(VOS_UINT8 ucRat);
...
1.日    期  : 2013年07月11日
  修改内容  : Create
*****************************************************************************/
extern VOS_VOID STK_ProfileInit(USIMM_STK_CFG_STRU *pstSTKProfileContent, VOS_UINT32 ulCardType);
...
extern VOS_VOID SI_STK_ATEnvelopeCnf(PS_USIM_ENVELOPE_CNF_STRU *pstMsg);

extern VOS_VOID SI_STK_MenuSelectionCnf(PS_USIM_ENVELOPE_CNF_STRU *pstMsg);

extern VOS_VOID SI_STK_TAFEnvelopeCnf(PS_USIM_ENVELOPE_CNF_STRU *pstMsg);
...
extern VOS_UINT32 SI_STK_EventDownReqCheck(SI_STK_REQ_STRU *STKReqMsg);
...
extern VOS_VOID SI_STK_TAFEnvelopeDown(SI_STK_REQ_STRU *pstSTKReqMsg);
...
extern VOS_UINT32 SI_STK_SetUpCall(VOS_VOID);
