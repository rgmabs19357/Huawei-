...
/*****************************************************************************
  4 函数声明
*****************************************************************************/
extern VOS_UINT32 CSIMA_SendTPDUCnfMsg(PS_USIM_SENDTPDU_CNF_STRU *pstMsg);
...
extern VOS_VOID CSIMA_FirstCardStatusInd(PS_USIM_STATUS_IND_STRU *pstMsg);

extern VOS_VOID CSIMA_CardStatusInd(PS_USIM_STATUS_IND_STRU *pstMsg);
