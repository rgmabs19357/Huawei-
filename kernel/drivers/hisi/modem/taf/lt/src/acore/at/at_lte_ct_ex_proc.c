...
VOS_UINT32 atQryFPAPOWERParaCnfProc(VOS_UINT8 ucClientId, VOS_VOID *pMsgBlock)
{
	...
	{
		usLength += (VOS_UINT16)At_sprintf(AT_CMD_MAX_LEN,(VOS_CHAR *)pgucLAtSndCodeAddr,(VOS_CHAR *)pgucLAtSndCodeAddr + usLength,
				",%d",pstCnf->usMaxPowerList[0]);

		for( ucTmp = 1 ; ucTmp < pstCnf->usPaLeverNum ; ucTmp++)
		{
			usLength += (VOS_UINT16)At_sprintf(AT_CMD_MAX_LEN,(VOS_CHAR *)pgucLAtSndCodeAddr,(VOS_CHAR *)pgucLAtSndCodeAddr + usLength,
...
VOS_UINT32 atSetFCALPDDCSParaCnfProc(VOS_UINT8 ucClientId, VOID *pMsgBlock)
{
    OS_MSG_STRU* pEvent = NULL;
...
VOS_UINT32 atQryFCALPDDCSParaCnfProc(VOS_UINT8 ucClientId, VOID *pMsgBlock)
{
...
VOS_UINT32 atSetFPDPOWSParaCnfProc(VOS_UINT8 ucClientId, VOID *pMsgBlock)
{
    OS_MSG_STRU* pEvent = NULL;
...
VOS_UINT32 atSetFQPDDCRESParaCnfProc(VOS_UINT8 ucClientId, VOID *pMsgBlock)
{
	OS_MSG_STRU* pEvent = NULL;
