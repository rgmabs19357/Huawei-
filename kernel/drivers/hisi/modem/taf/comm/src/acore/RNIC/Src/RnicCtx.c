...
)
{
    ...
    pstIpv6PdpCtx->ucRabId     = RNIC_INVALID_RABID;
    pstIpv6PdpCtx->aucRsv[0]   = 0;
    pstIpv6PdpCtx->aucRsv[1]   = 0;
    pstIpv6PdpCtx->aucRsv[2]   = 0;
...
)
{
    ...
    pstIpv4v6PdpCtx->ucRabId                = RNIC_INVALID_RABID;
    pstPdpAddr->stIpv4PdpInfo.ucRabId       = RNIC_INVALID_RABID;
    pstPdpAddr->stIpv6PdpInfo.ucRabId       = RNIC_INVALID_RABID;
    pstIpv4v6PdpCtx->ulIpv4Addr             = 0;
    pstIpv4v6PdpCtx->aucRsv[0]   = 0;
    pstIpv4v6PdpCtx->aucRsv[1]   = 0;
    pstIpv4v6PdpCtx->aucRsv[2]   = 0;
