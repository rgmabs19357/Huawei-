...
*/
	...
	AT_SetHighRatPlmnSearchActiveStub, AT_SET_PARA_TIME,   TAF_NULL_PTR,    AT_NOT_SET_TIME,   TAF_NULL_PTR, AT_SET_PARA_TIME,
    VOS_NULL_PTR,   AT_NOT_SET_TIME,
	AT_CME_INCORRECT_PARAMETERS, CMD_TBL_LIMITED_NULL,
    (TAF_UINT8*)"^CHIGHRATHPLMNSEARCHENABLESTUB", (VOS_UINT8*)"(0,1)"},
#endif
...
/* XML命令 end  */
    ...
    VOS_NULL_PTR, AT_NOT_SET_TIME,
    AT_CME_INCORRECT_PARAMETERS, CMD_TBL_PIN_IS_LOCKED,
    (VOS_UINT8*)"^APDS",    (VOS_UINT8*)"(@dial_string),(@subaddr),(0,1),(0,1),(0,1)"},
