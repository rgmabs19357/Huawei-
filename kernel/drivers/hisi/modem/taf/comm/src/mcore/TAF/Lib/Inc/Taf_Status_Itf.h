...
/*****************************************************************************
 ...
 结构说明  :开机请求
 1.日    期   : 2011年8月4日
   修改内容   : V7R1 phase II: 删除网络模式和接入模式优先级
*****************************************************************************/
typedef struct
{
...
/* Sta_MsgInd函数移动位置 */
 ...
 /*-------------- DETACH过程请求 --------------*/
VOS_UINT32 Sta_Detach ( VOS_UINT32 ulOpID, VOS_UINT32 uDetachCause );

 /*------------- ATTACH过程请求 ---------------*/
VOS_UINT32 Sta_Attach ( VOS_UINT32 ulOpID, VOS_UINT32 uAttatchType );
