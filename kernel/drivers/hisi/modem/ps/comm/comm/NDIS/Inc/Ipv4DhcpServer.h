 ...
 ******************************************************************************
  文 件 名   : Ipv4DhcpServer.h
  版 本 号   : 初稿
  生成日期   : 2011年3月7日
  最近修改   :
  功能描述   : APP核IPV4 DHCP Server功能
  函数列表   :
  修改历史   :
  1.日    期   : 2011年3月7日
    修改内容   : 创建文件
...
/*针对当前打印进行宏定义*/
#ifndef NDIS_RELEASE
#define IP_INFO_LOG(STRING)                              vos_printf("%s,%d,%s \r\n",__FILE__,__LINE__,STRING)
#define IP_ERROR_LOG(STRING)                             vos_printf("%s,%d,%s \r\n",__FILE__,__LINE__,STRING)
#define IP_ERROR_LOG1(STRING,lPara)                      vos_printf("%s,%d,%s,%d \r\n", __FILE__,__LINE__,STRING,lPara)
#define IP_ERROR_LOG2(STRING,lPara1,lPara2)              vos_printf("%s,%d,%s,%d,%d \r\n",__FILE__,__LINE__,STRING,lPara1,lPara2)
#else
