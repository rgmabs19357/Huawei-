...
#if 0
extern VOS_UINT32 NV_ReadEx(MODEM_ID_ENUM_UINT16 enModemId, VOS_UINT16 usID, VOS_VOID *pItem, VOS_UINT32 ulLength);
#endif
...
#define Ndis_NvimItem_Read( ulId, pItemData, usItemDataLen ) \
    NV_ReadEx( MODEM_ID_0, ulId, (VOS_VOID *)(pItemData), usItemDataLen)
...
#if 0
/*NDIS转定义MSP的上报关键事件接口函数*/
#define NDIS_ReportEventLog(ulModuleId,ulLogType, ulEventID)    \
            /*lint -e961*/ \
            (VOS_VOID)DIAG_ReportEventLog(NDIS_OM_ID((ulModuleId), (ulLogType)), \
                                        (VOS_UINT32)(ulEventID + NDIS_OM_KEY_EVENT_BASE_ID))\
            /*lint +e961*/

#define NDIS_LOG(ModulePID, SubMod, Level, pcString) \
            NDIS_OM_LOG( __FILE__, __LINE__, ModulePID, Level, pcString)

#define NDIS_LOG1(ModulePID, SubMod, Level, pcString, lPara1) \
            NDIS_OM_LOG1( __FILE__, __LINE__, ModulePID, Level, pcString, (VOS_INT32)(lPara1))

#define NDIS_LOG2(ModulePID, SubMod, Level, pcString, lPara1,lPara2) \
            NDIS_OM_LOG2( __FILE__, __LINE__, ModulePID, Level, pcString, (VOS_INT32)(lPara1),(VOS_INT32)(lPara2))

#define NDIS_LOG3(ModulePID, SubMod, Level, pcString, lPara1,lPara2,lPara3) \
            NDIS_OM_LOG3( __FILE__, __LINE__, ModulePID, Level, pcString, (VOS_INT32)(lPara1),(VOS_INT32)(lPara2),(VOS_INT32)(lPara3))

#define NDIS_LOG4(ModulePID, SubMod, Level, pcString, lPara1,lPara2,lPara3,lPara4) \
            NDIS_OM_LOG4( __FILE__, __LINE__, ModulePID, Level, pcString, (VOS_INT32)(lPara1),(VOS_INT32)(lPara2),(VOS_INT32)(lPara3),(VOS_INT32)(lPara4))


#define NDIS_INFO_LOG(ModuleId, String)  NDIS_LOG( ModuleId, 0,LOG_LEVEL_INFO, String)
#define NDIS_INFO_LOG1(ModuleId, String,Para1)  NDIS_LOG1( ModuleId, 0,LOG_LEVEL_INFO, String, Para1)
#define NDIS_INFO_LOG2(ModuleId, String,Para1,Para2)  NDIS_LOG2( ModuleId, 0,LOG_LEVEL_INFO, String, Para1,Para2)
#define NDIS_INFO_LOG3(ModuleId, String,Para1,Para2,Para3)  NDIS_LOG3( ModuleId, 0,LOG_LEVEL_INFO, String, Para1,Para2,Para3)
#define NDIS_INFO_LOG4(ModuleId, String,Para1,Para2,Para3,Para4)  NDIS_LOG4( ModuleId, 0,LOG_LEVEL_INFO, String, Para1,Para2,Para3,Para4)


#define NDIS_WARNING_LOG(ModuleId, String)  NDIS_LOG( ModuleId, 0,LOG_LEVEL_WARNING, String)
#define NDIS_WARNING_LOG1(ModuleId, String,Para1)  NDIS_LOG1( ModuleId, 0,LOG_LEVEL_WARNING, String, Para1)
#define NDIS_WARNING_LOG2(ModuleId, String,Para1,Para2)  NDIS_LOG2( ModuleId, 0,LOG_LEVEL_WARNING, String, Para1,Para2)
#define NDIS_WARNING_LOG3(ModuleId, String,Para1,Para2,Para3)  NDIS_LOG3( ModuleId, 0,LOG_LEVEL_WARNING, String, Para1,Para2,Para3)
#define NDIS_WARNING_LOG4(ModuleId, String,Para1,Para2,Para3,Para4)  NDIS_LOG4( ModuleId, 0,LOG_LEVEL_WARNING, String, Para1,Para2,Para3,Para4)

#define NDIS_ERROR_LOG(ModuleId, String)  NDIS_LOG( ModuleId, 0,LOG_LEVEL_ERROR, String)
#define NDIS_ERROR_LOG1(ModuleId, String,Para1)  NDIS_LOG1( ModuleId, 0,LOG_LEVEL_ERROR, String, Para1)
#define NDIS_ERROR_LOG2(ModuleId, String,Para1,Para2)  NDIS_LOG2( ModuleId, 0,LOG_LEVEL_ERROR, String, Para1,Para2)
#define NDIS_ERROR_LOG3(ModuleId, String,Para1,Para2,Para3)  NDIS_LOG3( ModuleId, 0,LOG_LEVEL_ERROR, String, Para1,Para2,Para3)
#define NDIS_ERROR_LOG4(ModuleId, String,Para1,Para2,Para3,Para4)  NDIS_LOG4( ModuleId, 0,LOG_LEVEL_ERROR, String, Para1,Para2,Para3,Para4)
#else
#define NDIS_ReportEventLog(ulModuleId,ulLogType, ulEventID)
#define NDIS_LOG(ModulePID, SubMod, Level, pcString)
#define NDIS_LOG1(ModulePID, SubMod, Level, pcString, lPara1)
...
extern VOS_VOID Ndis_UlNcmFrmProc(UDI_HANDLE ulhandle, IMM_ZC_STRU *pstImmZc);
