...
{
    vos_printf("Recv Dhcp Packet              :    %d \r\n",g_stDhcpStatStru.ulRecvDhcpPkt);
    vos_printf("Recv Dhcp Discover  Msg       :    %d \r\n",g_stDhcpStatStru.ulRecvDiscoverMsg);
    vos_printf("Recv Dhcp Request   Msg       :    %d \r\n",g_stDhcpStatStru.ulRecvRequestMsg);
    vos_printf("Recv Dhcp Selecting Msg       :    %d \r\n",g_stDhcpStatStru.ulRecvSelectingReqMsg);
    vos_printf("Recv Dhcp Other     Msg       :    %d \r\n",g_stDhcpStatStru.ulRecvOtherReqMsg);
    vos_printf("Recv Dhcp Release   Msg       :    %d \r\n",g_stDhcpStatStru.ulRecvReleaseMsg);
    vos_printf("Recv Dhcp Other Typ Msg       :    %d \r\n",g_stDhcpStatStru.ulRecvOtherTypeMsg);
    vos_printf("Proc Dhcp Packet    Error     :    %d \r\n",g_stDhcpStatStru.ulProcErr);
    vos_printf("Send Dhcp Offer               :    %d \r\n",g_stDhcpStatStru.ulSendOffer);
    vos_printf("Send Dhcp Ack                 :    %d \r\n",g_stDhcpStatStru.ulSendAck);
    vos_printf("Send Dhcp NACK                :    %d \r\n",g_stDhcpStatStru.ulSendNack);
    vos_printf("Send Dhcp Mac Frame Succ      :    %d \r\n",g_stDhcpStatStru.ulSendDhcpPktSucc);
    vos_printf("Send Dhcp Mac Frame Fail      :    %d \r\n",g_stDhcpStatStru.ulSendDhcpPktFail);
