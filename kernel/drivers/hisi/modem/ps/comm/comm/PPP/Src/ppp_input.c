/************************************************************************
  ...
  File name    : ppp_input.c
  Version      : V200R001
  Date         : 2005-11-18
  Description  : 该C文件给出了PPP模块的供AT_I/O与AT_DATA模块调用的输入函数。
...
#else
/*****************************************************************************
 Prototype      : PPP_PushPacketEvent
 Description    : 接收到Um/Uu口的数据
 Input          : ---
 Output         : ---
 Return Value   : PS_SUCC   --- 成功
                  PS_FAIL   --- 失败
...
/*****************************************************************************
 Prototype      : PPP_PushRawDataEvent
 Description    : 接收到Um/Uu口的数据，PPP类型的PDP激活情况下使用
 Input          : ---
 Input          : ---
 Output         : ---
 Return Value   : PS_SUCC   --- 成功
