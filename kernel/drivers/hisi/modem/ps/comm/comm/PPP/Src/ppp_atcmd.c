/************************************************************************
  ...
  File name    : ppp_atcmd.c
  Version      : V200R001
  Date         : 2005-11-18
  Description  : 该C文件为AT模块"创建PPP链路"提供对应的API函数。
                  为AT模块"释放PPP链路"提供对应的API函数。
                  为AT模块"PPP模块接收网侧指示的配置信息"提供对应的API函数。
  ...
  1. Date:2005-11-18
     Modification:Create
  2. 2006-03-13 MODIFY BY F49086 FOR A32D02475
 ************************************************************************/
...
******************************************************************************/
/*****************************************************************************
 函 数 名  : PPP_SetHdlcConfig
 功能描述  : 配置HDLC使用软件还是硬件，用于调度时切换
 输入参数  : ulConfig    -   HDLC配置
 输出参数  :
 返 回 值  : 无
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : PPP_GetHdlcConfig
 功能描述  : 获取HDLC配置
 输入参数  : 无
 输出参数  : 无
 返 回 值  : ulConfig    -   HDLC配置
 调用函数  :
 被调函数  :
