...
/*****************************************************************************
 函 数 名  : IPS_MNTN_CCORE_OutputIpsInfo
 功能描述  : 输出TCP/IP协议栈基本信息
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : IPS_MNTN_CCORE_OutputIpsNatMappingsInfo
 功能描述  : 输出TCP/IP协议栈NAT映射信息
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : IPS_MNTN_CCORE_Init
 功能描述  : IPS可维可测模块PID初始化函数
 输入参数  : InitPhase      -- 初始化阶段
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
 被调函数  :
