...
extern VOS_UINT32 R_ITF_SetFlowCtrl(VOS_UINT32 ulFlowCtrlType, VOS_UINT32 ulNewLev);
...
extern VOS_VOID   R_ITF_SetLFlowLev(VOS_VOID);
extern VOS_VOID R_ITF_InitFlowCtrl(VOS_VOID);
extern VOS_UINT32 R_ITF_SetGprsFlowCtrl(VOS_VOID);
extern VOS_UINT32 R_ITF_StopGprsFlowCtrl(VOS_VOID);
