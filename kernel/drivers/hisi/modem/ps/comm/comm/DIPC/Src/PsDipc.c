...
/*****************************************************************************
函 数 名  : DIPC_PrintLog
功能描述  : 目前临时使用DIPC打印函数，后续等A核打印可用后切换为PS_LOG，打印没有参数的打印
...
功能描述  : 目前临时使用DIPC打印函数，后续等A核打印可用后切换为PS_LOG，打印有1个参数的打印
输入参数  : VOS_UINT32  ulModuleId      打印模块名
            VOS_UINT32  ulSubMod        打印子模块名
            VOS_UINT32  ulLevel         打印级别
            VOS_CHAR   *pcString        打印内容
...
功能描述  : 目前临时使用DIPC打印函数，后续等A核打印可用后切换为PS_LOG，打印有2个参数的打印
输入参数  : VOS_UINT32  ulModuleId      打印模块名
            VOS_UINT32  ulSubMod        打印子模块名
            VOS_UINT32  ulLevel         打印级别
            VOS_CHAR   *pcString        打印内容
...
/*****************************************************************************
 ...
 输入参数  : UDI_DEVICE_ID enUdiDevId   底软使用设备ID
...
/*****************************************************************************
 ...
 功能描述  : 外部使用设备ID是否合法检查
 输入参数  : UDI_DEVICE_ID enUdiDevId  AT发来的PDP激活消息指针
 输出参数  : 无
