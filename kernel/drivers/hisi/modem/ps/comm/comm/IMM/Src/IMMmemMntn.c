...
/*****************************************************************************
 函 数 名  : IMM_MntnCheckReportMemInfoStatus
 功能描述  : 检查是否需要向SDT上报内存使用状态消息
 输入参数  : IMM_MEM_USED_INFO_TRIG_TYPE_ENUM_UINT8 enTrigType 触发消息上报类型
...
/*****************************************************************************
 函 数 名  : IMM_MntnPrintBlkMemPoolUsedInfo
 功能描述  : 打印单个内存池使用情况
 输入参数  : IMM_MEM_POOL_STRU  *pstImmMemPoolInfo
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : IMM_MntnShowUsedBlkMemInfo
 功能描述  : 显示IMM_MEM统计信息
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
...
/*****************************************************************************
 函 数 名  : IMM_MntnMemUseBlkCntRpt
 功能描述  : 向SDT上报使用的内存块数
 输入参数  : unsigned char  ucPoolId 内存池ID号
             BLK_MEM_USED_INFO_TRIG_TYPE_ENUM_UINT8 enTrigType 触发原因
...
#if (FEATURE_ON == FEATURE_IMM_MEM_DEBUG)
/*****************************************************************************
 函 数 名  : IMM_MntnGetOverMemBlkCnt
 功能描述  : 统计内存超时块个数
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : VOS_UINT32
...
/*****************************************************************************
 函 数 名  : IMM_MntnMemTraceInfoRptSaveMemData
 功能描述  : 上报内存块的跟踪信息,保存数据块信息
 输入参数  : VOS_UINT8  ucPoolId         内存池ID
             IMM_BLK_MEM_TRACE_INFO_STRU *pstBlkMemTraceInfo 消息指针
             IMM_MEM_STRU *pMem      数据指针
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : IMM_MntnMemUsedBlkTraceInfoRpt
 功能描述  : 上报内存块的跟踪信息
 输入参数  : unsigned char  ucPoolId 内存池ID号
             BLK_MEM_USED_INFO_TRIG_TYPE_ENUM_UINT8 enTrigType 触发原因
 输出参数  : 无
...
/*****************************************************************************
 函 数 名  : IMM_MntnReportMemLeakMsg
 功能描述  : 向SDT上报内存泄露消息
...
/*****************************************************************************
 函 数 名  : IMM_MntnCheckPoolOverTimeOccupancy
 功能描述  : 对外提供接口, 判断IMM MEM是否有泄漏
 输入参数  : ucPoolId -- 检查的内存池ID
 输出参数  : 无
 返 回 值  : VOS_TRUE - 内存有泄漏; VOS_FALSE - 操作失败或内存无泄漏。
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : IMM_MntnRptPoolLeakInfo
 功能描述  : 提供给RB模块的结构，用于上报泄露信息
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : IMM_MntnBlkMemUsedInfoEventRpt
 功能描述  : 内存使用事件上报
 输入参数  : unsigned char  ucPoolId 内存池ID号
             BLK_MEM_USED_INFO_TRIG_TYPE_ENUM_UINT8 enTrigType 触发原因
 输出参数  :
...
/*****************************************************************************
 函 数 名  : IMM_MntnCheckLeak
 功能描述  : 对外提供接口, 判断IMM MEM是否有泄漏
 输入参数  : 无
 输出参数  : 无
 返 回 值  : VOS_TRUE - 内存泄漏; VOS_FALSE - 内存无泄漏。
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : IMM_MntnCheckMemPoolLeak
 功能描述  : 检查内存池是否泄露
 输入参数  : VOS_UINT8 ucCheckType
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : IMM_MemSetAllocFailThreshold
 功能描述  : IMM 设置申请上报门限
...
/*****************************************************************************
 函 数 名  : IMM_MemReSetAllocFailStatus
 功能描述  : 清空内存失败统计信息
 输入参数  : VOS_VOID
 输出参数  : VOS_VOID
 返 回 值  : 无
...
/*****************************************************************************
 函 数 名  : IMM_MemPrintDetail
 功能描述  : IMM 内存可维可测打印配置
 输入参数  : VOS_UINT8 ucChoice 是否使能内存块详细打印
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : IMM_MemSetTraceFunc
 功能描述  : IMM 内存可维可测配置跟踪函数轨迹
 输入参数  : VOS_UINT8 ucChoice 是否使能函数跟踪轨迹打印
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
 被调函数  :
