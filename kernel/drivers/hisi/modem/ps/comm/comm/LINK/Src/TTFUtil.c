/******************************************************************************
  ...
  2. Data: 2007-01-27
     Modification:BLOCK Memory Management

  3.日    期   : 2007年6月1日
    修改内容   : 问题单A32D10791: TTF_ZC_BLK管理中加入内存块状态检查
                 新增函数: TTF_ZC_BlkPrint, TTF_ZC_ShowInfo, TTF_ZC_BLkChk
                 修改    : TTF_ZC_BlkInit, TTF_ZC_BlkAlloc, TTF_ZC_BlkFree
******************************************************************************/
...
TTF_MBUF_ST *TTF_MbufNew(VOS_UINT32 ulPid, VOS_UINT16 usLen)
{
    ...
    /*========================*/    /*设置内存单元的参数*/
    VOS_MemSet(pMbuf, 0, sizeof(TTF_MBUF_ST) + usLen);
...
VOS_VOID TTF_Write32RegByBit(VOS_UINT32 ulRegAddr, VOS_UINT8 ucStartBit, VOS_UINT8 ucEndBit,VOS_UINT32 ulSetValue)
{
    ...
    {
        LogPrint4("TTF_Write32RegByBit para err ,regAddr 0x%x, startBit %d, endBit %d, value %d\r\n",
...
VOS_UINT32 TTF_Read32RegByBit(VOS_UINT32 ulRegAddr, VOS_UINT8 ucStartBit, VOS_UINT8 ucEndBit)
{
    ...
    if ( (VOS_NULL_PTR == ulRegAddr) || (ucStartBit > ucEndBit) || (ucStartBit > TTF_REG_MAX_BIT) || (ucEndBit > TTF_REG_MAX_BIT) )
    {
        LogPrint3("TTF_Read32RegByBit para err ,regAddr 0x%x, startBit %d, endBit %d\r\n",
...
VOS_UINT32 TTF_CopyLink_DL_Execute(VOS_UINT32 ulPid, TTF_COPYLINK_DL_STRU *pstTtfCpyLink)
{
        ...
        ulCopyNodeLoop++)
    {
        ...
        DRV_RT_MEMCPY(pstCopyLinkNode->pucDstData,
...
)
{
    ...
    if ( 0 == ulElementCnt )
    {
        PS_LOG(ulPid, 0, PS_PRINT_NORMAL,
    ...
    {
        PS_LOG2(ulPid, 0, PS_PRINT_NORMAL,
    ...
    VOS_UINT8 *pucSrcData, VOS_UINT16 usDataLen, VOS_UINT16 usModLen)
{
    ...
    {
        PS_LOG2(ulPid, PS_SUBMOD_NULL, PS_PRINT_WARNING,
    ...
    {
        DRV_RT_MEMCPY(pucDst, pucSrcData, usDataLen);
    }
    else
    {
...
)
{
    ...
    if (usDataLen >= usModLen)
    {
        PS_LOG(ulPid, PS_SUBMOD_NULL, PS_PRINT_WARNING,
    ...
    {
        DRV_RT_MEMCPY(pucDstData,pucSrc,usDataLen);
    }
