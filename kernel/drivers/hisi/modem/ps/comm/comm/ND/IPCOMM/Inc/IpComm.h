...
#define IP_ASSERT(exp) \
    if(!(exp))\
    {\
        vos_assert((VOS_UINT32)__FILE__, __LINE__);\
        return;\
    }
...
#define IPND_LOG(ModulePID, SubMod, Level, pcString) \
            IPND_OM_LOG( __FILE__, __LINE__, ModulePID, Level, pcString)

#define IPND_LOG1(ModulePID, SubMod, Level, pcString, lPara1) \
            IPND_OM_LOG1( __FILE__, __LINE__, ModulePID, Level, pcString, (VOS_INT32)(lPara1))

#define IPND_LOG2(ModulePID, SubMod, Level, pcString, lPara1,lPara2) \
            IPND_OM_LOG2( __FILE__, __LINE__, ModulePID, Level, pcString, (VOS_INT32)(lPara1),(VOS_INT32)(lPara2))

#define IPND_LOG3(ModulePID, SubMod, Level, pcString, lPara1,lPara2,lPara3) \
            IPND_OM_LOG3( __FILE__, __LINE__, ModulePID, Level, pcString, (VOS_INT32)(lPara1),(VOS_INT32)(lPara2),(VOS_INT32)(lPara3))

#define IPND_LOG4(ModulePID, SubMod, Level, pcString, lPara1,lPara2,lPara3,lPara4) \
            IPND_OM_LOG4( __FILE__, __LINE__, ModulePID, Level, pcString, (VOS_INT32)(lPara1),(VOS_INT32)(lPara2),(VOS_INT32)(lPara3),(VOS_INT32)(lPara4))

#define IPND_INFO_LOG(ModuleId, String)  IPND_LOG( ModuleId, 0,LOG_LEVEL_INFO, String)
#define IPND_INFO_LOG1(ModuleId, String,Para1)  IPND_LOG1( ModuleId, 0,LOG_LEVEL_INFO, String, Para1)
#define IPND_INFO_LOG2(ModuleId, String,Para1,Para2)  IPND_LOG2( ModuleId, 0,LOG_LEVEL_INFO, String, Para1,Para2)
#define IPND_INFO_LOG3(ModuleId, String,Para1,Para2,Para3)  IPND_LOG3( ModuleId, 0,LOG_LEVEL_INFO, String, Para1,Para2,Para3)
#define IPND_INFO_LOG4(ModuleId, String,Para1,Para2,Para3,Para4)  IPND_LOG4( ModuleId, 0,LOG_LEVEL_INFO, String, Para1,Para2,Para3,Para4)


#define IPND_WARNING_LOG(ModuleId, String)  IPND_LOG( ModuleId, 0,LOG_LEVEL_WARNING, String)
#define IPND_WARNING_LOG1(ModuleId, String,Para1)  IPND_LOG1( ModuleId, 0,LOG_LEVEL_WARNING, String, Para1)
#define IPND_WARNING_LOG2(ModuleId, String,Para1,Para2)  IPND_LOG2( ModuleId, 0,LOG_LEVEL_WARNING, String, Para1,Para2)
#define IPND_WARNING_LOG3(ModuleId, String,Para1,Para2,Para3)  IPND_LOG3( ModuleId, 0,LOG_LEVEL_WARNING, String, Para1,Para2,Para3)
#define IPND_WARNING_LOG4(ModuleId, String,Para1,Para2,Para3,Para4)  IPND_LOG4( ModuleId, 0,LOG_LEVEL_WARNING, String, Para1,Para2,Para3,Para4)

#define IPND_ERROR_LOG(ModuleId, String)  IPND_LOG( ModuleId, 0,LOG_LEVEL_ERROR, String)
#define IPND_ERROR_LOG1(ModuleId, String,Para1)  IPND_LOG1( ModuleId, 0,LOG_LEVEL_ERROR, String, Para1)
#define IPND_ERROR_LOG2(ModuleId, String,Para1,Para2)  IPND_LOG2( ModuleId, 0,LOG_LEVEL_ERROR, String, Para1,Para2)
#define IPND_ERROR_LOG3(ModuleId, String,Para1,Para2,Para3)  IPND_LOG3( ModuleId, 0,LOG_LEVEL_ERROR, String, Para1,Para2,Para3)
#define IPND_ERROR_LOG4(ModuleId, String,Para1,Para2,Para3,Para4)  IPND_LOG4( ModuleId, 0,LOG_LEVEL_ERROR, String, Para1,Para2,Para3,Para4)
...
/*IP模块打印begin*/
extern VOS_VOID IPND_OM_LOG( const VOS_CHAR  *pcFileName,  VOS_UINT32  ulLineNum,
                           VOS_UINT32      ulModuleId,   VOS_UINT32 ulLevel,
                           const VOS_CHAR  *pcString );
extern VOS_VOID IPND_OM_LOG1( const VOS_CHAR   *pcFileName, VOS_UINT32  ulLineNum,
                            VOS_UINT32  ulModuleId,       VOS_UINT32 ulLevel,
                            const VOS_CHAR    *pcString,  VOS_INT32  lPara1);
extern VOS_VOID IPND_OM_LOG2( const VOS_CHAR   *pcFileName, VOS_UINT32  ulLineNum,
                            VOS_UINT32 ulModuleId,        VOS_UINT32 ulLevel,
                            const VOS_CHAR   *pcString,   VOS_INT32  lPara1,
                            VOS_INT32  lPara2);
extern VOS_VOID IPND_OM_LOG3( const VOS_CHAR  *pcFileName,  VOS_UINT32  ulLineNum,
                            VOS_UINT32 ulModuleId,        VOS_UINT32 ulLevel,
                            const VOS_CHAR   *pcString,   VOS_INT32  lPara1,
                            VOS_INT32  lPara2,            VOS_INT32  lPara3);
extern VOS_VOID IPND_OM_LOG4( const VOS_CHAR   *pcFileName, VOS_UINT32  ulLineNum,
                            VOS_UINT32 ulModuleId,        VOS_UINT32 ulLevel,
                            const VOS_CHAR   *pcString,   VOS_INT32  lPara1,
                            VOS_INT32  lPara2,            VOS_INT32  lPara3,
                            VOS_INT32  lPara4);
