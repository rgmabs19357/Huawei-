...
#define  NSAPI_MEM_FAIL()     PS_LOG(WUEPS_PID_OM, 0, OM_PRINT_LEVEL_ERROR, "NAS Mem Operation Failed!");

#define  NSAPI_MSG_FAIL()     PS_LOG(WUEPS_PID_OM, 0, OM_PRINT_LEVEL_ERROR, "NAS Msg Opration Failed!");

#define  NSAPI_TIMER_FAIL()   PS_LOG(WUEPS_PID_OM, 0, OM_PRINT_LEVEL_ERROR, "NAS Timer Opration Failed!");
