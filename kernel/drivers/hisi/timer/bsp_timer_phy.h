...
extern BSP_VOID timer_32bit_count_set(BSP_U8 timerId);
extern BSP_U32 timer_input_clk_get(BSP_U8 timerId);
extern BSP_VOID timer_int_clear(BSP_U8 timerId);
extern BSP_VOID timer_int_mask(BSP_U8 timerId);
extern BSP_U32 timer_int_status_get(BSP_U8 timerId);
extern BSP_VOID timer_int_unmask(BSP_U8 timerId);
extern BSP_U32 timer_load_get(BSP_U8 timerId);
extern BSP_VOID timer_load_set(BSP_U8 ucTimerId, BSP_U32 ulValue);
extern BSP_U32 timer_raw_int_status_get(BSP_U8 timerId);
extern BSP_VOID timer_start(BSP_U8 timerId, BSP_U32 mode);
extern BSP_VOID timer_stop(BSP_U8 timerId);
extern BSP_S32 timer_sys_ctrl_set(void);
extern BSP_U32 timer_value_get(BSP_U8 timerId);
extern BSP_S32 timer_find_phy_id (BSP_U8 timerID);
extern BSP_S32 timer_is_running(BSP_U8 timerId);
