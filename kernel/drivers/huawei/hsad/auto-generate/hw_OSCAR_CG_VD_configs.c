...
config_pair  hw_OSCAR_CG_VD_configs [] = {
    {"apds/apds_type", (unsigned int)7, E_CONFIG_DATA_TYPE_INT },
    {"atmel/slave_address", (unsigned int)51, E_CONFIG_DATA_TYPE_INT },
    {"audio/aud_para", (const unsigned int)(unsigned int*)"OSCAR", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"OSCAR_CG_VD", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"OSCAR_CG_VD", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_OSCAR_CG_VD= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_CG_VD,
 .data_array={.config_pair_ptr=hw_OSCAR_CG_VD_configs},
 .list={NULL,NULL},
};
