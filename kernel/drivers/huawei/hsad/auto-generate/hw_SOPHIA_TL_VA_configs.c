...
config_pair  hw_SOPHIA_TL_VA_configs [] = {
    ...
    {"audio/tcxo_support", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"SOPHIA_TL_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"SOPHIA_TL_VA", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_SOPHIA_TL_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_SOPHIA_TL_VA,
 .data_array={.config_pair_ptr=hw_SOPHIA_TL_VA_configs},
 .list={NULL,NULL},
};
