...
config_pair  hw_balong_ddr3cap_udp_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"balong_ddr3cap_udp", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_balong_ddr3cap_udp= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_BALONG_DDR3CAP_UDP,
 .data_array={.config_pair_ptr=hw_balong_ddr3cap_udp_configs},
 .list={NULL,NULL},
};
