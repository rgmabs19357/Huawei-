...
config_pair  hw_OSCAR_VTL_VD_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"OSCAR_4G_VD", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"OSCAR_4G_VD", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_OSCAR_VTL_VD= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_VTL_VD,
 .data_array={.config_pair_ptr=hw_OSCAR_VTL_VD_configs},
 .list={NULL,NULL},
};
