...
config_pair  hw_balong_lpddr3_udp_6361s_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"balong_lpddr3_udp_6361s", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_balong_lpddr3_udp_6361s= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_BALONG_LPDDR3_UDP_6361S,
 .data_array={.config_pair_ptr=hw_balong_lpddr3_udp_6361s_configs},
 .list={NULL,NULL},
};
