...
config_pair  hw_OSCAR_CG_VC_configs [] = {
    ...
    {"audio/comph_val", (unsigned int)194, E_CONFIG_DATA_TYPE_INT },
    ...
    {"audio/hs_4_pole_max_voltage", (unsigned int)2160, E_CONFIG_DATA_TYPE_INT },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"OSCAR_CG_VC", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"OSCAR_CG_VC", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_OSCAR_CG_VC= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_CG_VC,
 .data_array={.config_pair_ptr=hw_OSCAR_CG_VC_configs},
 .list={NULL,NULL},
};
