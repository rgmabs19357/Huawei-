...
config_pair  hw_OSCAR_VUL_VE_configs [] = {
    ...
    {"product/product_name", (const unsigned int)(unsigned int*)"OSCAR_UL", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_OSCAR_VUL_VE= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_VUL_VE,
 .data_array={.config_pair_ptr=hw_OSCAR_VUL_VE_configs},
 .list={NULL,NULL},
};
