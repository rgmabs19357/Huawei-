...
config_pair  hw_OSCAR_4G_VC_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"OSCAR_4G_VC", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_OSCAR_4G_VC= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_4G_VC,
 .data_array={.config_pair_ptr=hw_OSCAR_4G_VC_configs},
 .list={NULL,NULL},
};
