...
config_pair  hw_SOPHIA_CLG_VA_configs [] = {
    {"CCPU_GPIO_INT_GROUP/group_num", (unsigned int)2, E_CONFIG_DATA_TYPE_INT },
    {"apds/apds_type", (unsigned int)7, E_CONFIG_DATA_TYPE_INT },
    {"atmel/slave_address", (unsigned int)51, E_CONFIG_DATA_TYPE_INT },
    {"audio/aud_para", (const unsigned int)(unsigned int*)"SOPHIACLG", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"audio/gpio_es305_reset", (unsigned int)47, E_CONFIG_DATA_TYPE_INT },
    {"audio/gpio_es305_wakeup", (unsigned int)150, E_CONFIG_DATA_TYPE_INT },
    {"audio/gpio_intr", (unsigned int)7, E_CONFIG_DATA_TYPE_INT },
    {"audio/gpio_modemctl_enble", (unsigned int)62, E_CONFIG_DATA_TYPE_INT },
    ...
    {"audio/type_1_vout_max_voltage", (unsigned int)2700000, E_CONFIG_DATA_TYPE_INT },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"SOPHIA_CLG_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"modem/cbp_ack", (unsigned int)50, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_ap_rdy", (unsigned int)125, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_ap_wk_mdm", (unsigned int)46, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_cannot_sleep", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_flow_ctr", (unsigned int)109, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_mdm_rdy", (unsigned int)128, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_mdm_wk_ap", (unsigned int)28, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_pwr_en", (unsigned int)122, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_rst", (unsigned int)126, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_rst_ind", (unsigned int)3, E_CONFIG_DATA_TYPE_INT },
    {"modem/gpio_cbp_backup", (unsigned int)48, E_CONFIG_DATA_TYPE_INT },
    {"modem/gpio_cbp_sim_switch", (unsigned int)24, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"SOPHIA_CLG_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"tech/tech_type", (unsigned int)25, E_CONFIG_DATA_TYPE_INT },
    ...
    {"wifi/nvram", (const unsigned int)(unsigned int*)"nvram_SOPHIA_CLG", E_CONFIG_DATA_TYPE_STRING },
    {0, 0, 0}
 };
struct board_id_general_struct config_common_SOPHIA_CLG_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_SOPHIA_CLG_VA,
 .data_array={.config_pair_ptr=hw_SOPHIA_CLG_VA_configs},
 .list={NULL,NULL},
};
