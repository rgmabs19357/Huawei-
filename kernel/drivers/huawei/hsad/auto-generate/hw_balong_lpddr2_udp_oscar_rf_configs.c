...
config_pair  hw_balong_lpddr2_udp_oscar_rf_configs [] = {
    ...
    {"audio/gpio_intr", (unsigned int)28, E_CONFIG_DATA_TYPE_INT },
    ...
    {"bluetooth/gpio_bt_en", (unsigned int)10, E_CONFIG_DATA_TYPE_INT },
    {"bluetooth/gpio_bt_wake_host", (unsigned int)5, E_CONFIG_DATA_TYPE_INT },
    {"bluetooth/gpio_host_wake_bt", (unsigned int)11, E_CONFIG_DATA_TYPE_INT },
    ...
    {"gas_gauge/bq27510_enable", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"gas_gauge/charger_enable", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"gas_gauge/low_power_int", (unsigned int)27, E_CONFIG_DATA_TYPE_INT },
    ...
    {"keyboard/key_back", (unsigned int)26, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"balong_lpddr2_udp", E_CONFIG_DATA_TYPE_STRING },
    {"pwc/afreq", (unsigned int)1596000, E_CONFIG_DATA_TYPE_INT },
    {"pwc/gfreq", (unsigned int)530000, E_CONFIG_DATA_TYPE_INT },
    ...
    {"sd_card/sdcard_frequency", (unsigned int)90, E_CONFIG_DATA_TYPE_INT },
    ...
    {"sensor/gsensor_gpio", (unsigned int)122, E_CONFIG_DATA_TYPE_INT },
...
struct board_id_general_struct config_common_balong_lpddr2_udp_oscar_rf= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_BALONG_LPDDR2_UDP_OSCAR_RF,
 .data_array={.config_pair_ptr=hw_balong_lpddr2_udp_oscar_rf_configs},
 .list={NULL,NULL},
};
