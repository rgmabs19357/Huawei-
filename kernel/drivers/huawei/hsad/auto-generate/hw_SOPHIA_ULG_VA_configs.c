...
config_pair  hw_SOPHIA_ULG_VA_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"SOPHIA_ULG_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"SOPHIA_ULG_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"sensor/sensor_type", (unsigned int)4, E_CONFIG_DATA_TYPE_INT },
...
struct board_id_general_struct config_common_SOPHIA_ULG_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_SOPHIA_ULG_VA,
 .data_array={.config_pair_ptr=hw_SOPHIA_ULG_VA_configs},
 .list={NULL,NULL},
};
