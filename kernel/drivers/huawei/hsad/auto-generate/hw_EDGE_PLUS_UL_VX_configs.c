...
config_pair  hw_EDGE_PLUS_UL_VX_configs [] = {
    {"apds/apds_type", (unsigned int)5, E_CONFIG_DATA_TYPE_INT },
    {"atmel/slave_address", (unsigned int)51, E_CONFIG_DATA_TYPE_INT },
    {"audio/aud_para", (const unsigned int)(unsigned int*)"EDGEPUL", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"audio/modem_algo", (const unsigned int)(unsigned int*)"FORTE", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UL_VX", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"camera/iopower", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"charger/aux_batt", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"gps/gpio_gps_en", (unsigned int)3, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UL_VX", E_CONFIG_DATA_TYPE_STRING },
    {"product/product_name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UL", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"wifi/gpio_wifi_enable", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    {"wifi/gpio_wifi_irq", (unsigned int)4, E_CONFIG_DATA_TYPE_INT },
    {"wifi/nvram", (const unsigned int)(unsigned int*)"nvram_EDGE_PLUS_UL_EMO", E_CONFIG_DATA_TYPE_STRING },
    {"wifi/wifi_clock", (unsigned int)50000000, E_CONFIG_DATA_TYPE_INT },
    {0, 0, 0}
 };
struct board_id_general_struct config_common_EDGE_PLUS_UL_VX= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_EDGE_PLUS_UL_VX,
 .data_array={.config_pair_ptr=hw_EDGE_PLUS_UL_VX_configs},
 .list={NULL,NULL},
};
