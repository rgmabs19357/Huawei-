...
config_pair  hw_EDGE_PLUS_UL_VY_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UL_VY", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UL_VY", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_EDGE_PLUS_UL_VY= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_EDGE_PLUS_UL_VY,
 .data_array={.config_pair_ptr=hw_EDGE_PLUS_UL_VY_configs},
 .list={NULL,NULL},
};
