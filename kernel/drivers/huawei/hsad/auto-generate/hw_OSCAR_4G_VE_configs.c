...
config_pair  hw_OSCAR_4G_VE_configs [] = {
...
struct board_id_general_struct config_common_OSCAR_4G_VE= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_4G_VE,
 .data_array={.config_pair_ptr=hw_OSCAR_4G_VE_configs},
 .list={NULL,NULL},
};
