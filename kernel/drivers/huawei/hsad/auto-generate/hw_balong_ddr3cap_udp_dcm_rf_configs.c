...
config_pair  hw_balong_ddr3cap_udp_dcm_rf_configs [] = {
...
struct board_id_general_struct config_common_balong_ddr3cap_udp_dcm_rf= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_BALONG_DDR3CAP_UDP_DCM_RF,
 .data_array={.config_pair_ptr=hw_balong_ddr3cap_udp_dcm_rf_configs},
 .list={NULL,NULL},
};
