...
config_pair  hw_balong_lpddr2_udp_configs [] = {
...
struct board_id_general_struct config_common_balong_lpddr2_udp= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_BALONG_LPDDR2_UDP,
 .data_array={.config_pair_ptr=hw_balong_lpddr2_udp_configs},
 .list={NULL,NULL},
};
