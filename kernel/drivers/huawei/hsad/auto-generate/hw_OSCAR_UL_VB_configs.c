...
config_pair  hw_OSCAR_UL_VB_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"OSCAR_UL_VB", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"OSCAR_UL_VB", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"wifi/nvram", (const unsigned int)(unsigned int*)"nvram_OSCAR_UL", E_CONFIG_DATA_TYPE_STRING },
    {"wifi/wifi_clock", (unsigned int)50000000, E_CONFIG_DATA_TYPE_INT },
    {0, 0, 0}
 };
struct board_id_general_struct config_common_OSCAR_UL_VB= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_UL_VB,
 .data_array={.config_pair_ptr=hw_OSCAR_UL_VB_configs},
 .list={NULL,NULL},
};
