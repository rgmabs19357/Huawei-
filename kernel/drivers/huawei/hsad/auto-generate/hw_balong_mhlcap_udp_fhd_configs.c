...
config_pair  hw_balong_mhlcap_udp_fhd_configs [] = {
    ...
    {"board/type", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    {"camera/OV5648SN", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"camera/S5K4E1GA", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"camera/SONYIMX134", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"charger/charger_int", (unsigned int)24, E_CONFIG_DATA_TYPE_INT },
    ...
    {"cypress/flip_x", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"keyboard/key_back", (unsigned int)31, E_CONFIG_DATA_TYPE_INT },
    ...
    {"lcd/devices", (const unsigned int)(unsigned int*)"mipi_toshiba_MDY90", E_CONFIG_DATA_TYPE_STRING },
    {"lcd/gpio_lcd_id0", (unsigned int)36, E_CONFIG_DATA_TYPE_INT },
    {"lcd/gpio_lcd_id1", (unsigned int)37, E_CONFIG_DATA_TYPE_INT },
    {"lcd/gpio_lcd_power", (unsigned int)107, E_CONFIG_DATA_TYPE_INT },
    {"lcd/gpio_lcd_reset", (unsigned int)38, E_CONFIG_DATA_TYPE_INT },
    {"lcd/resolution_type", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"memory_config/fb", (unsigned int)38912, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/gpu", (unsigned int)16384, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/gralloc", (unsigned int)196608, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/overlay", (unsigned int)192512, E_CONFIG_DATA_TYPE_INT },
    ...
    {"modem/cbp_ack", (unsigned int)57, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_ap_rdy", (unsigned int)125, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_ap_wk_mdm", (unsigned int)45, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_flow_ctr", (unsigned int)59, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_mdm_rdy", (unsigned int)128, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_mdm_wk_ap", (unsigned int)28, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_pwr_en", (unsigned int)124, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_rst", (unsigned int)126, E_CONFIG_DATA_TYPE_INT },
    {"modem/cbp_rst_ind", (unsigned int)3, E_CONFIG_DATA_TYPE_INT },
    {"modem/viacbp82d", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"balong_mhlcap_udp_fhd", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"sd_card/sdcard_frequency", (unsigned int)10, E_CONFIG_DATA_TYPE_INT },
    ...
    {"sim/sim1_present_electrical_lvl", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"sim/sim2_detection_gpio", (unsigned int)23, E_CONFIG_DATA_TYPE_INT },
    {"sim/sim2_present_electrical_lvl", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"synaptics/attn_gpio", (unsigned int)30, E_CONFIG_DATA_TYPE_INT },
    {"synaptics/flip_x", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    {"synaptics/flip_y", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"synaptics/irq_config", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    {"synaptics/is_incell", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"synaptics/vdd_voltage", (unsigned int)2800000, E_CONFIG_DATA_TYPE_INT },
    ...
    {"touchscreen/product", (const unsigned int)(unsigned int*)"udp", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"usb/ashell_enable", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"usb/switch_id_pin", (unsigned int)63, E_CONFIG_DATA_TYPE_INT },
    ...
    {"wifi/nvram", (const unsigned int)(unsigned int*)"nvram_EDGE_PLUS_UG", E_CONFIG_DATA_TYPE_STRING },
    {"wifi/wifi_clock", (unsigned int)50000000, E_CONFIG_DATA_TYPE_INT },
    {0, 0, 0}
 };
struct board_id_general_struct config_common_balong_mhlcap_udp_fhd= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_BALONG_MHLCAP_UDP_FHD,
 .data_array={.config_pair_ptr=hw_balong_mhlcap_udp_fhd_configs},
 .list={NULL,NULL},
};
