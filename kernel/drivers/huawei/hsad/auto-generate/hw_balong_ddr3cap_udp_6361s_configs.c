...
config_pair  hw_balong_ddr3cap_udp_6361s_configs [] = {
    ...
    {"lcd/devices", (const unsigned int)(unsigned int*)"mipi_jdi_OTM1282B", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"memory_config/gralloc", (unsigned int)155763, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/overlay", (unsigned int)58829, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"balong_ddr3cap_udp_6361s", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"touchscreen/support_chip_name_2", (const unsigned int)(unsigned int*)"null", E_CONFIG_DATA_TYPE_STRING },
    {"touchscreen/support_chip_name_3", (const unsigned int)(unsigned int*)"null", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_balong_ddr3cap_udp_6361s= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_BALONG_DDR3CAP_UDP_6361S,
 .data_array={.config_pair_ptr=hw_balong_ddr3cap_udp_6361s_configs},
 .list={NULL,NULL},
};
