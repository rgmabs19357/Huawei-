...
config_pair  hw_OSCAR_CG_VA_configs [] = {
    ...
    {"bluetooth/gpio_bt_en", (unsigned int)125, E_CONFIG_DATA_TYPE_INT },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"OSCAR_CG_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"cdma_gsm/cdma_select", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    {"cdma_gsm/cg_mode", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"cdma_gsm/ctr_gpio", (unsigned int)62, E_CONFIG_DATA_TYPE_INT },
    ...
    {"gas_gauge/ss_use_pmu_ocv", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"nfc/clock_src", (const unsigned int)(unsigned int*)"XTAL", E_CONFIG_DATA_TYPE_STRING },
    {"nfc/gpio_nfc_enable", (unsigned int)59, E_CONFIG_DATA_TYPE_INT },
    {"nfc/gpio_nfc_enable_valid", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"OSCAR_CG_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"sensor/compass_gpio", (unsigned int)27, E_CONFIG_DATA_TYPE_INT },
    ...
    {"sensor/hall_gpio_config_ln", (const unsigned int)(unsigned int*)"w_51", E_CONFIG_DATA_TYPE_STRING },
    {"sensor/hall_gpio_config_ls", (const unsigned int)(unsigned int*)"s_114", E_CONFIG_DATA_TYPE_STRING },
    {"sensor/hall_gpio_config_rn", (const unsigned int)(unsigned int*)"w_128", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"wifi/gpio_wifi_enable", (unsigned int)18, E_CONFIG_DATA_TYPE_INT },
...
struct board_id_general_struct config_common_OSCAR_CG_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_CG_VA,
 .data_array={.config_pair_ptr=hw_OSCAR_CG_VA_configs},
 .list={NULL,NULL},
};
