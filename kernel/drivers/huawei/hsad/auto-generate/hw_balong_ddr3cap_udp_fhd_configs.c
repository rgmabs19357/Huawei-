...
config_pair  hw_balong_ddr3cap_udp_fhd_configs [] = {
    ...
    {"mhl/type", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"balong_ddr3cap_udp_fhd", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_balong_ddr3cap_udp_fhd= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_BALONG_DDR3CAP_UDP_FHD,
 .data_array={.config_pair_ptr=hw_balong_ddr3cap_udp_fhd_configs},
 .list={NULL,NULL},
};
