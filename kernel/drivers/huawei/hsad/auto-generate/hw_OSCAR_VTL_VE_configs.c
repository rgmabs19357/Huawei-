...
config_pair  hw_OSCAR_VTL_VE_configs [] = {
    {"apds/apds_type", (unsigned int)7, E_CONFIG_DATA_TYPE_INT },
    {"atmel/slave_address", (unsigned int)51, E_CONFIG_DATA_TYPE_INT },
    {"audio/aud_para", (const unsigned int)(unsigned int*)"OSCARUL", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"OSCAR_4G_VE", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"gas_gauge/current_offset_a", (unsigned int)1000000, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"OSCAR_4G_VE", E_CONFIG_DATA_TYPE_STRING },
    {"product/product_name", (const unsigned int)(unsigned int*)"OSCAR_TL", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"tech/dsda_single_rild", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"tech/hw_sglte", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"touchscreen/product", (const unsigned int)(unsigned int*)"oscar", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"usb/eye_pattern", (unsigned int)0x708334ea, E_CONFIG_DATA_TYPE_INT },
    ...
    {"wifi/nvram", (const unsigned int)(unsigned int*)"nvram_OSCAR_4G", E_CONFIG_DATA_TYPE_STRING },
    {"wifi/wifi_clock", (unsigned int)50000000, E_CONFIG_DATA_TYPE_INT },
    {0, 0, 0}
 };
struct board_id_general_struct config_common_OSCAR_VTL_VE= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_VTL_VE,
 .data_array={.config_pair_ptr=hw_OSCAR_VTL_VE_configs},
 .list={NULL,NULL},
};
