...
config_pair  hw_EDGE_PLUS_UL_VA_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UG_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UL_VA", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_EDGE_PLUS_UL_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_EDGE_PLUS_UL_VA,
 .data_array={.config_pair_ptr=hw_EDGE_PLUS_UL_VA_configs},
 .list={NULL,NULL},
};
