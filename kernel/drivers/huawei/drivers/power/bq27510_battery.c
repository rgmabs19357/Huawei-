...
int get_battery_id(void)
{
    ...
    battery_ptesent = 1;//is_bq27510_battery_exist(di);
    if(!battery_ptesent){
...
#define CHECK_DI() \
    if(g_battery_measure_by_bq27510_device == NULL)\
        return -1;
    
int hisi_bq27510_battery_temperature()
{
    CHECK_DI();
    return bq27510_battery_temperature(g_battery_measure_by_bq27510_device);
}
int hisi_bq27510_battery_voltage()
{
    CHECK_DI();
    return bq27510_battery_voltage(g_battery_measure_by_bq27510_device);
}
int hisi_is_bq27510_battery_reach_threshold()
{
    CHECK_DI();
    return is_bq27510_battery_reach_threshold(g_battery_measure_by_bq27510_device);
}
int hisi_is_bq27510_battery_exist()
{
    CHECK_DI();
    return is_bq27510_battery_exist(g_battery_measure_by_bq27510_device);
}
hisi_bq27510_battery_unfiltered_capacity()
{
    CHECK_DI();
    return bq27510_battery_capacity(g_battery_measure_by_bq27510_device);
}
int hisi_bq27510_battery_capacity()
{
    CHECK_DI();
    return bq27510_battery_capacity(g_battery_measure_by_bq27510_device);
}

int hisi_bq27510_battery_rm()
{
    CHECK_DI();
    return bq27510_battery_rm(g_battery_measure_by_bq27510_device);
}
int hisi_bq27510_battery_fcc()
{
    CHECK_DI();
    return bq27510_battery_fcc(g_battery_measure_by_bq27510_device);
}
int hisi_bq27510_battery_health()
{
    CHECK_DI();
    return bq27510_battery_health(g_battery_measure_by_bq27510_device);
}
int hisi_bq27510_battery_capacity_level()
{
    CHECK_DI();
    return bq27510_battery_capacity_level(g_battery_measure_by_bq27510_device);
}
int hisi_bq27510_battery_technology()
{
    CHECK_DI();
    return bq27510_battery_technology(g_battery_measure_by_bq27510_device);
}

short hisi_bq27510_battery_current()
{
    CHECK_DI();
    return (int)bq27510_battery_current(g_battery_measure_by_bq27510_device);
}
short hisi_bq27510_battery_current_avg()
{
    CHECK_DI();
    return (int)bq27510_battery_current(g_battery_measure_by_bq27510_device);
}
int hisi_bq27510_battery_tte()
{
    CHECK_DI();
    return bq27510_battery_tte(g_battery_measure_by_bq27510_device);
}
int hisi_bq27510_battery_ttf()
{
    CHECK_DI();
    return bq27510_battery_ttf(g_battery_measure_by_bq27510_device);
}

int hisi_is_bq27510_battery_full()
{
    CHECK_DI();
    return is_bq27510_battery_full(g_battery_measure_by_bq27510_device);
}
                            ...
                            struct device_attribute *attr, char *buf)
{
    ...
    val *=1000;
    if(get_boot_into_recovery_flag() && strstr(saved_command_line, "androidboot.swtype=factory")){
                                 ...
                                 const struct i2c_device_id *id)
{
    ...
    if(ret)
    {
	pr_err("gpio_direction_input error\n");
        goto batt_failed_4;
    }
    ...
    if (!coul_ops) {
		BQ27510_ERR("failed to alloc coul_ops struct\n");
		retval = -ENOMEM;
        goto batt_failed_5;
    }

    coul_ops->is_coul_ready = NULL;
    coul_ops->is_battery_exist = hisi_is_bq27510_battery_exist;
    coul_ops->is_battery_reach_threshold = hisi_is_bq27510_battery_reach_threshold;
    coul_ops->is_battery_full = hisi_is_bq27510_battery_full;
    coul_ops->battery_voltage = hisi_bq27510_battery_voltage;
    coul_ops->battery_current = hisi_bq27510_battery_current;
    coul_ops->battery_current_avg = hisi_bq27510_battery_current_avg;
    coul_ops->battery_unfiltered_capacity = hisi_bq27510_battery_unfiltered_capacity;
    coul_ops->battery_capacity = hisi_bq27510_battery_capacity;
    coul_ops->battery_temperature = hisi_bq27510_battery_temperature;
    coul_ops->battery_rm = hisi_bq27510_battery_rm;
    coul_ops->battery_fcc = hisi_bq27510_battery_fcc;
    coul_ops->battery_tte = hisi_bq27510_battery_tte;
    coul_ops->battery_ttf = hisi_bq27510_battery_ttf;
    coul_ops->battery_health = hisi_bq27510_battery_health;
    coul_ops->battery_capacity_level = hisi_bq27510_battery_capacity_level;
    coul_ops->battery_technology = hisi_bq27510_battery_technology;
    coul_ops->charger_event_rcv = NULL;

    di->ops = coul_ops;
    retval = hisi_coul_ops_register(coul_ops,COUL_SMARTSTAR);
    if (retval) {
        BQ27510_ERR("failed to register coul ops\n");
        goto batt_failed_6;
    }
#endif
