/*
 *  s5k4e1ga_foxconn camera driver head file
 *
...
#ifndef _S5K4E1GA_FOXCONN_H
#define _S5K4E1GA_FOXCONN_H

//#include "../isp/k3_isp_io.h"
/***********************************************************************
 *
 * s5k4e1ga_foxconn init sensor registers list
 *
 ***********************************************************************/
const struct _sensor_reg_t s5k4e1ga_foxconn_init_regs[] = {
...
{0x3111, 0xc6},//Embedded data off [5]  //0x86
...
{0x0200, 0x03},//fine integration time µÕ’’∂»œ¬ÃıŒ∆
{0x0201, 0x00},
...
/*1280x960*/
const struct _sensor_reg_t s5k4e1ga_foxconn_framesize_1280x960[] = {
...
/*1920x1080*/
const struct _sensor_reg_t s5k4e1ga_foxconn_framesize_1080p[] = {
{0x0100, 0x00},//stream off
{0x0105, 0x01}, //
{0x301B, 0x75},
...
/*2592x1952*/
const struct _sensor_reg_t s5k4e1ga_foxconn_framesize_full[] = {
{0x0100, 0x00},//stream off
{0x0105, 0x01}, //
{0x301B, 0x75},
...
#endif /* S5K4E1GA_FOXCONN_H_INCLUDED */
