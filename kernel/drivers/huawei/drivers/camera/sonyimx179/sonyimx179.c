...
#define SONYIMX179_EQUIVALENT_FOCUS      (21)  //21mm
/*iso*/
...
static otp_data sonyimx179_otp;
...
static framesize_s sonyimx179_framesizes[] = {
	...
	{0, 0, 1600, 1200, 3440, 1712, 30, 30, 0x201, 0x1AB, 0x24F, VIEW_FULL, RESOLUTION_4_3, true, false,{(sensor_reg_t *)sonyimx179_framesize_1600x1200, ARRAY_SIZE(sonyimx179_framesize_1600x1200)} }, 

	/* 3264x2448, 15fps full size */
	{0, 0, 3264, 2448, 3440, 3424, 15, 15, 0x201, 0x1AB, 0x24F, VIEW_FULL, RESOLUTION_4_3, false, false, {(sensor_reg_t *)sonyimx179_framesize_3264x2448, ARRAY_SIZE(sonyimx179_framesize_3264x2448)} },
};
...
/*sonyimx179_get_equivalent_focus*/
