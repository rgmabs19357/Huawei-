...
//#define OV5847_SUNNY_AP_WRITEAE_MODE
#include "effect.h"
#include "cam_util.h"
...
#define OV5648_SUNNY_I2C_RETRY_TIMES  5
...
static camera_capability ov5648_sunny_cap[] = {
    {V4L2_CID_FOCAL_LENGTH, 439},//4.39mm
...
static framesize_s ov5648_sunny_framesizes[] = {
	{0, 0, 1280, 960, 1408, 1320, 30, 30, 0x18D, 0x14B, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false, {ov5648_sunny_framesize_quarter, ARRAY_SIZE(ov5648_sunny_framesize_quarter)} },
	{0, 0, 2592, 1952, 2816, 2088, 15, 15, 0x138, 0x104, 0xC9, VIEW_FULL, RESOLUTION_4_3, false, false, {ov5648_sunny_framesize_full, ARRAY_SIZE(ov5648_sunny_framesize_full)} },
};
...
static int ov5648_sunny_update_flip(u16 width, u16 height)
{
	...
	ov5648_sunny_write_reg(OV5648_SUNNY_FLIP_REG, ov5648_sunny_sensor.vflip ? 0x06 : 0x00, ~0x06);
...
static int ov5648_sunny_stream_on(camera_state state)
{
	...
	return ov5648_sunny_framesize_switch(state);
}
...
static int ov5648_sunny_check_sensor(void)
{
	...
	u16 id = 0;
    int retry = 0;
    for(retry = 0; retry < OV5648_SUNNY_I2C_RETRY_TIMES; retry++) {
...
static int ov5648_sunny_init(void)
{
	...
	if (false == ov5648_sunny_check) {
        if (check_suspensory_camera("OV5648SN") != 1) {
    		print_error("%s: product not have this sensor", __func__);
            return -ENODEV;     
        }       
        ov5648_sunny_check = true;
    }
...
static void ov5648_sunny_set_default(void)
{
	...
	ov5648_sunny_sensor.isp_idi_skip = false;
}
