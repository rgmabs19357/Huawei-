...
/*isp_reg_t*/
{
	...
	{0x65603,0xa0},//y00215412 change sharpness high gain threshod 0x40->0x60 20120814
...
/*dns*/
{
    ...
    {
        /*raw_dns_coff*/
        {{0x08,0x0d,0x13,0x27,0x39,0x60},{0x0c,0x0e,0x10,0x12,0x14,0x16},{0x0c,0x0e,0x10,0x12,0x14,0x16}},
        {{0x08,0x0d,0x13,0x27,0x39,0x60},{0x0c,0x0e,0x10,0x12,0x14,0x16},{0x0c,0x0e,0x10,0x12,0x14,0x16}},
        {{0x08,0x0d,0x13,0x27,0x39,0x60},{0x0c,0x0e,0x10,0x12,0x14,0x16},{0x0c,0x0e,0x10,0x12,0x14,0x16}},
...
/*isp_reg_t*/
{
	...
	{0x1da0c,0x74},//B gain for H High light
	{0x1da0d,0x76},//B gain for H
	{0x1da0e,0x78},//B gain for H
	{0x1da0f,0x7a},//B gain for H low light
	...
	{0x1da05,0x80},//B gain for A
	{0x1da06,0x7d},//B gain for A
	{0x1da07,0x7c},//B gain for A low light
	{0x1da08,0x84},//R gain for A High light
	{0x1da09,0x88},//R gain for A
	{0x1da0a,0x8c},//R gain for A
	{0x1da0b,0x95},//R gain for A low light

	{0x1d9ec,0x83},//B gain for mix High light
	{0x1d9ed,0x84},//B gain for mix
	{0x1d9ee,0x87},//B gain for mix
	{0x1d9ef,0x8b},//B gain for mix low light
	{0x1d9f0,0x86},//R gain for mix High light
	{0x1d9f1,0x88},//R gain for mix
	{0x1d9f2,0x8a},//R gain for mix
	{0x1d9f3,0x8c},//R gain for mix low light

	{0x1d9f4,0x80},//B gain for cwf High light
	{0x1d9f5,0x81},//B gain for cwf
	{0x1d9f6,0x84},//B gain for cwf
	{0x1d9f7,0x88},//B gain for cwf low light
	{0x1d9f8,0x86},//R gain for cwf High light
	{0x1d9f9,0x87},//R gain for cwf
	{0x1d9fa,0x88},//R gain for cwf
	{0x1d9fb,0x89},//R gain for cwf low light

	{0x1d9fc,0x7e},//B gain for D High light
	{0x1d9fd,0x7d},//B gain for D
	{0x1d9fe,0x7b},//B gain for D
	{0x1d9ff,0x79},//B gain for D low light
	{0x1da00,0x7f},//R gain for D High light
	{0x1da01,0x84},//R gain for D
	{0x1da02,0x86},//R gain for D
	{0x1da03,0x88},//R gain for D low light
	...
	{0x65602,0x00},//max gain
	{0x65603,0xC0},//y00215412 change sharpness high gain threshod 0x40->0x60 20120814
	{0x6560c,0x04},//min sharp
	...
	{0x65643,0xa0},//y00215412 change sharpness high gain threshod 0x40->0x60 20120814
	{0x6564c,0x04},
	{0x6564d,0x0e},//low gain sharpness, 20120814 0x20->0x30
	{0x6564e,0x10},//MinSharpenTp
	{0x6564f,0x60},//MaxSharpenTp
	{0x65650,0x10},//MinSharpenTm
	{0x65651,0x60},//MaxSharpenTm
