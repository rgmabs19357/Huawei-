...
#define SONYIMX135_MAX_ANALOG_GAIN2			31
...
static framesize_s sonyimx135_rgbw_es1_framesizes[] = {
	{0, 2, 2048, 1536, 4572, 1850, 30, 25, 0x19A, 0x155, 0x100, VIEW_FULL, RESOLUTION_4_3, true, false,{(sensor_reg_t *)sonyimx135_rgbw_es1_framesize_2048x1536, ARRAY_SIZE(sonyimx135_rgbw_es1_framesize_2048x1536)} },
	{0, 2, 4160, 3120, 4572, 3142, 10, 5, 0x15D, 0x123, 0xA0, VIEW_FULL, RESOLUTION_4_3, false, false,{(sensor_reg_t *)sonyimx135_rgbw_es1_framesize_full, ARRAY_SIZE(sonyimx135_rgbw_es1_framesize_full)} },
};

static framesize_s sonyimx135_rgb_framesizes[] = {
	{0, 0, 1920, 1088, 4572, 2624, 30, 25, 0x313, 0x290, 0x100, VIEW_HDR_MOVIE, RESOLUTION_16_9, false, false,{(sensor_reg_t *)sonyimx135_rgb_framesize_1920x1088_HDR, ARRAY_SIZE(sonyimx135_rgb_framesize_1920x1088_HDR)} },
	{0, 0, 2048, 1536, 4572, 3236, 21, 21, 0x313, 0x290, 0x100, VIEW_HDR_MOVIE, RESOLUTION_4_3, false, false,{(sensor_reg_t *)sonyimx135_rgb_framesize_2048x1536_HDR, ARRAY_SIZE(sonyimx135_rgb_framesize_2048x1536_HDR)} },
	{0, 0, 1920, 1088, 4572, 2324, 30, 30, 0X2BB, 0X247, 0x280, VIEW_FULL, RESOLUTION_16_9, true, false,{(sensor_reg_t *)sonyimx135_rgb_framesize_1920x1088, ARRAY_SIZE(sonyimx135_rgb_framesize_1920x1088)}},
	{0, 0, 2080, 1560, 4572, 2330, 30, 30, 0x2BB, 0x247, 0x280, VIEW_FULL, RESOLUTION_4_3, true, false,{(sensor_reg_t *)sonyimx135_rgb_framesize_2080x1560, ARRAY_SIZE(sonyimx135_rgb_framesize_2080x1560)} },
	{0, 0, 3264, 2448, 4572, 3142, 30, 30, 0x3B0, 0x313, 0x360, VIEW_FULL, RESOLUTION_4_3, false, true,{(sensor_reg_t *)sonyimx135_rgb_framesize_3264x2448, ARRAY_SIZE(sonyimx135_rgb_framesize_3264x2448)} },
	{0, 0, 3280, 1960, 4572, 2566, 30, 30, 0x301, 0x281, 0x2C0, VIEW_FULL, RESOLUTION_16_9, false, true,{(sensor_reg_t *)sonyimx135_rgb_framesize_3280x1960, ARRAY_SIZE(sonyimx135_rgb_framesize_3280x1960)} },
	{0, 0, 4160, 3120, 4572, 3264, 23, 23, 0x2F0, 0x273, 0x2B0, VIEW_FULL, RESOLUTION_4_3, false, true,{(sensor_reg_t *)sonyimx135_rgb_framesize_4160x3120_zsl, ARRAY_SIZE(sonyimx135_rgb_framesize_4160x3120_zsl)} },	
	{0, 0, 4160, 3120, 4582, 4664, 10, 10, 0x1A3, 0x15D, 0x17F, VIEW_FULL, RESOLUTION_4_3, false, false,{(sensor_reg_t *)sonyimx135_rgb_framesize_4160x3120_nozsl_full, ARRAY_SIZE(sonyimx135_rgb_framesize_4160x3120_nozsl_full)} },	
};

static framesize_s sonyimx135_rgbw_es2_framesizes[] = {
	{0, 2, 2048, 1536, 4572, 1850, 30, 25, 0x19A, 0x155, 0x100, VIEW_FULL, RESOLUTION_4_3, true, false,{(sensor_reg_t *)sonyimx135_rgbw_es2_framesize_2048x1536, ARRAY_SIZE(sonyimx135_rgbw_es2_framesize_2048x1536)} },
	{0, 2, 4160, 3120, 4572, 3142, 10, 5, 0x15D, 0x123, 0xA0, VIEW_FULL, RESOLUTION_4_3, false, false,{(sensor_reg_t *)sonyimx135_rgbw_es2_framesize_full, ARRAY_SIZE(sonyimx135_rgbw_es2_framesize_full)} },
};
...
static imx135_sensor_module sonyimx135_sensor_module[] = {
	{"sonyimx135_RGB_ES2_ADDR1",  SONYIMX135_CHIP_ID_ES2_ADRESS_H,SONYIMX135_CHIP_ID_ES2_ADRESS_L,SONYIMX135_CHIP_ID_ES2, SONYIMX135_SLAVE_ADDRESS1, 0x80, 
	     (const sensor_reg_t *)sonyimx135_rgb_init_regs, ARRAY_SIZE(sonyimx135_rgb_init_regs),sonyimx135_rgb_framesizes,ARRAY_SIZE(sonyimx135_rgb_framesizes)},
	...
	{"sonyimx135_RGBW_ES1_ADDR1", SONYIMX135_CHIP_ID_ES1_ADRESS_H,SONYIMX135_CHIP_ID_ES1_ADRESS_L,SONYIMX135_CHIP_ID_ES1, SONYIMX135_SLAVE_ADDRESS1, 0x00,
		(const sensor_reg_t *)sonyimx135_rgbw_es1_init_regs, ARRAY_SIZE(sonyimx135_rgbw_es1_init_regs),sonyimx135_rgbw_es1_framesizes,ARRAY_SIZE(sonyimx135_rgbw_es1_framesizes)},
	{"sonyimx135_RGBW_ES2_ADDR1", SONYIMX135_CHIP_ID_ES2_ADRESS_H,SONYIMX135_CHIP_ID_ES2_ADRESS_L,SONYIMX135_CHIP_ID_ES2, SONYIMX135_SLAVE_ADDRESS1, 0x00,
	      (const sensor_reg_t *)sonyimx135_rgbw_es2_init_regs, ARRAY_SIZE(sonyimx135_rgbw_es2_init_regs),sonyimx135_rgbw_es2_framesizes,ARRAY_SIZE(sonyimx135_rgbw_es2_framesizes)},
};
...
//static u8 sonyimx135_otp_bayer();  // Add for read OTP begin
...
{
	print_debug("Enter %s, seq[%0x], size=%d", __func__, (int)seq, size);
				 ...
				 struct v4l2_frmsize_discrete *fs, int flag, camera_setting_view_type view_type,bool zsl_preview)
{
	...
	print_info("Enter Function:%s State(%d), flag=%d, width=%d, height=%d,resolution_type=%d",
		    __func__, state, flag, fs->width, fs->height,camera_get_resolution_type(fs->width, fs->height));
		...
		for (i = 0; i < size; i++) {
			if ((sonyimx135_framesizes[i].width >= fs->width)
				    ...
				    && (VIEW_HDR_MOVIE == sonyimx135_framesizes[i].view_type))
			 {
					...
					match = true;
					print_info("enter %s,framesize_index=%d",__func__,i);
					break;
			}
		}
	}else{
...
{
	int size = 0;
    const struct _sensor_reg_t *sonyimx135_init_regs = sonyimx135_sensor_module[sensor_mode_index].preg;
	...
	print_info("%s, OTP flag = %0x", __func__, sonyimx135_otp_flag);
...
static void sonyimx135_reset_i2c(struct i2c_t *i2c)
{
	...
	print_info("enter %s, addr=%0x", __func__, i2c->addr);
...
static int sonyimx135_find_sensor(imx135_sensor_module *fix_sensor)
{
	...
	if (chip_id == id) 
	{
	      ...
	      sonyimx135_read_reg(SONYIMX135_OTP_CFA_FMT_REG,&fmt); 
	      print_info("enter %s,fmt = %d,fix_sensor_fmt=%d", __func__,fmt,fix_sensor_fmt);

		if((fmt & 0x80)!=(fix_sensor_fmt & 0x80))
		{
...
static int sonyimx135_check_sensor_new(void)
{
	...
	print_info("%s, OTP flag = %0x", __func__, sonyimx135_otp_flag);
       sensor->effect = &effect_imx135_liteon;
...
void sonyimx135_set_exposure_gain(u32 exposure, u32 gain)
{
	u32  analog_gain = 0;
	...
	if (gain > SONYIMX135_MAX_ANALOG_GAIN2 * 16)
	{
...
void sonyimx135_set_gain(u32 gain)
{
	u8 digital_h = 1;
	u8 digital_l = 0;
	if (0 == gain) // reset digital gain to 1x
	{
		sonyimx135_write_reg(SONYIMX135_GROUP_HOLD_FUNCTION_REG, 0x01 , 0x00); // group hold
		sonyimx135_write_reg(SONYIMX135_DIG_GAIN_GR_REG_H, digital_h & 0xff, 0x00);
		sonyimx135_write_reg(SONYIMX135_DIG_GAIN_GR_REG_L, digital_l & 0xff, 0x00);
...
static int sonyimx135_reset(camera_power_state power_state)
{
	...
	sonyimx135_sensor.sensor_hdr_movie.hdrInfo.hdr_on = HDR_MOVIE_OFF;
 ...
 **************************************************************************
*/
static void sonyimx135_set_hdr_movie_switch(int on)
{
	print_info("enter %s,on = %d",__func__,on);
	sonyimx135_sensor.sensor_hdr_movie.hdrInfo.hdr_on = (u32)on;
}
...
static void sonyimx135_set_default(void)
{
	...
	sonyimx135_sensor.lane_clk = CLK_700M ;//CLK_450M
