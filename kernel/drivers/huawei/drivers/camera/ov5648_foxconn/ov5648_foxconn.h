...
#ifndef _OV5648_FOXCONN_H
#define _OV5648_FOXCONN_H
...
const struct _sensor_reg_t ov5648_foxconn_init_regs[] = {
...
/*1280x960*/
const struct _sensor_reg_t ov5648_foxconn_framesize_quarter[] = {
  ...
  //  {0x3810, 0x00}, // isp x win = 16
   ...
   // {0x3812, 0x00}, // isp y win = 10
    ...
    {0x3815, 0x31}, // y inc
   // {0x3817, 0x00}, // hsync start
    {0x3820, 0x08, 0x06}, // flip off, v bin off
    {0x3821, 0x07, 0x06}, // mirror on, h bin on
    {0x4004, 0x02}, // black line number
...
/*2592 1952 full size*/
const struct _sensor_reg_t ov5648_foxconn_framesize_full[] = {
   ...
   // {0x3812, 0x00}, // isp y win = 2
    ...
    {0x3815, 0x11}, // y inc
    //{0x3817, 0x00}, // hsync start
    {0x3820, 0x40, 0x06}, // flip off, v bin off
    {0x3821, 0x06, 0x06}, // mirror on, v bin off
