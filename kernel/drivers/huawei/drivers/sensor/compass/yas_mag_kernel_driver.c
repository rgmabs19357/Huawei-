...
static DEVICE_ATTR(set_cal, S_IRUGO|S_IWUSR,
	geomagnetic_set_cal_show, geomagnetic_set_cal_store);
...
/*hardware I2C check*/
    ...
    rt = set_sensor_chip_info(COMPASS, "YAMAHA YAS532");
	if (rt) {
...
/*input device initialize*/
	...
	input_data->name = COMPASS_INPUT_DEV_NAME;
