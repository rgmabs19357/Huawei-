...
{
    {8000,   624000, 0},            /*level 1 frequency >= 624000KHz, min_ddr_freq = 0,It means not need to set DDR.*/
    {16000, 798000, 0},             /*level 2 frequency >= 798000KHz, min_ddr_freq = 0,It means not need to set DDR.*/
    {35000, 1596000, 800000},       /*level 3 frequency >= 1596000KHz, min_ddr_freq >= 800000KHz*/
};
