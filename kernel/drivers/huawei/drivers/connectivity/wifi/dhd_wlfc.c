...
dhd_wlfc_enable(dhd_pub_t *dhd)
{
	...
	DHD_ERROR(("dhd_wlfc_enable(): enter with wlfc_enabled = %d, wlfc_state = 0x%x\n",
		dhd->wlfc_enabled, dhd->wlfc_state));
...
dhd_wlfc_deinit(dhd_pub_t *dhd)
{
	...
	DHD_ERROR(("dhd_wlfc_deinit(): enter with dhd->wlfc_state = 0x%x\n", dhd->wlfc_state));
