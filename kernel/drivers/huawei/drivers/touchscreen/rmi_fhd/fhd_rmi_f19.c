...
struct f19_data {
	...
	u16 int_enable_button_address;
	u16 single_button_address;
	u16 sensor_map_address;
	u16 all_button_sensitivity_address;
	u16 all_button_threshold_address;
};
	...
	struct f19_data *f19)
{
	...
	u16 ctrl_base_addr = f19->general_control_address;
...
static int rmi_f19_config(struct rmi_function_container *fc)
{
	struct f19_data *data = fc->data;
	int retval = 0;
	union f19_0d_query *button_query = &data->button_query;
