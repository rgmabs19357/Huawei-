 ...
 */
#ifndef _FHD_RMI_DRIVER_H
#define _FHD_RMI_DRIVER_H
...
static ssize_t tricat(rmi_fn_,FNUM,_##propname##_show)(\
					...
					char *buf);\
\
DEVICE_ATTR(fhd_##propname, RMI_RO_ATTR,\
...
\
DEVICE_ATTR(fhd_##propname, RMI_RO_ATTR_1,\
		rmi_show_error,\
...
#define attrify(nm) &dev_attr_fhd_##nm.attr
...
extern void fhd_rmi4_fw_update(struct rmi_device *rmi_dev,
