...
typedef union {
	struct {
		u32  gnew1_size_vrt : 12;
		u32  reserved0      : 4;
		u32  gnew1_size_hrz : 12;
		u32  reserved1      : 4;
	} bits;
	u32 ul32;
}EDC_GNEW1_SIZE;
...
typedef union {
	struct {
		u32  reserved0     : 12;
		u32  ovly3_alp_sel : 2;
		u32  ovly3_under_alp_sel : 2;
		u32  reserved1     : 1;
		u32  gnew1_fmtin   : 2;
		u32  gnew1_bgr     : 1;
		u32  reserved2     : 2;
		u32  ovly3_alp_mode     : 1;
		u32  ovly3_src_blend_en : 1;
		u32  reserved3     : 3;
		u32  gnew1_en	   : 1;
		u32  reserved4     : 4;
	} bits;
...
typedef union {
	struct {
		u32  ovly3_alp_value0 : 8;
		u32	 ovly3_alp_value1 : 8;
		u32  reserved0        : 16;
	} bits;
	u32 ul32;
}EDC_OVLY3_GLB_ALP;
...
typedef union {
	struct {
		u32  gnew2_size_vrt : 12;
		u32  reserved0      : 4;
		u32  gnew2_size_hrz : 12;
		u32  reserved1      : 4;
	} bits;
	u32 ul32;
}EDC_GNEW2_SIZE;
...
typedef union {
	struct {
		u32  reserved0     : 12;
		u32  ovly4_alp_sel : 2;
		u32  ovly4_under_alp_sel : 2;
		u32  reserved1     : 1;
		u32  gnew2_fmtin   : 2;
		u32  gnew2_bgr     : 1;
		u32  reserved2     : 2;
		u32  ovly4_alp_mode     : 1;
		u32  ovly4_src_blend_en : 1;
		u32  reserved3     : 3;
		u32  gnew2_en	   : 1;
		u32  reserved4     : 4;
	} bits;
...
typedef union {
	struct {
		u32  ovly4_alp_value0 : 8;
		u32	 ovly4_alp_value1 : 8;
		u32  reserved0        : 16;
	} bits;
	u32 ul32;
}EDC_OVLY4_GLB_ALP;
...
typedef union {
	struct {
		u32  crsr_bot_clip : 4;
		u32  crsr_top_clip : 4;
		u32  crsr_right_clip : 4;
		u32  crsr_left_clip  : 4;
		u32  crsl_bot_clip : 4;
		u32  crsl_top_clip : 4;
		u32  crsl_right_clip : 4;
		u32  crsl_left_clip  : 4;
	}bits;
	u32 ul32;
}EDC_CRS_CLIP;
...
typedef union {
	struct {
		u32  ch1r_bot_clip : 4;
		u32  ch1r_top_clip : 4;
		u32  ch1r_right_clip : 4;
		u32  ch1r_left_clip  : 4;
		u32  ch1l_bot_clip : 4;
		u32  ch1l_top_clip : 4;
		u32  ch1l_right_clip : 4;
		u32  ch1l_left_clip  : 4;
	}bits;
	u32 ul32;
}EDC_CH1_CLIP;
...
typedef union {
	struct {
		u32  ch2r_bot_clip : 4;
		u32  ch2r_top_clip : 4;
		u32  ch2r_right_clip : 4;
		u32  ch2r_left_clip  : 4;
		u32  ch2l_bot_clip : 4;
		u32  ch2l_top_clip : 4;
		u32  ch2l_right_clip : 4;
		u32  ch2l_left_clip  : 4;
	}bits;
	u32 ul32;
}EDC_CH2_CLIP;
#endif
...
typedef union {
	struct {
		u32  gnew2_bot_clip : 4;
		u32  gnew2_top_clip : 4;
		u32  gnew2_right_clip : 4;
		u32  gnew2_left_clip  : 4;
		u32  gnew1_bot_clip : 4;
		u32  gnew1_top_clip : 4;
		u32  gnew1_right_clip : 4;
		u32  gnew1_left_clip  : 4;
	}bits;
	u32 ul32;
}EDC_GNEW_CLIP;
...
/* added by gongyu for edc Gnew1 and Gnew2 ch */

/* Gnew1 */
void set_EDC_GNEW1_ADDR(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW1_ADDR_OFFSET;
	EDC_GNEW1_ADDR edc_gnew1_addr;

	edc_gnew1_addr.ul32 = inp32(addr);
	edc_gnew1_addr.bits.gnew1_addr = nVal;
	outp32(addr, edc_gnew1_addr.ul32);
}
void set_EDC_GNEW1_STRIDE(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW1_STRIDE_OFFSET;
	EDC_GNEW1_STRIDE edc_gnew1_stride;

	edc_gnew1_stride.ul32 = inp32(addr);
	edc_gnew1_stride.bits.gnew1_stride = nVal;
	outp32(addr, edc_gnew1_stride.ul32);
}
void set_EDC_GNEW1_XY(u32 edc_base, u32 gnew1_x, u32 gnew1_y)
{
	u32 addr = edc_base + EDC_GNEW1_XY_OFFSET;
	EDC_GNEW1_XY edc_gnew1_xy;

	edc_gnew1_xy.ul32 = inp32(addr);
	edc_gnew1_xy.bits.gnew1_y = gnew1_y;
	edc_gnew1_xy.bits.gnew1_x = gnew1_x;
	outp32(addr, edc_gnew1_xy.ul32);
}
void set_EDC_GNEW1_SIZE(u32 edc_base, u32 gnew1_size_hrz, u32 gnew1_size_vrt)
{
	u32 addr = edc_base + EDC_GNEW1_SIZE_OFFSET;
	EDC_GNEW1_SIZE edc_gnew1_size;

	edc_gnew1_size.ul32 = inp32(addr);
	edc_gnew1_size.bits.gnew1_size_vrt = (gnew1_size_vrt > 0) ? (gnew1_size_vrt - 1) : 0;
	edc_gnew1_size.bits.gnew1_size_hrz = (gnew1_size_hrz > 0) ? (gnew1_size_hrz - 1) : 0;
	outp32(addr, edc_gnew1_size.ul32);
}

void set_EDC_GNEW1_CTL_pix_fmt(u32 edc_base, u32 val)
{
	u32 addr = edc_base + EDC_GNEW1_CTL_OFFSET;
	EDC_GNEW1_CTL  edc_gnew1_ctl;

	edc_gnew1_ctl.ul32 = inp32(addr);
	edc_gnew1_ctl.bits.gnew1_fmtin = val;
	outp32(addr, edc_gnew1_ctl.ul32);
}

void set_EDC_GNEW1_CTL_bgr(u32 edc_base, u32 val)
{
	u32 addr = edc_base + EDC_GNEW1_CTL_OFFSET;
	EDC_GNEW1_CTL  edc_gnew1_ctl;

	edc_gnew1_ctl.ul32 = inp32(addr);
	edc_gnew1_ctl.bits.gnew1_bgr = val;
	outp32(addr, edc_gnew1_ctl.ul32);
}

void set_EDC_GNEW1_CTL_ch_en(u32 edc_base, u32 val)
{
	u32 addr = edc_base + EDC_GNEW1_CTL_OFFSET;
	EDC_GNEW1_CTL  edc_gnew1_ctl;

	edc_gnew1_ctl.ul32 = inp32(addr);
	edc_gnew1_ctl.bits.gnew1_en = val;
	outp32(addr, edc_gnew1_ctl.ul32);
}

/* Gnew2 */
void set_EDC_GNEW2_ADDR(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_ADDR_OFFSET;
	EDC_GNEW2_ADDR edc_gnew2_addr;

	edc_gnew2_addr.ul32 = inp32(addr);
	edc_gnew2_addr.bits.gnew2_addr = nVal;
	outp32(addr, edc_gnew2_addr.ul32);
}
void set_EDC_GNEW2_STRIDE(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_STRIDE_OFFSET;
	EDC_GNEW2_STRIDE edc_gnew2_stride;

	edc_gnew2_stride.ul32 = inp32(addr);
	edc_gnew2_stride.bits.gnew2_stride = nVal;
	outp32(addr, edc_gnew2_stride.ul32);
}
void set_EDC_GNEW2_XY(u32 edc_base, u32 gnew2_x, u32 gnew2_y)
{
	u32 addr = edc_base + EDC_GNEW2_XY_OFFSET;
	EDC_GNEW2_XY edc_gnew2_xy;

	edc_gnew2_xy.ul32 = inp32(addr);
	edc_gnew2_xy.bits.gnew2_y = gnew2_y;
	edc_gnew2_xy.bits.gnew2_x = gnew2_x;
	outp32(addr, edc_gnew2_xy.ul32);
}
void set_EDC_GNEW2_SIZE(u32 edc_base, u32 gnew2_size_hrz, u32 gnew2_size_vrt)
{
	u32 addr = edc_base + EDC_GNEW2_SIZE_OFFSET;
	EDC_GNEW2_SIZE edc_gnew2_size;

	edc_gnew2_size.ul32 = inp32(addr);
	edc_gnew2_size.bits.gnew2_size_vrt = (gnew2_size_vrt > 0) ? (gnew2_size_vrt - 1) : 0;
	edc_gnew2_size.bits.gnew2_size_hrz = (gnew2_size_hrz > 0) ? (gnew2_size_hrz - 1) : 0;
	outp32(addr, edc_gnew2_size.ul32);
}

void set_EDC_GNEW2_CTL_pix_fmt(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_CTL_OFFSET;
	EDC_GNEW2_CTL  edc_gnew2_ctl;

	edc_gnew2_ctl.ul32 = inp32(addr);
	edc_gnew2_ctl.bits.gnew2_fmtin = nVal;
	outp32(addr, edc_gnew2_ctl.ul32);
}

void set_EDC_GNEW2_CTL_bgr(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_CTL_OFFSET;
	EDC_GNEW2_CTL  edc_gnew2_ctl;

	edc_gnew2_ctl.ul32 = inp32(addr);
	edc_gnew2_ctl.bits.gnew2_bgr = nVal;
	outp32(addr, edc_gnew2_ctl.ul32);
}

void set_EDC_GNEW2_CTL_ch_en(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_CTL_OFFSET;
	EDC_GNEW2_CTL  edc_gnew2_ctl;

	edc_gnew2_ctl.ul32 = inp32(addr);
	edc_gnew2_ctl.bits.gnew2_en = nVal;
	outp32(addr, edc_gnew2_ctl.ul32);
}

/* overlay_3 */
void set_EDC_OVERLAY_3_blend_en(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW1_CTL_OFFSET;
	EDC_GNEW1_CTL  edc_gnew1_ctl;

	edc_gnew1_ctl.ul32 = inp32(addr);
	edc_gnew1_ctl.bits.ovly3_src_blend_en = nVal;
	outp32(addr, edc_gnew1_ctl.ul32);
}
void set_EDC_OVERLAY_3_alpha_mode(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW1_CTL_OFFSET;
	EDC_GNEW1_CTL  edc_gnew1_ctl;

	edc_gnew1_ctl.ul32 = inp32(addr);
	edc_gnew1_ctl.bits.ovly3_alp_mode = nVal;
	outp32(addr, edc_gnew1_ctl.ul32);
}
void set_EDC_OVERLAY_3_under_alpha_sel(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW1_CTL_OFFSET;
	EDC_GNEW1_CTL  edc_gnew1_ctl;

	edc_gnew1_ctl.ul32 = inp32(addr);
	edc_gnew1_ctl.bits.ovly3_under_alp_sel = nVal;
	outp32(addr, edc_gnew1_ctl.ul32);
}

void set_EDC_OVERLAY_3_alpha_sel(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW1_CTL_OFFSET;
	EDC_GNEW1_CTL  edc_gnew1_ctl;

	edc_gnew1_ctl.ul32 = inp32(addr);
	edc_gnew1_ctl.bits.ovly3_alp_sel = nVal;
	outp32(addr, edc_gnew1_ctl.ul32);
}
void set_EDC_OVERLAY_3_glb_alpha(u32 edc_base, u32 alp_value0, u32 alp_value1)
{
	u32 addr = edc_base + EDC_OVLY_3_GLP_ALP_OFFSET;
	EDC_OVLY3_GLB_ALP edc_ovly3_glp_alp;

	edc_ovly3_glp_alp.ul32 = inp32(addr);
	edc_ovly3_glp_alp.bits.ovly3_alp_value0 = alp_value0;
	edc_ovly3_glp_alp.bits.ovly3_alp_value1 = alp_value1;
	outp32(addr, edc_ovly3_glp_alp.ul32);
}

/* overlay_4 */
void set_EDC_OVERLAY_4_blend_en(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_CTL_OFFSET;
	EDC_GNEW2_CTL  edc_gnew2_ctl;

	edc_gnew2_ctl.ul32 = inp32(addr);
	edc_gnew2_ctl.bits.ovly4_src_blend_en = nVal;
	outp32(addr, edc_gnew2_ctl.ul32);
}
void set_EDC_OVERLAY_4_alpha_mode(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_CTL_OFFSET;
	EDC_GNEW2_CTL  edc_gnew2_ctl;

	edc_gnew2_ctl.ul32 = inp32(addr);
	edc_gnew2_ctl.bits.ovly4_alp_mode = nVal;
	outp32(addr, edc_gnew2_ctl.ul32);
}
void set_EDC_OVERLAY_4_under_alpha_sel(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_CTL_OFFSET;
	EDC_GNEW2_CTL  edc_gnew2_ctl;

	edc_gnew2_ctl.ul32 = inp32(addr);
	edc_gnew2_ctl.bits.ovly4_under_alp_sel = nVal;
	outp32(addr, edc_gnew2_ctl.ul32);
}

void set_EDC_OVERLAY_4_alpha_sel(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW2_CTL_OFFSET;
	EDC_GNEW2_CTL  edc_gnew2_ctl;

	edc_gnew2_ctl.ul32 = inp32(addr);
	edc_gnew2_ctl.bits.ovly4_alp_sel = nVal;
	outp32(addr, edc_gnew2_ctl.ul32);
}
void set_EDC_OVERLAY_4_glb_alpha(u32 edc_base, u32 alp_value0, u32 alp_value1)
{
	u32 addr = edc_base + EDC_OVLY_4_GLP_ALP_OFFSET;
	EDC_OVLY4_GLB_ALP edc_ovly4_glp_alp;

	edc_ovly4_glp_alp.ul32 = inp32(addr);
	edc_ovly4_glp_alp.bits.ovly4_alp_value0 = alp_value0;
	edc_ovly4_glp_alp.bits.ovly4_alp_value1 = alp_value1;
	outp32(addr, edc_ovly4_glp_alp.ul32);
}

/* CROSS Switch */
void set_EDC_CROSS_CTL_ovly_1_sel(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CROSS_CTL_OFFSET;
	EDC_CROSS_CTL edc_cross_ctl;

	edc_cross_ctl.ul32 = inp32(addr);
	edc_cross_ctl.bits.ovly1_sel = nVal;
	outp32(addr, edc_cross_ctl.ul32);
}

void set_EDC_CROSS_CTL_ovly_2_sel(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CROSS_CTL_OFFSET;
	EDC_CROSS_CTL edc_cross_ctl;

	edc_cross_ctl.ul32 = inp32(addr);
	edc_cross_ctl.bits.ovly2_sel = nVal;
	outp32(addr, edc_cross_ctl.ul32);
}
void set_EDC_CROSS_CTL_ovly_3_sel(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CROSS_CTL_OFFSET;
	EDC_CROSS_CTL edc_cross_ctl;

	edc_cross_ctl.ul32 = inp32(addr);
	edc_cross_ctl.bits.ovly3_sel = nVal;
	outp32(addr, edc_cross_ctl.ul32);
}

void set_EDC_CROSS_CTL_ovly_4_sel(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CROSS_CTL_OFFSET;
	EDC_CROSS_CTL edc_cross_ctl;
	...
	edc_cross_ctl.bits.ovly4_sel = nVal;
	
	outp32(addr, edc_cross_ctl.ul32);
}

void set_EDC_CROSS_CTRL_default_val(u32 edc_base)
{
	u32 addr = edc_base + EDC_CROSS_CTL_OFFSET;
	EDC_CROSS_CTL edc_cross_ctl;

	edc_cross_ctl.ul32 = inp32(addr);
	edc_cross_ctl.bits.ovly1_sel = 0;
	edc_cross_ctl.bits.ovly2_sel = 1;
	edc_cross_ctl.bits.ovly3_sel = 2;
	edc_cross_ctl.bits.ovly4_sel = 3;
	outp32(addr, edc_cross_ctl.ul32);
}

/*begin support edc  pixels algin  modified by weiyi 00175802*/
#if defined(CONFIG_OVERLAY_PIXEL_ALIGN_SUPPORT)	
void set_EDC_CRS_CLIP_bottom_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CRS_CLIP_OFFSET;
	EDC_CRS_CLIP  edc_crs_clip;

	edc_crs_clip.ul32 = inp32(addr);
	edc_crs_clip.bits.crsl_bot_clip= nVal;
	outp32(addr, edc_crs_clip.ul32);
}

void set_EDC_CRS_CLIP_top_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CRS_CLIP_OFFSET;
	EDC_CRS_CLIP  edc_crs_clip;

	edc_crs_clip.ul32 = inp32(addr);
	edc_crs_clip.bits.crsl_top_clip= nVal;
	outp32(addr, edc_crs_clip.ul32);
}

void set_EDC_CRS_CLIP_right_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CRS_CLIP_OFFSET;
	EDC_CRS_CLIP  edc_crs_clip;

	edc_crs_clip.ul32 = inp32(addr);
	edc_crs_clip.bits.crsl_right_clip= nVal;
	outp32(addr, edc_crs_clip.ul32);
}

void set_EDC_CRS_CLIP_left_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CRS_CLIP_OFFSET;
	EDC_CRS_CLIP  edc_crs_clip;

	edc_crs_clip.ul32 = inp32(addr);
	edc_crs_clip.bits.crsl_left_clip= nVal;
	outp32(addr, edc_crs_clip.ul32);
}

void set_EDC_CH1_CLIP_bottom_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CH1_CLIP_OFFSET;
	EDC_CH1_CLIP  edc_ch1_clip;

	edc_ch1_clip.ul32 = inp32(addr);
	edc_ch1_clip.bits.ch1l_bot_clip= nVal;
	outp32(addr, edc_ch1_clip.ul32);
}

void set_EDC_CH1_CLIP_top_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CH1_CLIP_OFFSET;
	EDC_CH1_CLIP  edc_ch1_clip;

	edc_ch1_clip.ul32 = inp32(addr);
	edc_ch1_clip.bits.ch1l_top_clip= nVal;
	outp32(addr, edc_ch1_clip.ul32);
}

void set_EDC_CH1_CLIP_right_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CH1_CLIP_OFFSET;
	EDC_CH1_CLIP  edc_ch1_clip;

	edc_ch1_clip.ul32 = inp32(addr);
	edc_ch1_clip.bits.ch1l_right_clip= nVal;
	outp32(addr, edc_ch1_clip.ul32);
}

void set_EDC_CH1_CLIP_left_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CH1_CLIP_OFFSET;
	EDC_CH1_CLIP  edc_ch1_clip;

	edc_ch1_clip.ul32 = inp32(addr);
	edc_ch1_clip.bits.ch1l_left_clip= nVal;
	outp32(addr, edc_ch1_clip.ul32);
}

void set_EDC_CH2_CLIP_bottom_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CH2_CLIP_OFFSET;
	EDC_CH2_CLIP  edc_ch2_clip;

	edc_ch2_clip.ul32 = inp32(addr);
	edc_ch2_clip.bits.ch2l_bot_clip= nVal;
	outp32(addr, edc_ch2_clip.ul32);
}

void set_EDC_CH2_CLIP_top_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CH2_CLIP_OFFSET;
	EDC_CH2_CLIP  edc_ch2_clip;

	edc_ch2_clip.ul32 = inp32(addr);
	edc_ch2_clip.bits.ch2l_top_clip= nVal;
	outp32(addr, edc_ch2_clip.ul32);
}

void set_EDC_CH2_CLIP_right_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CH2_CLIP_OFFSET;
	EDC_CH2_CLIP  edc_ch2_clip;

	edc_ch2_clip.ul32 = inp32(addr);
	edc_ch2_clip.bits.ch2l_right_clip= nVal;
	outp32(addr, edc_ch2_clip.ul32);
}

void set_EDC_CH2_CLIP_left_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_CH2_CLIP_OFFSET;
	EDC_CH2_CLIP  edc_ch2_clip;

	edc_ch2_clip.ul32 = inp32(addr);
	edc_ch2_clip.bits.ch2l_left_clip= nVal;
	outp32(addr, edc_ch2_clip.ul32);
}
#endif
/*end support edc  pixels algin  modified by weiyi 00175802*/
...
/* Gnew Clip */
void set_EDC_GNEW_CLIP_gnew2_bottom_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW_CLIP_OFFSET;
	EDC_GNEW_CLIP edc_gnew_clip;

	edc_gnew_clip.ul32 = inp32(addr);
	edc_gnew_clip.bits.gnew2_bot_clip = nVal;
	outp32(addr, edc_gnew_clip.ul32);
}
void set_EDC_GNEW_CLIP_gnew2_top_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW_CLIP_OFFSET;
	EDC_GNEW_CLIP edc_gnew_clip;

	edc_gnew_clip.ul32 = inp32(addr);
	edc_gnew_clip.bits.gnew2_top_clip = nVal;
	outp32(addr, edc_gnew_clip.ul32);
}
void set_EDC_GNEW_CLIP_gnew2_right_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW_CLIP_OFFSET;
	EDC_GNEW_CLIP edc_gnew_clip;

	edc_gnew_clip.ul32 = inp32(addr);
	edc_gnew_clip.bits.gnew2_right_clip = nVal;
	outp32(addr, edc_gnew_clip.ul32);
}
void set_EDC_GNEW_CLIP_gnew2_left_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW_CLIP_OFFSET;
	EDC_GNEW_CLIP edc_gnew_clip;

	edc_gnew_clip.ul32 = inp32(addr);
	edc_gnew_clip.bits.gnew2_left_clip = nVal;
	outp32(addr, edc_gnew_clip.ul32);
}

void set_EDC_GNEW_CLIP_gnew1_bottom_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW_CLIP_OFFSET;
	EDC_GNEW_CLIP edc_gnew_clip;

	edc_gnew_clip.ul32 = inp32(addr);
	edc_gnew_clip.bits.gnew1_bot_clip = nVal;
	outp32(addr, edc_gnew_clip.ul32);
}
void set_EDC_GNEW_CLIP_gnew1_top_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW_CLIP_OFFSET;
	EDC_GNEW_CLIP edc_gnew_clip;

	edc_gnew_clip.ul32 = inp32(addr);
	edc_gnew_clip.bits.gnew1_top_clip = nVal;
	outp32(addr, edc_gnew_clip.ul32);
}
void set_EDC_GNEW_CLIP_gnew1_right_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW_CLIP_OFFSET;
	EDC_GNEW_CLIP edc_gnew_clip;

	edc_gnew_clip.ul32 = inp32(addr);
	edc_gnew_clip.bits.gnew1_right_clip = nVal;
	outp32(addr, edc_gnew_clip.ul32);
}
void set_EDC_GNEW_CLIP_gnew1_left_clip(u32 edc_base, u32 nVal)
{
	u32 addr = edc_base + EDC_GNEW_CLIP_OFFSET;
	EDC_GNEW_CLIP edc_gnew_clip;

	edc_gnew_clip.ul32 = inp32(addr);
	edc_gnew_clip.bits.gnew1_left_clip = nVal;
	outp32(addr, edc_gnew_clip.ul32);
}
