...
hdmi_cec_param* cec_str_tocmd(const char *str, hdmi_cec_param* cec_cmd)
{
    ...
    count = sscanf(str, HDMI_CMD_CEC"%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", 
        (int *)&cec_cmd->en_src_addr, (int *)&cec_cmd->en_dst_addr, (int *)&cec_cmd->opcode, (int *)&cec_cmd->un_operand.raw_data.length,
        (int *)&cec_cmd->un_operand.raw_data.data[0],
        (int *)&cec_cmd->un_operand.raw_data.data[1],
        (int *)&cec_cmd->un_operand.raw_data.data[2],
        (int *)&cec_cmd->un_operand.raw_data.data[3],
        (int *)&cec_cmd->un_operand.raw_data.data[4],
        (int *)&cec_cmd->un_operand.raw_data.data[5],
        (int *)&cec_cmd->un_operand.raw_data.data[6],
        (int *)&cec_cmd->un_operand.raw_data.data[7],
        (int *)&cec_cmd->un_operand.raw_data.data[8],
        (int *)&cec_cmd->un_operand.raw_data.data[9],
        (int *)&cec_cmd->un_operand.raw_data.data[10],
        (int *)&cec_cmd->un_operand.raw_data.data[11],
        (int *)&cec_cmd->un_operand.raw_data.data[12],
        (int *)&cec_cmd->un_operand.raw_data.data[13],
        (int *)&cec_cmd->un_operand.raw_data.data[14]);
