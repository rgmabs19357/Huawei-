...
struct k3_bq27510_device_info *g_battery_measure_by_bq27510_device = NULL;
struct hisi_coul_ops *g_bq27510_coul_ops = NULL;
...
int is_bq27510_coul_ready(void)
{
	if (g_battery_measure_by_bq27510_i2c_client && g_battery_measure_by_bq27510_device)
	    return 1;
    else
        return 0;
}
...
{
    return is_k3_bq27510_battery_exist(g_battery_measure_by_bq27510_device);
}

int is_bq27510_battery_reach_threshold(void)
{
    int low_bat_flag;
    low_bat_flag = is_k3_bq27510_battery_reach_threshold(g_battery_measure_by_bq27510_device);
...
{
    return is_k3_bq27510_battery_full(g_battery_measure_by_bq27510_device);
}


int bq27510_battery_voltage(void)
{
    return k3_bq27510_battery_voltage(g_battery_measure_by_bq27510_device);
}

int bq27510_battery_current(void)
{
    return k3_bq27510_battery_current(g_battery_measure_by_bq27510_device);
}

int bq27510_battery_capacity(void)
{
    return k3_bq27510_battery_capacity(g_battery_measure_by_bq27510_device);
}

int bq27510_battery_temperature(void)
{
    return k3_bq27510_battery_temperature(g_battery_measure_by_bq27510_device);
}

int bq27510_battery_rm(void)
{
    return k3_bq27510_battery_rm(g_battery_measure_by_bq27510_device);
}

int bq27510_battery_fcc(void)
{
    return k3_bq27510_battery_fcc(g_battery_measure_by_bq27510_device);
}

int bq27510_battery_health(void)
{
    return k3_bq27510_battery_health(g_battery_measure_by_bq27510_device);
}

int bq27510_battery_capacity_level(void)
{
    return k3_bq27510_battery_capacity_level(g_battery_measure_by_bq27510_device);
}

int bq27510_battery_technology(void)
{
    return k3_bq27510_battery_technology(g_battery_measure_by_bq27510_device);
}
				 ...
				 const struct i2c_device_id *id)
{
    ...
    if (!coul_ops) {
		BQ27510_ERR("failed to alloc coul ops struct\n");
		retval = -ENOMEM;
		goto batt_failed_5;
    }

    coul_ops->is_coul_ready = is_bq27510_coul_ready;
    coul_ops->is_battery_exist = is_bq27510_battery_exist;
    coul_ops->is_battery_reach_threshold = is_bq27510_battery_reach_threshold;
    coul_ops->is_battery_full= is_bq27510_battery_full;
    coul_ops->battery_voltage = bq27510_battery_voltage;
    coul_ops->battery_current = bq27510_battery_current;
    coul_ops->battery_capacity = bq27510_battery_capacity;
    coul_ops->battery_temperature = bq27510_battery_temperature;
    coul_ops->battery_rm = bq27510_battery_rm;
    coul_ops->battery_fcc = bq27510_battery_fcc;
    coul_ops->battery_health = bq27510_battery_health;
    coul_ops->battery_capacity_level = bq27510_battery_capacity_level;
    coul_ops->battery_technology = bq27510_battery_technology;

    g_bq27510_coul_ops = coul_ops;

    retval = hisi_coul_ops_register(coul_ops,COUL_BQ27510);
    if (retval) {
		BQ27510_ERR("[%s,%d]:failed to register coul ops\n ", __FUNCTION__, __LINE__);
		goto batt_failed_6;
    }
...
batt_failed_6:
    g_bq27510_coul_ops = NULL;
    kfree(coul_ops);
batt_failed_5:
    g_battery_measure_by_bq27510_i2c_client = NULL;
    g_battery_measure_by_bq27510_device = NULL;
...
static int k3_bq27510_battery_remove(struct i2c_client *client)
{
    ...
    hisi_coul_ops_unregister(g_bq27510_coul_ops);

    kfree(g_bq27510_coul_ops);
    g_bq27510_coul_ops = NULL;
