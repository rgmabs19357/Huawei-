...
* Author: yangjun(00185015)       Version : 0.1      Date:  2013-09-01
*
...
enum err_wrt_num
{
    ERRNUM_FSA9685_REG_MANUAL_SW_1 = -1,
    ERRNUM_FSA9685_REG_CONTROL = -2,
    ERRNUM_FSA9685_REG_DETACH_CONTROL = -3,
};

enum err_ctr_irq_num
{
    ERRNUM_REQUEST_THREADED_IRQ = -1,
    ERRNUM_GPIO_DIRECTION_INPUT = -2,
    ERRNUM_GPIO_REQUEST = -3,
    ERRUNM_GPIO_TO_IRQ = -4,
    ERRNUM_OF_GET_NAME_GPIO = -5,
    ERRNUM_SWITCH_USB_DEV_REGISTER = -6,
};
