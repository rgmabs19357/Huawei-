...
/* OVISP LENC setting for DAY light Long Exposure */
	{0x1c264, 0x06},
	{0x1c265, 0x04},
	{0x1c266, 0x04},
	{0x1c267, 0x04},
...
{
	return k3_ispio_read_reg(sonyimx105_sensor.i2c_config.index, sonyimx105_sensor.i2c_config.addr,
		reg, (u16*)val, sonyimx105_sensor.i2c_config.val_bits, sonyimx105_sensor.i2c_config.addr_bits);
}
...
{
	return k3_ispio_write_reg(sonyimx105_sensor.i2c_config.index, sonyimx105_sensor.i2c_config.addr,
		reg, val, sonyimx105_sensor.i2c_config.val_bits, mask, sonyimx105_sensor.i2c_config.addr_bits);
}
...
static int sonyimx105_write_seq(const struct _sensor_reg_t *seq, u32 size, u8 mask)
{
	...
	return k3_ispio_write_seq(sonyimx105_sensor.i2c_config.index, sonyimx105_sensor.i2c_config.addr,
		seq, size, sonyimx105_sensor.i2c_config.val_bits, mask, sonyimx105_sensor.i2c_config.addr_bits);
}
...
static void sonyimx105_set_default(void)
{
	...
	sonyimx105_sensor.i2c_config.addr_bits = I2C_16BIT;
