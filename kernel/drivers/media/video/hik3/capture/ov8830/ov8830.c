...
/* De-noise */
	...
	/* Raw G De-noise improve white pixel: maybe over write by cmdset */
	{0x6551a, 0x02},//gain 1X
	{0x6551b, 0x04},//gain  2X
	{0x6551c, 0x06},//gain  4X
	{0x6551d, 0x08},//gain  8X
	{0x6551e, 0x0c},//gain 16X
	{0x6551f, 0x18},//gain 32X
	{0x65520, 0x20},//gain 64X
	...
	{0x65528, 0x00},
	{0x65529, 0x0c}, //gain 8x
	{0x6552a, 0x00},
	{0x6552b, 0x18}, //gain 16x
	{0x6552c, 0x00},
...
/* sharpeness */
	...
	{0x65601, 0x10},//0319
	{0x65602, 0x00},
	{0x65603, 0x60},// change sharpness high gain threshod 0x40->0x60 20120814
	{0x65608, 0x06},
	{0x65609, 0x20},
	{0x6560c, 0x08},
...
/* OVISP LENC setting for DAY light Long Exposure (HDR/3D) */
	//Y channel re-back to old version(do not plus 8) 
	{0x1c264, 0x0a},
	{0x1c265, 0x05},
	{0x1c266, 0x05},
	{0x1c267, 0x05},
...
/* AWB */
	...
	{0x1d902, 0x00},//Set 1 to enable new awb shift, set 0 to enable old awb shift
	...
	{0x1d8e3, 0x90},
	{0x1d8f4, 0x08},//nAWBShiftBrThres3
	{0x1d8f5, 0x20},
	{0x1d8f6, 0x1c},//nAWBShiftBrThres4
	{0x1d8f7, 0xa6},
	{0x1d8f2, 0x04},//nAWBShiftLowBrightThres
	{0x1d8f3, 0x22},//nAWBShiftHighBrightThres
	{0x1d9c8, 0x7c},//B gain for A High light
	{0x1d9c9, 0x7c},//B gain for A
	{0x1d9ca, 0x7c},//B gain for A
	{0x1d9cb, 0x7c},//B gain for A low light
	...
	{0x1d9d0, 0x80},//B gain for cwf High light
	{0x1d9d1, 0x80},//B gain for cwf
	{0x1d9d2, 0x80},//B gain for cwf
	{0x1d9d3, 0x80},//B gain for cwf low light

	{0x1d9d4, 0x80},//R gain for cwf High light
	{0x1d9d5, 0x80},//R gain for cwf
	{0x1d9d6, 0x80},//R gain for cwf
	{0x1d9d7, 0x80},//R gain for cwf low light
	...
	{0x66206, 0x13},//0x66206~0x66208 will be over write by dynamic AWB, just used to debug
	{0x66207, 0x1c},
	{0x66208, 0x1c},
	{0x66209, 0x78},//horizontal coordinate of cwf center point
	{0x6620a, 0x68},//vertical coordinate of cwf center point
	{0x6620b, 0xf8}, 
	{0x6620c, 0xb2},
	{0x6620d, 0x40},//0x6620d~0x66210 will be over write by dynamic AWB, just used to debug
	{0x6620e, 0x32},
	{0x6620f, 0x6e},
	{0x66210, 0x60},
	{0x66201, 0x52},
...
/* OVISP CTAWB setting for Long Exposure (HDR/3D) */
	{0x66206, 0x14},//0x66206~0x66208 will be over write by dynamic AWB, just used to debug
	{0x66207, 0x19},
	{0x66208, 0x15},
	{0x66209, 0x87},
	...
	{0x6620d, 0x48},//0x6620d~0x66210 will be over write by dynamic AWB, just used to debug
	{0x6620e, 0x34},
	{0x6620f, 0x70},
	{0x66210, 0x56},
	{0x66201, 0x52},
...
static framesize_s ov8830_framesizes[] = {
	...
	/* 1080p eis 2112*1200 */
	{0, 0, 2112, 1200, 3864, 2296, 25, 21, 0x239, 0x1da, 0x1f4, VIEW_FULL, RESOLUTION_16_9, false, {ov8830_framesize_1080pEIS, ARRAY_SIZE(ov8830_framesize_1080pEIS)} },
...
/*
 **************************************************************************
 * FunctionName: ov8830_read_isp_reg;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
/*
 **************************************************************************
 * FunctionName: ov8830_write_isp_reg;
 * Description : NA;
 * Input       : NA;
 * Output      : NA;
 * ReturnValue : NA;
...
/*
 **************************************************************************
 * FunctionName: ov8830_update_otp_wb;
 * Description : R/G and B/G of typical camera module is defined here,
 * 			  	 call this function after OV8830 initialization to calibrate white balance;
 * Input       : otp_index;
 * Output      : NA;
