...
{
	return k3_ispio_read_reg(sonyimx091_sensor.i2c_config.index, sonyimx091_sensor.i2c_config.addr,
		reg, (u16*)val, sonyimx091_sensor.i2c_config.val_bits, sonyimx091_sensor.i2c_config.addr_bits);
}
...
static int sonyimx091_read_reg_print_info(const struct _sensor_reg_t *seq, u32 size)
{
	...
	for( i = 0; i< size;i++) {
		reg = seq[i].subaddr;
		ret = k3_ispio_read_reg(sonyimx091_sensor.i2c_config.index, sonyimx091_sensor.i2c_config.addr,
		reg, (u16*)val, sonyimx091_sensor.i2c_config.val_bits, sonyimx091_sensor.i2c_config.addr_bits);
...
{
	return k3_ispio_write_reg(sonyimx091_sensor.i2c_config.index, sonyimx091_sensor.i2c_config.addr,
		reg, val, sonyimx091_sensor.i2c_config.val_bits, mask, sonyimx091_sensor.i2c_config.addr_bits);
}
...
static int sonyimx091_write_seq(const struct _sensor_reg_t *seq, u32 size, u8 mask)
{
	...
	return k3_ispio_write_seq(sonyimx091_sensor.i2c_config.index, sonyimx091_sensor.i2c_config.addr,
		seq, size, sonyimx091_sensor.i2c_config.val_bits, mask, sonyimx091_sensor.i2c_config.addr_bits);
}
...
static void sonyimx091_set_default(void)
{
	...
	sonyimx091_sensor.i2c_config.addr_bits = I2C_16BIT;
