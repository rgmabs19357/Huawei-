...
{
	return k3_ispio_read_reg(mt9m114_sensor.i2c_config.index, mt9m114_sensor.i2c_config.addr,
		reg, val, mt9m114_sensor.i2c_config.val_bits, mt9m114_sensor.i2c_config.addr_bits);
}
...
{
	return k3_ispio_write_reg(mt9m114_sensor.i2c_config.index, mt9m114_sensor.i2c_config.addr,
		reg, val, length, mask, mt9m114_sensor.i2c_config.addr_bits);
}
...
static int mt9m114_write_seq(const struct _sensor_reg_t *seq, u32 size, u8 mask)
{
	...
	return k3_ispio_write_seq(mt9m114_sensor.i2c_config.index, mt9m114_sensor.i2c_config.addr,
		seq, size, mt9m114_sensor.i2c_config.val_bits, mask, mt9m114_sensor.i2c_config.addr_bits);
}
...
static void mt9m114_set_default(void)
{
	...
	mt9m114_sensor.i2c_config.addr_bits = I2C_16BIT;
