...
{
	return k3_ispio_read_reg(s5k3h2yx_foxconn_sensor.i2c_config.index, s5k3h2yx_foxconn_sensor.i2c_config.addr,
		reg, (u16 *)val, s5k3h2yx_foxconn_sensor.i2c_config.val_bits, s5k3h2yx_foxconn_sensor.i2c_config.addr_bits);
}
...
static int s5k3h2yx_foxconn_write_seq(const struct _sensor_reg_t *seq, u32 size, u8 mask)
{
	...
	return k3_ispio_write_seq(s5k3h2yx_foxconn_sensor.i2c_config.index, s5k3h2yx_foxconn_sensor.i2c_config.addr,
		seq, size, s5k3h2yx_foxconn_sensor.i2c_config.val_bits, mask, s5k3h2yx_foxconn_sensor.i2c_config.addr_bits);
}
...
static void s5k3h2yx_foxconn_set_default(void)
{
	...
	s5k3h2yx_foxconn_sensor.i2c_config.addr_bits = I2C_16BIT;
