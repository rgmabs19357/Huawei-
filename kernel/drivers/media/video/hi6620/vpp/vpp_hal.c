...
void log_reg_value(void)
{
	...
	printk("****VOUVERSION1(0x10)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x10));
	printk("****VOUVERSION2(0x14)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x14));
	printk("****VODEBUG(0x20)            : 0x%0x \n", VPP_REG(s_xl_mmio,0x20));
	printk("****VOLNKLSTCTRL(0x24)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x24));
	printk("****VOLNKLSTADDR(0x28)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x28));
	printk("****VOLNKLSTSTRT(0x2c)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x2c));
	printk("****VOLNKLSTPENDINGSTA(0x30) : 0x%0x \n", VPP_REG(s_xl_mmio,0x30));
	printk("****VOLNKLSTWORKINGSTA(0x34) : 0x%0x \n", VPP_REG(s_xl_mmio,0x34));
	printk("****VOLNKLSTENDSTA(0x38)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x38));
	printk("****VOLNKLSTNUMSTA(0x3c)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x3c));
	...
	printk("****VADHCOEFAD(0x4c)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x4c));
	printk("****VADVCOEFAD(0x50)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x50));
	printk("****ACCAD(0x54)              : 0x%0x \n", VPP_REG(s_xl_mmio,0x54));
	...
	printk("****VHDDIEADDR(0x138)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x138));
    printk("****VHDWBC1ADDR(0x13c)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x13c));
    printk("****VHDWBC1STRD(0x140)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x140));
	printk("****VHDDIESTADDR(0x144)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x144));
	...
	printk("****VHDBK(0x170)             : 0x%0x \n", VPP_REG(s_xl_mmio,0x170));
    printk("****VHDCSCIDC(0x180)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x180));
	printk("****VHDCSCODC(0x184)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x184));
	printk("****VHDCSCP0(0x188)          : 0x%0x \n", VPP_REG(s_xl_mmio,0x188));
	printk("****VHDCSCP1(0x18c)          : 0x%0x \n", VPP_REG(s_xl_mmio,0x18c));
	printk("****VHDCSCP2(0x190)          : 0x%0x \n", VPP_REG(s_xl_mmio,0x190));
	printk("****VHDCSCP3(0x194)          : 0x%0x \n", VPP_REG(s_xl_mmio,0x194));
	printk("****VHDCSCP4(0x198)          : 0x%0x \n", VPP_REG(s_xl_mmio,0x198));
	printk("****VHDACM0(0x1a0)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1a0));
	printk("****VHDACM1(0x1a4)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1a4));
	printk("****VHDACM2(0x1a8)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1a8));
	printk("****VHDACM3(0x1ac)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1ac));
	printk("****VHDACM4(0x1b0)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1b0));
	printk("****VHDACM5(0x1b4)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1b4));
	printk("****VHDACM6(0x1b8)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1b8));
	printk("****VHDACM7(0x1bc)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1bc));
	printk("****VHDACM0(0x1b0)           : 0x%0x \n", VPP_REG(s_xl_mmio,0x1b0));
	...
	printk("****VHDACCTHD1(0x200)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x200));
	printk("****VHDACCTHD2(0x204)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x204));
    printk("****VHDACCLOWN(0x210)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x210));
    printk("****VHDACCLOWN(0x214)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x214));
	printk("****VHDACCLOWN(0x218)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x218));
	printk("****VHDACCMEDN(0x220)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x220));
	printk("****VHDACCMEDN(0x224)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x224));
    printk("****VHDACCMEDN(0x228)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x228));
	printk("****VHDACCHIGHN(0x230)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x230));
	printk("****VHDACCHIGHN(0x234)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x234));
	printk("****VHDACCHIGHN(0x238)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x238));
	printk("****VHDACCMLN(0x240)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x240));
	printk("****VHDACCMLN(0x244)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x244));
    printk("****VHDACCMLN(0x248)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x248));
	printk("****VHDACCMHN(0x250)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x250));
	printk("****VHDACCMHN(0x254)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x254));
    printk("****VHDACCMHN(0x258)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x258));
	printk("****VHDACC3LOW(0x260)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x260));
    printk("****VHDACC3MED(0x264)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x264));
    printk("****VHDACC3HIGH(0x268)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x268));
    printk("****VHDACC8MLOW(0x26c)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x26c));
	printk("****VHDACC8MHIGH(0x270)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x270));
	printk("****VHDACCTOTAL(0x274)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x274));
    printk("****VHDIFIRCOEF01(0x280)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x280));
	printk("****VHDIFIRCOEF23(0x284)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x284));
	printk("****VHDIFIRCOEF45(0x288)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x288));
	printk("****VHDIFIRCOEF67(0x28c)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x28c));
	printk("****VHDDIECTRL(0x300)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x300));
	printk("****VHDDIELMA0(0x308)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x308));
	printk("****VHDDIELMA1(0x30c)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x30c));
    printk("****VHDDIELMA2(0x310)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x310));
    printk("****VHDDIEINTEN(0x314)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x314));
	printk("****VHDDIESCALE(0x318)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x318));
	printk("****VHDDIECHECK1(0x31c)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x31c));
	printk("****VHDDIECHECK2(0x320)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x320));
	printk("****VHDDIEDIR0_3(0x324)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x324));
	printk("****VHDDIEDIR4_7(0x328)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x328));
	printk("****VHDDIEDIR8_11(0x32c)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x32c));
	printk("****VHDDIEDIR12_14(0x330)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x330));
	printk("****VHDDIESTA(0x338)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x338));
	...
	printk("****VHDDIESTNADDR(0x3bo)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x3b0));
	printk("****VHDDIESTSQTRADDR(0x3b4)  : 0x%0x \n", VPP_REG(s_xl_mmio,0x3b4));
	printk("****VHDCCRSCLR0(0x3b8)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x3b8));
	printk("****VHDCCRSCLR1(0x3bc)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x3bc));
	printk("****VHDPDCTRL(0x400)         : 0x%0x \n", VPP_REG(s_xl_mmio,0x400));
	printk("****VHDPDBLKPOS0(0x404)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x404));
	printk("****VHDPDBLKPOS1(0x408)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x408));
	printk("****VHDPDBLKTHD(0x40c)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x40c));
	printk("****VHDPDHISTTHD(0x410)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x410));
	printk("****VHDPDUMTHD(0x414)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x414));
	printk("****VHDPDPCCCORING(0x418)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x418));
	printk("****VHDPDPCCHTHD(0x41c)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x41c));
	printk("****VHDPDPCCVTHD(0x420)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x420));
	printk("****VHDPDITDIFFVTHD(0x424)   : 0x%0x \n", VPP_REG(s_xl_mmio,0x424));
	printk("****VHDPDLASITHD(0x428)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x428));
	printk("****VHDPDFRMITDIFF(0x42c)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x42c));
	printk("****VHDPDSTLBLKSAD(0x430)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x430));
	printk("****VHDPDSTLBLKSAD(0x434)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x434));
	printk("****VHDPDSTLBLKSAD(0x438)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x438));
	printk("****VHDPDSTLBLKSAD(0x43c)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x43c));
	printk("****VHDPDSTLBLKSAD(0x440)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x440));
	printk("****VHDPDSTLBLKSAD(0x444)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x444));
	printk("****VHDPDSTLBLKSAD(0x448)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x448));
	printk("****VHDPDSTLBLKSAD(0x44c)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x44c));
	printk("****VHDPDSTLBLKSAD(0x450)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x450));
	printk("****VHDPDSTLBLKSAD(0x454)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x454));
	printk("****VHDPDSTLBLKSAD(0x458)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x458));
	printk("****VHDPDSTLBLKSAD(0x45c)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x45c));
	printk("****VHDPDSTLBLKSAD(0x460)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x460));
	printk("****VHDPDSTLBLKSAD(0x464)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x464));
	printk("****VHDPDSTLBLKSAD(0x468)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x468));
	printk("****VHDPDSTLBLKSAD(0x46c)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x46c));
	printk("****VHDPDHISTBIN(0x470)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x470));
	printk("****VHDPDHISTBIN(0x474)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x474));
	printk("****VHDPDHISTBIN(0x478)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x478));
	printk("****VHDPDHISTBIN(0x47c)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x47c));
	printk("****VHDPDUMMATCH0(0x480)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x480));
	printk("****VHDPDUMNOMATCH0(0x484)   : 0x%0x \n", VPP_REG(s_xl_mmio,0x484));
	printk("****VHDPDUMMATCH1(0x488)     : 0x%0x \n", VPP_REG(s_xl_mmio,0x488));
	printk("****VHDPDUMNOMATCH1(0x48c)   : 0x%0x \n", VPP_REG(s_xl_mmio,0x48c));
	printk("****VHDPDPCCFFWD(0x490)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x490));
	printk("****VHDPDPCCFWD(0x494)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x494));
	printk("****VHDPDPCCBWD(0x498)       : 0x%0x \n", VPP_REG(s_xl_mmio,0x498));
	printk("****VHDPDPCCCRSS(0x49c)      : 0x%0x \n", VPP_REG(s_xl_mmio,0x49c));
	printk("****VHDPDPCCPW(0x4a0)        : 0x%0x \n", VPP_REG(s_xl_mmio,0x4a0));
	printk("****VHDPDPCCFWDTKR(0x4a4)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4a4));
	printk("****VHDPDPCCBWDTKR(0x4a8)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4a8));
	printk("****VHDPDPCCBLKFWD(0x4ac)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4ac));
	printk("****VHDPDPCCBLKFWD(0x4b0)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4b0));
	printk("****VHDPDPCCBLKFWD(0x4b4)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4b4));
	printk("****VHDPDPCCBLKFWD(0x4b8)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4b8));
	printk("****VHDPDPCCBLKFWD(0x4bc)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4bc));
	printk("****VHDPDPCCBLKFWD(0x4c0)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4c0));
	printk("****VHDPDPCCBLKFWD(0x4c4)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4c4));
	printk("****VHDPDPCCBLKFWD(0x4c8)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4c8));
	printk("****VHDPDPCCBLKFWD(0x4cc)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4cc));
	printk("****VHDPDPCCBLKBWD(0x4d0)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4d0));
	printk("****VHDPDPCCBLKBWD(0x4d4)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4d4));
	printk("****VHDPDPCCBLKBWD(0x4d8)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4d8));
	printk("****VHDPDPCCBLKBWD(0x4dc)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4dc));
	printk("****VHDPDPCCBLKBWD(0x4e0)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4e0));
	printk("****VHDPDPCCBLKBWD(0x4e4)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4e4));
	printk("****VHDPDPCCBLKBWD(0x4e8)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4e8));
	printk("****VHDPDPCCBLKBWD(0x4ec)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4ec));
	printk("****VHDPDPCCBLKBWD(0x4f0)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4f0));
	printk("****VHDPDLASICNT14(0x4f4)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4f4));
	printk("****VHDPDLASICNT32(0x4f8)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4f8));
	printk("****VHDPDLASICNT34(0x4fc)    : 0x%0x \n", VPP_REG(s_xl_mmio,0x4fc));
...
void log_config_value(VPP_CONFIG_S* pVppConfig)
{
#if DEBUG_LEVEL
    BUG_ON(NULL == pVppConfig);

    printk("\n************** vpp config list start ***************\n");

	printk("bincrop_enable(%d), bdie_enbale(%d), bcsc_enable(%d), bscal_enable(%d) \n",
	       pVppConfig->bincrop_enable, pVppConfig->bdie_enbale, pVppConfig->bcsc_enable, pVppConfig->bscal_enable);

    /* VPP_INIMAGE_S */
	printk("vpp_in_img.pixformat(0x%x), vpp_in_img.width(%u), vpp_in_img.height(%u) \n",
	       pVppConfig->vpp_in_img.pixformat, pVppConfig->vpp_in_img.width, pVppConfig->vpp_in_img.height);
	printk("vpp_in_img.buffer_bus_addr(0x%x), vpp_in_img.stride(%u) \n",
	       pVppConfig->vpp_in_img.buffer_bus_addr, pVppConfig->vpp_in_img.stride);

    /* VPP_OUTIMAGE_S */
	printk("vpp_out_img.pixformat(0x%x), vpp_out_img.width(%u), vpp_out_img.height(%u) \n",
	       pVppConfig->vpp_out_img.pixformat, pVppConfig->vpp_out_img.width, pVppConfig->vpp_out_img.height);
	printk("vpp_out_img.buffer_bus_addr(0x%x), vpp_out_img.stride(%u) \n",
	       pVppConfig->vpp_out_img.buffer_bus_addr, pVppConfig->vpp_out_img.stride);

    /* VPP_CSCCOEF_E */
	printk("encsc_mode(%d) \n", pVppConfig->encsc_mode);

    /* VPP_DIE_ADDRINFO_S */
	printk("vpp_die_addrinfo.lluma_addr(0x%x), vpp_die_addrinfo.lchroma_addr(0x%x) \n",
	       pVppConfig->vpp_die_addrinfo.lluma_addr, pVppConfig->vpp_die_addrinfo.lchroma_addr);
	printk("vpp_die_addrinfo.cluma_addr(0x%x), vpp_die_addrinfo.cchroma_addr(0x%x) \n",
	       pVppConfig->vpp_die_addrinfo.cluma_addr, pVppConfig->vpp_die_addrinfo.cchroma_addr);
	printk("vpp_die_addrinfo.nluma_addr(0x%x), vpp_die_addrinfo.nchroma_addr(0x%x) \n",
	       pVppConfig->vpp_die_addrinfo.nluma_addr, pVppConfig->vpp_die_addrinfo.nchroma_addr);

    /* VPP_INCROPPING_S */
	printk("vpp_in_crop.cropX(%u), vpp_in_crop.cropY(%u) \n",
	       pVppConfig->vpp_in_crop.cropX, pVppConfig->vpp_in_crop.cropY);
	printk("vpp_in_crop.height(%u), vpp_in_crop.width(%u) \n",
	       pVppConfig->vpp_in_crop.height, pVppConfig->vpp_in_crop.width);

    /* VPP_DIE_CFG_S */
	printk("vpp_die_config.edie_lum_mode(%d), vpp_die_config.edie_chm_mode(%d) \n",
	       pVppConfig->vpp_die_config.edie_lum_mode, pVppConfig->vpp_die_config.edie_chm_mode);
	printk("vpp_die_config.edie_st_mode(%d), vpp_die_config.edie_fod(%d) \n",
	       pVppConfig->vpp_die_config.edie_st_mode, pVppConfig->vpp_die_config.edie_fod);

    printk("************** vpp config list end *****************\n\n");
#endif
...
void hal_init(void)
{
    s_xl_mmio = ioremap(REG_BASE_VPP,CP_REGS_SIZE);
    if( NULL == s_xl_mmio)
    {
                                            ...
                                            VPP_PIXELFORMAT_E  enDataFmt)
{
    ...
    switch(enLayer)
    {
        case HAL_LAYER_VIDEO1:
        {
            ...
            if(enDataFmt == VPP_INPUTFMT_YCBCR_SEMIPLANAR_420S)
            {
                VHDCTRL.bits.ifmt = VPP_INPUTFMT_YCBCR_SEMIPLANAR_420;
            }
            else if(enDataFmt == VPP_INPUTFMT_YCBCR_SEMIPLANAR_422S)
            {
                VHDCTRL.bits.ifmt = VPP_INPUTFMT_YCBCR_SEMIPLANAR_422;
            }
            else if(enDataFmt == VPP_INPUTFMT_YCBCR_SEMIPLANAR_444S)
            {
                VHDCTRL.bits.ifmt = VPP_INPUTFMT_YCBCR_SEMIPLANAR_444;
            }
            else
            {
    ...
    ||(enDataFmt == VPP_INPUTFMT_YCBCR_SEMIPLANAR_420S)
    ||(enDataFmt == VPP_INPUTFMT_YCBCR_PLANAR_420))
    {
        logd("Ver Zme Enable,420 data format\n");

        hal_set_zme_ver_type(enLayer, 1);
        hal_set_zme_vertap (enLayer, HAL_ZMEMODE_VERC, 1);

        hal_set_zme_enable   (enLayer, HAL_ZMEMODE_VER, 1);
        hal_set_zme_fir_enable(enLayer, HAL_ZMEMODE_VER, 0);
    }
    else
    {
        logd("Ver Zme Enable,422 data format\n");
        hal_set_zme_ver_type(enLayer, 0);
        hal_set_zme_vertap (enLayer, HAL_ZMEMODE_VERC, 0);

        hal_set_zme_enable   (enLayer, HAL_ZMEMODE_VER, 0);
        hal_set_zme_fir_enable(enLayer, HAL_ZMEMODE_VER, 0);
    }
...
void hal_set_zme_ver_type(HAL_LAYER_E enLayer, unsigned int uVerType)
{
    U_VHDVSP VHDVSP;
    VHDVSP.u32 = 0x0;
