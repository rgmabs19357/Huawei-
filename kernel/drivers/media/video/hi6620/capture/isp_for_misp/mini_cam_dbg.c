...
void mini_isp_debug_init_cmd_reg(void)
{
    ...
    /* init from file */
    mini_isp_debug_load_reg("/data/isptest/ov-cmd-reg.txt",
                       g_cmd_reg_key,
                       ISP_CMD_REG_MAX,
                       &g_cmd_reg_cnt);
...
void mini_isp_debug_init_irq_reg(void)
{
    ...
    /* init from file */
    mini_isp_debug_load_reg("/data/isptest/ov-irq-reg.txt",
                       g_irq_reg_key,
                       ISP_IRQ_REG_MAX,
                       &g_irq_reg_cnt);
...
int mini_isp_debug_init()
{
    ...
    mini_isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt","camera.debug.zsl.onlineenable", &zsl_online_enable);
    mini_isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt","camera.debug.zsl.backidx", &zsl_back_idx);
    mini_isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt","camera.debug.printflg", &print_flg);
    mini_isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt", "camera.debug.zsl.copyflg", &zsl_copy_flg);
    mini_isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt", "camera.debug.sensor.apaeflg", &ap_ae_flg);
    mini_isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt", "camera.debug.sensor.colorbarflg", &color_bar_flg);
