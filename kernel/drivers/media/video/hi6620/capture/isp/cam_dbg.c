...
void isp_debug_init_cmd_reg(void)
{
    ...
    /* init from file */
    isp_debug_load_reg("/data/isptest/ov-cmd-reg.txt",
                       g_cmd_reg_key,
                       ISP_CMD_REG_MAX,
                       &g_cmd_reg_cnt);
...
void isp_debug_init_irq_reg(void)
{
    ...
    /* init from file */
    isp_debug_load_reg("/data/isptest/ov-irq-reg.txt",
                       g_irq_reg_key,
                       ISP_IRQ_REG_MAX,
                       &g_irq_reg_cnt);
...
int isp_debug_init()
{
    ...
    isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt","camera.debug.zsl.onlineenable", &zsl_online_enable);
    isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt","camera.debug.zsl.backidx", &zsl_back_idx);
    isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt","camera.debug.printflg", &print_flg);
    isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt", "camera.debug.zsl.copyflg", &zsl_copy_flg);
    isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt", "camera.debug.sensor.apaeflg", &ap_ae_flg);
    isp_debug_load_cfg("/data/isptest/ov-isp-cfg.txt", "camera.debug.sensor.colorbarflg", &color_bar_flg);
