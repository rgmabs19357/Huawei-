...
#define ISP_PROC_IMAGE_MAC_DROP_THRESHHOLD  (0x1c5a5)       //when drop,process slice again.
#define PROC_IMAGE_MAC_DROP_THRESHHOLD      (4)            //max drop we can tolerate while processing image with preview.
...
#define REG_ISP_GDNS(x)		(0x6551a + (x))
#define REG_ISP_BRDNS(x)		(0x65522 + (x)*2)
#define REG_ISP_UVDNS(x)		(0x65c00 + (x))
