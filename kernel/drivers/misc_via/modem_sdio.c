...
static void modem_sdio_irq(struct sdio_func *func)
{
	...
	if((sdio_log_level > LOG_NOTICE) || (modem->msg->head.chanInfo  == SDIO_AT_CHANNEL_NUM) ||
		(modem->msg->head.chanInfo  == SDIO_AT_CHANNEL_NUM_10) || (modem->msg->head.chanInfo  == SDIO_AT_CHANNEL_NUM_11)){
