#ifndef HI6620_DIGITAL_H
#define HI6620_DIGITAL_H
...
#define SIO1_INT_CLR  ( 0x200C )  /* SIO1_INT_CLR */
...
#define SIO1_CLR    ( 0x2038 )  /* SIO CLEAR FIFO */
#define SIO1_TST_TX0_DATA   (0x2040)
#define SIO1_TST_TX1_DATA   (0x2044)
#define SIO1_TST_TX2_DATA   (0x2048)
#define SIO1_TST_TX3_DATA   (0x204C)
#define SIO1_TST_TX4_DATA   (0x2050)
#define SIO1_TST_TX5_DATA   (0x2054)
#define SIO1_TST_TX6_DATA   (0x2058)
#define SIO1_TST_TX7_DATA   (0x205C)
...
#define SPDIF_INTRUPT       ( 0x3008 )  /* SPDIF SPDIF_INTRUPT */
...
#define HIGHBIT_IS_LEFT     ( 0 << 3 )  
#define HIGHBIT_IS_RIGHT     ( 1 << 3 )  
...
#define HI6620_RECODE_16BIT     ( 1 )   /* record 16bit */
#define HI6620_RECODE_24BIT     ( 0 )   /* record 24bit */
#define HI6620_HIGHBIT_LEFT     ( 1 << 1 )
...
typedef struct {
    ...
    /* asp cfg clock*/
    struct clk* clk_asp_cfg;
    /* ASP clock */
    struct clk *clk_asphdmi_ref;
    /* ASPHDMI mclk */
    struct clk *clk_hdmi_m;
    struct clk *clk_hdmi_s;
    /* ASPSPDIF clk */
    struct clk *clk_aspspdif;
    /* ASPSIO clk */
    struct clk *clk_asphdmi_adws;
    struct clk *clk_asphdmi_bclk;
}AUDIO_CLK_STRU ;
...
struct hi6620_digital_runtime_data {
    spinlock_t lock;            /* protect hi6620_runtime_data */
    bool use2tx_flag;          /* flag of using two channel*/
    struct hi6620_tx_runtime_data tx[2];/*tx[0] for tx0/tx2/tx3 & tx[1] for tx1*/
    unsigned int  period_size;  /* DMA SIZE */
    unsigned int  period_next;  /* record which period to fix dma next time */
    unsigned int  period_cur;   /* record which period using now */
    bool two_dma_flag;          /* flag of using two dma,for capture */
    enum HI6620_STATUS status;  /* pcm status running or stop */
