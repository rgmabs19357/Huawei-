...
/*****************************************************************************
 函 数 名  : hi6620_mailbox_send_data
 功能描述  : 邮箱核间通信数据发送
 输入参数  : void *pmsg_body        : 要发送的数据包
             unsigned int msg_len   : 数据包长度
 输出参数  : 无
 返 回 值  : STATIC int
 调用函数  : hi6620_notify_pcm_*()
 被调函数  :
...
/*****************************************************************************
 函 数 名  : hi6620_notify_pcm_set_buf
 功能描述  : 核间通信告知HIFI 数据BUFFER已就绪
 输入参数  : hifi_channel_set_buffer *psrc_data
 输出参数  : 无
 返 回 值  : STATIC int, 0 for Success; Others for error
 调用函数  : hi6620_intr_handle_pb()和hi6620_intr_handle_cp()
 被调函数  :
...
/*****************************************************************************
 函 数 名  : hi6620_notify_isr_register
 功能描述  : 邮箱核间数据接收回调函数注册
...
/*****************************************************************************
 函 数 名  : hi6620_pcm_hifi_hw_params
