...
static struct platform_device *xmm_pdev;
			     ...
			     const char *buf, size_t count)
{
	...
	if (state == POWER_SET_ON) {
		...
		*xmm_driver_plat_data->post_suspend = xmm_power_runtime_idle;
		*xmm_driver_plat_data->pre_resume = xmm_power_runtime_resume;
