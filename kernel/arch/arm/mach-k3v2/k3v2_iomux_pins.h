...
IOMUX_PIN(gpio_055_cs, "isp_scl0", FUNC1, PULLDOWN, LEVEL2, &iomg19, &iocg71)
IOMUX_PIN(gpio_056_cs, "isp_sda0", FUNC1, PULLDOWN, LEVEL2, &iomg19, &iocg72)
...
IOMUX_PIN(gpio_166_cs, "bt_spi_clk", RESERVE, PULLDOWN, LEVEL2, NULL, &iocg181)
IOMUX_PIN(gpio_167_cs, "bt_spi_csn", RESERVE, PULLDOWN, LEVEL2, NULL, &iocg182)
IOMUX_PIN(gpio_168_cs, "bt_spi_data", RESERVE, PULLDOWN, LEVEL2, NULL, &iocg183)
IOMUX_PIN(gpio_169_cs, "bt_enable_rm", RESERVE, PULLDOWN, LEVEL2, NULL, &iocg184)
IOMUX_PIN(gpio_170_cs, "bt_26M_in", RESERVE, PULLDOWN, LEVEL2, NULL, &iocg185)
IOMUX_PIN(gpio_171_cs, "rftcxo_pwr", FUNC1, PULLDOWN, LEVEL2, &iomg90, &iocg186)
IOMUX_PIN(gpio_172_cs, "coex_btpriority", RESERVE, PULLDOWN, RESERVE, NULL, &iocg187)
IOMUX_PIN(gpio_173_cs, "coex_btactive", RESERVE, PULLDOWN, RESERVE, NULL, &iocg188)
IOMUX_PIN(gpio_174_cs, "coex_wlactive", RESERVE, PULLDOWN, RESERVE, NULL, &iocg189)
