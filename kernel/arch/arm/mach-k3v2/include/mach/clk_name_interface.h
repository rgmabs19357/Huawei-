...
/* source clocks */
#define CLKIN_SYS 	"clkin_sys"			/* system clock for tcxo0 or tcxo1 */
#define CLK_REF32K	"clk_pmu32kc"			/* sleep clock */
...
#define CLK_MMC0HIGH	"clk_mmc0_high"		/* mmc0 high clock */
#define CLK_MMC1HIGH	"clk_mmc1_high"		/* mmc1 high clock */
#define CLK_MMC2HIGH	"clk_mmc2_high"		/* mmc2 high clock */
#define CLK_MMC0LOW		"clk_mmc0_low"		/* mmc0 low clock */
#define CLK_MMC1LOW		"clk_mmc1_low"		/* mmc1 low clock */
#define CLK_MMC2LOW		"clk_mmc2_low"		/* mmc2 low clock */
...
/* VENC zone begin */
#define CLK_PERIPLL_VENC_GATED	"clk_perippll_venc_gated"	/* venc gate clock of before divisor rate */
