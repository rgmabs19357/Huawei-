...
SRC_CLK(clk_parent_dummy, "clk_parent_dummy", 0, CFGAXI_NORMAL_RATE, UNINITIALIZED, NULL, 0, NULL)
SRC_CLK(clk_friend_dummy, "clk_friend_dummy", 0, CFGAXI_NORMAL_RATE, UNINITIALIZED, NULL, 0, NULL)
...
{
/*don't need to set clock's gate for testchip*/
#if 0
...
CLK_WITH_FRIEND(clk_g3d, "clk_g3d", clk_parent_dummy,
	0, CFGAXI_NORMAL_RATE, CFGAXI_NORMAL_RATE, CFGAXI_NORMAL_RATE, clk_friend_dummy,
...
CLK_WITH_FRIEND(clk_g2d, "clk_g2d", pll2_parent_clk,
	0, PLL2_DIV5_RATE, PLL2_32DIV_RATE, PLL3_RATE, clk_friend_dummy,
...
#define _REGISTER_CLOCK(d, n, c) \
		...
		.con_id = n, \
		.clk = &c,
struct clk_lookup k3v2_clk_lookups_cs[] = {
	/*source  clock*/
