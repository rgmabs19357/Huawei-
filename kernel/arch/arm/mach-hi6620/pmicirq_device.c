...
PMU_LOCAL BSP_U32 pmic_record_reg_addr[PMIC_RECORD_REG_BUTT]={
    SOC_SMART_SCP_RECORD1_ADDR(0),
    SOC_SMART_OCP_RECORD1_ADDR(0),
    SOC_SMART_OCP_RECORD2_ADDR(0),
    SOC_SMART_OCP_RECORD3_ADDR(0),
    SOC_SMART_OCP_RECORD4_ADDR(0),
    SOC_SMART_OCP_RECORD5_ADDR(0),
    SOC_SMART_OCP_RECORD6_ADDR(0),
    SOC_SMART_OCP_RECORD7_ADDR(0),
};
...
PMU_LOCAL BSP_U32 pmic_no_pwr_reg_addr[PMIC_NO_PWR_REG_BUTT]={
    ...
    SOC_SMART_NP_OCP_RECORD6_ADDR(0),
    SOC_SMART_NP_OCP_RECORD7_ADDR(0),
};
...
static int __init pmicirq_device_init(void)
{
    ...
    printk(KERN_INFO "smartirq_devs init ok \n");
    return 0;
}
