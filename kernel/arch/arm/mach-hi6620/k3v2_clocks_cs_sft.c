...
MACRO_CLK(clkin_sys, CLKIN_SYS, ON, CLKIN_SYS_RATE, CLKIN_SYS_MIN_RATE, CLKIN_SYS_MAX_RATE, NULL, NULL, \
		NULL, CLKIN_SYS_ENABLE_REG_ADDR, CLKIN_SYS_ENABLE_BIT_OFFSET, CLKIN_SYS_CLKSEL_REG_ADDR, CLKIN_SYS_CLKSEL_MASK, \
		CLKIN_SYS_CLKSEL_SET_VALID, CLKIN_SYS_CLKDIV_REG_ADDR, CLKIN_SYS_CLKDIV_MASK, CLKIN_SYS_CLKDIV_SET_VALID)

MACRO_CLK(clk_ref, CLK_REF, ON, CLK_REF_RATE, CLK_REF_MIN_RATE, CLK_REF_MAX_RATE, NULL, NULL, NULL, NULL, 0, NULL, 0, -1, NULL, 0, -1)

MACRO_CLK(clk_ref32k, CLK_REF32K, ON, CLK_REF32K_RATE, CLK_REF32K_MIN_RATE, CLK_REF32K_MAX_RATE, NULL, NULL, \
		NULL, CLK_REF32K_ENABLE_REG_ADDR, CLK_REF32K_ENABLE_BIT_OFFSET, CLK_REF32K_CLKSEL_REG_ADDR, CLK_REF32K_CLKSEL_MASK, \
		CLK_REF32K_CLKSEL_SET_VALID, CLK_REF32K_CLKDIV_REG_ADDR, CLK_REF32K_CLKDIV_MASK, CLK_REF32K_CLKDIV_SET_VALID)
		
MACRO_CLK(clk_dsppll, CLK_DSPPLL, ON, CLK_DSPPLL_RATE, CLK_DSPPLL_MIN_RATE, CLK_DSPPLL_MAX_RATE, NULL, NULL, \
		NULL, CLK_DSPPLL_ENABLE_REG_ADDR, CLK_DSPPLL_ENABLE_BIT_OFFSET, CLK_DSPPLL_CLKSEL_REG_ADDR, CLK_DSPPLL_CLKSEL_MASK, \
		CLK_DSPPLL_CLKSEL_SET_VALID, CLK_DSPPLL_CLKDIV_REG_ADDR, CLK_DSPPLL_CLKDIV_MASK, CLK_DSPPLL_CLKDIV_SET_VALID)
...
PLL_CLK(clk_peripll, CLK_PERIPLL, OFF, CLK_PERIPLL_RATE, CLK_PERIPLL_MIN_RATE, CLK_PERIPLL_MAX_RATE, CLK_PERIPLL_ENABLE_REG_ADDR, CLK_PERIPLL_ENABLE_BIT_OFFSET)
...
MACRO_CLK(clk_ddrpll, CLK_DDRPLL, ON, CLK_DDRPLL_RATE, CLK_DDRPLL_MIN_RATE, CLK_DDRPLL_MAX_RATE, NULL, NULL, \
		NULL, CLK_DDRPLL_ENABLE_REG_ADDR, CLK_DDRPLL_ENABLE_BIT_OFFSET, CLK_DDRPLL_CLKSEL_REG_ADDR, CLK_DDRPLL_CLKSEL_MASK, \
		CLK_DDRPLL_CLKSEL_SET_VALID, CLK_DDRPLL_CLKDIV_REG_ADDR, CLK_DDRPLL_CLKDIV_MASK, CLK_DDRPLL_CLKDIV_SET_VALID)
MACRO_CLK(clk_300m_src, CLK_300M_SRC, ON, CLK_300M_SRC_RATE, CLK_300M_SRC_MIN_RATE, CLK_300M_SRC_MAX_RATE, &clk_dsppll, NULL, \
		NULL, CLK_300M_SRC_ENABLE_REG_ADDR, CLK_300M_SRC_ENABLE_BIT_OFFSET, CLK_300M_SRC_CLKSEL_REG_ADDR, CLK_300M_SRC_CLKSEL_MASK, \
		CLK_300M_SRC_CLKSEL_SET_VALID, CLK_300M_SRC_CLKDIV_REG_ADDR, CLK_300M_SRC_CLKDIV_MASK, CLK_300M_SRC_CLKDIV_SET_VALID)
MACRO_CLK(clk_100m_src, CLK_100M_SRC, ON, CLK_100M_SRC_RATE, CLK_100M_SRC_MIN_RATE, CLK_100M_SRC_MAX_RATE, &clk_300m_src, NULL, \
		NULL, CLK_100M_SRC_ENABLE_REG_ADDR, CLK_100M_SRC_ENABLE_BIT_OFFSET, CLK_100M_SRC_CLKSEL_REG_ADDR, CLK_100M_SRC_CLKSEL_MASK, \
		CLK_100M_SRC_CLKSEL_SET_VALID, CLK_100M_SRC_CLKDIV_REG_ADDR, CLK_100M_SRC_CLKDIV_MASK, CLK_100M_SRC_CLKDIV_SET_VALID)
MACRO_CLK(clk_bus_src, CLK_BUS_SRC, ON, CLK_BUS_SRC_RATE, CLK_BUS_SRC_MIN_RATE, CLK_BUS_SRC_MAX_RATE, &clk_300m_src, NULL, \
		NULL, CLK_BUS_SRC_ENABLE_REG_ADDR, CLK_BUS_SRC_ENABLE_BIT_OFFSET, CLK_BUS_SRC_CLKSEL_REG_ADDR, CLK_BUS_SRC_CLKSEL_MASK, \
		CLK_BUS_SRC_CLKSEL_SET_VALID, CLK_BUS_SRC_CLKDIV_REG_ADDR, CLK_BUS_SRC_CLKDIV_MASK, CLK_BUS_SRC_CLKDIV_SET_VALID)
...
MACRO_CLK(clk_27m_gated, CLK_27M_GATED, OFF, CLK_27M_GATED_RATE,CLK_27M_GATED_MIN_RATE, CLK_27M_GATED_MAX_RATE, NULL, NULL, \
...
static struct clksel clksels_ddrio[] = {
	{.sel_parent = &clk_ddrpll, .sel_val = 0x00, 
	.parent_min = CLK_DDRPLL_RATE/CLK_DDRIO_DIV_MAX, .parent_max = CLK_DDRPLL_RATE},
	{.sel_parent = &clk_dsppll, .sel_val = 0x01, 
	.parent_min = CLK_DSPPLL_RATE/CLK_DDRIO_DIV_MAX, .parent_max = CLK_DSPPLL_RATE},
	{.sel_parent = &clk_gpll1, .sel_val = 0x03, 
	.parent_min = CLK_GPLL1_RATE/CLK_DDRIO_DIV_MAX, .parent_max = CLK_GPLL1_RATE},
	{.sel_parent = NULL},
};			
MACRO_CLK(clk_ddrio_div, CLK_DDRIO, OFF, CLK_DDRIO_RATE, CLK_DDRIO_MIN_RATE, CLK_DDRIO_MAX_RATE, &clk_ddrpll, NULL, \
		clksels_ddrio, CLK_DDRIO_ENABLE_REG_ADDR, CLK_DDRIO_ENABLE_BIT_OFFSET, CLK_DDRIO_CLKSEL_REG_ADDR, CLK_DDRIO_CLKSEL_MASK, \
		CLK_DDRIO_CLKSEL_SET_VALID, CLK_DDRIO_CLKDIV_REG_ADDR, CLK_DDRIO_CLKDIV_MASK, CLK_DDRIO_CLKDIV_SET_VALID)
MACRO_CLK(clk_ddrio, CLK_DDRIO_DIV, OFF, CLK_DDRIO_DIV_RATE, CLK_DDRIO_DIV_MIN_RATE, CLK_DDRIO_DIV_MAX_RATE, &clk_ddrio_div, NULL, \
		NULL, CLK_DDRIO_DIV_ENABLE_REG_ADDR, CLK_DDRIO_DIV_ENABLE_BIT_OFFSET, CLK_DDRIO_DIV_CLKSEL_REG_ADDR, CLK_DDRIO_DIV_CLKSEL_MASK, \
		CLK_DDRIO_DIV_CLKSEL_SET_VALID, CLK_DDRIO_DIV_CLKDIV_REG_ADDR, CLK_DDRIO_DIV_CLKDIV_MASK, CLK_DDRIO_DIV_CLKDIV_SET_VALID)
MACRO_CLK(clk_ddrc_div, CLK_DDRC_DIV, OFF, CLK_DDRC_DIV_RATE, CLK_DDRC_DIV_MIN_RATE, CLK_DDRC_DIV_MAX_RATE, &clk_ddrio_div, NULL, \
		NULL, CLK_DDRC_DIV_ENABLE_REG_ADDR, CLK_DDRC_DIV_ENABLE_BIT_OFFSET, CLK_DDRC_DIV_CLKSEL_REG_ADDR, CLK_DDRC_DIV_CLKSEL_MASK, \
		CLK_DDRC_DIV_CLKSEL_SET_VALID, CLK_DDRC_DIV_CLKDIV_REG_ADDR, CLK_DDRC_DIV_CLKDIV_MASK, CLK_DDRC_DIV_CLKDIV_SET_VALID)
MACRO_CLK(clk_ddrc, CLK_DDRC, OFF, CLK_DDRC_RATE, CLK_DDRC_MIN_RATE, CLK_DDRC_MAX_RATE, &clk_ddrc_div, NULL, \
		NULL, CLK_DDRC_ENABLE_REG_ADDR, CLK_DDRC_ENABLE_BIT_OFFSET, CLK_DDRC_CLKSEL_REG_ADDR, CLK_DDRC_CLKSEL_MASK, \
		CLK_DDRC_CLKSEL_SET_VALID, CLK_DDRC_CLKDIV_REG_ADDR, CLK_DDRC_CLKDIV_MASK, CLK_DDRC_CLKDIV_SET_VALID)
MACRO_CLK(clk_ddrbus_div, CLK_DDRBUS_DIV, OFF, CLK_DDRBUS_DIV_RATE, CLK_DDRBUS_DIV_MIN_RATE, CLK_DDRBUS_DIV_MAX_RATE, &clk_ddrc_div, NULL, \
		NULL, CLK_DDRBUS_DIV_ENABLE_REG_ADDR, CLK_DDRBUS_DIV_ENABLE_BIT_OFFSET, CLK_DDRBUS_DIV_CLKSEL_REG_ADDR, CLK_DDRBUS_DIV_CLKSEL_MASK, \
		CLK_DDRBUS_DIV_CLKSEL_SET_VALID, CLK_DDRBUS_DIV_CLKDIV_REG_ADDR, CLK_DDRBUS_DIV_CLKDIV_MASK, CLK_DDRBUS_DIV_CLKDIV_SET_VALID)
MACRO_CLK(clk_ddrphy, CLK_DDRPHY, OFF, CLK_DDRPHY_RATE, CLK_DDRPHY_MIN_RATE, CLK_DDRPHY_MAX_RATE, &clk_ddrc_div, NULL, \
		NULL, CLK_DDRPHY_ENABLE_REG_ADDR, CLK_DDRPHY_ENABLE_BIT_OFFSET, CLK_DDRPHY_CLKSEL_REG_ADDR, CLK_DDRPHY_CLKSEL_MASK, \
		CLK_DDRPHY_CLKSEL_SET_VALID, CLK_DDRPHY_CLKDIV_REG_ADDR, CLK_DDRPHY_CLKDIV_MASK, CLK_DDRPHY_CLKDIV_SET_VALID)
MACRO_CLK(clk_axi_video_bus, CLK_AXI_VIDEO_BUS, OFF, CLK_AXI_VIDEO_BUS_RATE, CLK_AXI_VIDEO_BUS_MIN_RATE, CLK_AXI_VIDEO_BUS_MAX_RATE, &clk_ddrbus_div, NULL, \
		NULL, CLK_AXI_VIDEO_BUS_ENABLE_REG_ADDR, CLK_AXI_VIDEO_BUS_ENABLE_BIT_OFFSET, CLK_AXI_VIDEO_BUS_CLKSEL_REG_ADDR, CLK_AXI_VIDEO_BUS_CLKSEL_MASK, \
		CLK_AXI_VIDEO_BUS_CLKSEL_SET_VALID, CLK_AXI_VIDEO_BUS_CLKDIV_REG_ADDR, CLK_AXI_VIDEO_BUS_CLKDIV_MASK, CLK_AXI_VIDEO_BUS_CLKDIV_SET_VALID)
MACRO_CLK(clk_axi_img_bus, CLK_AXI_IMG_BUS, OFF, CLK_AXI_IMG_BUS_RATE, CLK_AXI_IMG_BUS_MIN_RATE, CLK_AXI_IMG_BUS_MAX_RATE, &clk_ddrbus_div, NULL, \
		NULL, CLK_AXI_IMG_BUS_ENABLE_REG_ADDR, CLK_AXI_IMG_BUS_ENABLE_BIT_OFFSET, CLK_AXI_IMG_BUS_CLKSEL_REG_ADDR, CLK_AXI_IMG_BUS_CLKSEL_MASK, \
		CLK_AXI_IMG_BUS_CLKSEL_SET_VALID, CLK_AXI_IMG_BUS_CLKDIV_REG_ADDR, CLK_AXI_IMG_BUS_CLKDIV_MASK, CLK_AXI_IMG_BUS_CLKDIV_SET_VALID)
...
MACRO_CLK(clk_hdmi_slave, CLK_HDMI_SLAVE, OFF, CLK_HDMI_SLAVE_RATE, CLK_HDMI_SLAVE_MIN_RATE, CLK_HDMI_SLAVE_MAX_RATE, NULL, NULL, \
...
MACRO_CLK(clk_hdmi_sck, CLK_HDMI_SCK, OFF, CLK_HDMI_SCK_RATE, CLK_HDMI_SCK_MIN_RATE, CLK_HDMI_SCK_MAX_RATE, NULL, NULL, \
...
MACRO_CLK(clk_mclk_hdmi, CLK_MCLK_HDMI, OFF, CLK_MCLK_HDMI_RATE, CLK_MCLK_HDMI_MIN_RATE, CLK_MCLK_HDMI_MAX_RATE, NULL, NULL, \
...
MACRO_CLK(clk_asp_hdmi_adws, CLK_ASP_HDMI_ADWS, OFF, CLK_ASP_HDMI_ADWS_RATE, CLK_ASP_HDMI_ADWS_MIN_RATE, CLK_ASP_HDMI_ADWS_MAX_RATE, NULL, NULL, \
...
MACRO_CLK(clk_asp_hdmi_bclk, CLK_ASP_HDMI_BCLK, OFF, CLK_ASP_HDMI_BCLK_RATE, CLK_ASP_HDMI_BCLK_MIN_RATE, CLK_ASP_HDMI_BCLK_MAX_RATE, NULL, NULL, \
...
MACRO_CLK(clk_asp_spdif_ref, CLK_ASP_SPDIF_REF, OFF, CLK_ASP_SPDIF_REF_RATE, CLK_ASP_SPDIF_REF_MIN_RATE, CLK_ASP_SPDIF_REF_MAX_RATE, NULL, NULL, \
...
MACRO_CLK(clk_mali, CLK_MALI, OFF, CLK_MALI_RATE, CLK_MALI_MIN_RATE, CLK_MALI_MAX_RATE, &clk_gpll0, NULL, \
		clksels_mali, CLK_MALI_ENABLE_REG_ADDR, CLK_MALI_ENABLE_BIT_OFFSET, CLK_MALI_CLKSEL_REG_ADDR, CLK_MALI_CLKSEL_MASK, \
		CLK_MALI_CLKSEL_SET_VALID, CLK_MALI_CLKDIV_REG_ADDR, CLK_MALI_CLKDIV_MASK, CLK_MALI_CLKDIV_SET_VALID)
...
MACRO_CLK(clk_axi_mali_bus, CLK_AXI_MALI_BUS, OFF, CLK_AXI_MALI_BUS_RATE, CLK_AXI_MALI_BUS_MIN_RATE, CLK_AXI_MALI_BUS_MAX_RATE, &clk_ddrbus_div, NULL, \
...
MACRO_CLK(clk_isp_axi, CLK_ISP_AXI, OFF, CLK_ISP_AXI_RATE, CLK_ISP_AXI_MIN_RATE, CLK_ISP_AXI_MAX_RATE, &clk_ddrbus_div, NULL, \
...
MACRO_CLK(csi1_cfg_clk, CSI1_CFG_CLK, OFF, CSI1_CFG_CLK_RATE, CSI1_CFG_CLK_MIN_RATE, CSI1_CFG_CLK_MAX_RATE, &clk_bus_src, NULL, \
		NULL, CSI1_CFG_CLK_ENABLE_REG_ADDR, CSI1_CFG_CLK_ENABLE_BIT_OFFSET, CSI1_CFG_CLK_CLKSEL_REG_ADDR, CSI1_CFG_CLK_CLKSEL_MASK, \
		CSI1_CFG_CLK_CLKSEL_SET_VALID, CSI1_CFG_CLK_CLKDIV_REG_ADDR, CSI1_CFG_CLK_CLKDIV_MASK, CSI1_CFG_CLK_CLKDIV_SET_VALID)
...
MACRO_CLK(clk_dphy0_ref, CLK_DPHY0_REF, OFF, CLK_DPHY0_REF_RATE, CLK_DPHY0_REF_MIN_RATE, CLK_DPHY0_REF_MAX_RATE, &clkin_sys, NULL, \
...
MACRO_CLK(clk_dphy0_cfg, CLK_DPHY0_CFG, OFF, CLK_DPHY0_CFG_RATE, CLK_DPHY0_CFG_MIN_RATE, CLK_DPHY0_CFG_MAX_RATE, &clkin_sys, NULL, \
...
MACRO_CLK(clk_dphy1_cfg, CLK_DPHY1_CFG, OFF, CLK_DPHY1_CFG_RATE, CLK_DPHY1_CFG_MIN_RATE, CLK_DPHY1_CFG_MAX_RATE, &clkin_sys, NULL, \
...
MACRO_CLK(clk_dphy2_cfg, CLK_DPHY2_CFG, OFF, CLK_DPHY2_CFG_RATE, CLK_DPHY2_CFG_MIN_RATE, CLK_DPHY2_CFG_MAX_RATE, &clkin_sys, NULL, \
...
static struct clksel clksels_pwm0[] = {
	...
	.parent_min = CLKIN_SYS_RATE/CLK_PWM0_DIV_MAX, .parent_max = CLKIN_SYS_RATE},
	{.sel_parent = &clk_ref32k, .sel_val = 0x01, 
	.parent_min = CLK_REF32K_RATE/CLK_PWM0_DIV_MAX, .parent_max = CLK_REF32K_RATE},
	{.sel_parent = NULL},
};	

	
MACRO_CLK(clk_pwm0, CLK_PWM0, OFF, CLK_PWM0_RATE, CLK_PWM0_MIN_RATE, CLK_PWM0_MAX_RATE, &clkin_sys, NULL, \
...
MACRO_CLK(pclk_pwm0, PCLK_PWM0, OFF, PCLK_PWM0_RATE, PCLK_PWM0_MIN_RATE, PCLK_PWM0_MAX_RATE, &clk_bus_src, NULL, \
		clksels_pwm0, PCLK_PWM0_ENABLE_REG_ADDR, PCLK_PWM0_ENABLE_BIT_OFFSET, PCLK_PWM0_CLKSEL_REG_ADDR, PCLK_PWM0_CLKSEL_MASK, \
		PCLK_PWM0_CLKSEL_SET_VALID, PCLK_PWM0_CLKDIV_REG_ADDR, PCLK_PWM0_CLKDIV_MASK, PCLK_PWM0_CLKDIV_SET_VALID)
static struct clksel clksels_pwm1[] = {
	{.sel_parent = &clkin_sys, .sel_val = 0x00, 
	.parent_min = CLKIN_SYS_RATE/CLK_PWM1_DIV_MAX, .parent_max = CLKIN_SYS_RATE},
	{.sel_parent = &clk_ref32k, .sel_val = 0x01, 
	.parent_min = CLK_REF32K_RATE/CLK_PWM1_DIV_MAX, .parent_max = CLK_REF32K_RATE},
	{.sel_parent = NULL},
};		
MACRO_CLK(clk_pwm1, CLK_PWM1, OFF, CLK_PWM1_RATE, CLK_PWM1_MIN_RATE, CLK_PWM1_MAX_RATE, &clkin_sys, NULL, \
...
MACRO_CLK(pclk_pwm1, PCLK_PWM1, OFF, PCLK_PWM1_RATE, PCLK_PWM1_MIN_RATE, PCLK_PWM1_MAX_RATE, &clk_bus_src, NULL, \
		clksels_pwm0, PCLK_PWM1_ENABLE_REG_ADDR, PCLK_PWM1_ENABLE_BIT_OFFSET, PCLK_PWM1_CLKSEL_REG_ADDR, PCLK_PWM1_CLKSEL_MASK, \
		PCLK_PWM1_CLKSEL_SET_VALID, PCLK_PWM1_CLKDIV_REG_ADDR, PCLK_PWM1_CLKDIV_MASK, PCLK_PWM1_CLKDIV_SET_VALID)
...
MACRO_CLK(clk_timer0, CLK_TIMER0, OFF, CLK_TIMER0_RATE, CLK_TIMER0_MIN_RATE, CLK_TIMER0_MAX_RATE, &clk_ref, clkfr_timer0, \
...
MACRO_CLK(clk_timer1, CLK_TIMER1, OFF, CLK_TIMER1_RATE, CLK_TIMER1_MIN_RATE, CLK_TIMER1_MAX_RATE, &clk_ref, clkfr_timer1, \
...
MACRO_CLK(clk_timer2, CLK_TIMER2, OFF, CLK_TIMER2_RATE, CLK_TIMER2_MIN_RATE, CLK_TIMER2_MAX_RATE, &clk_ref, clkfr_timer2, \
...
MACRO_CLK(clk_timer3, CLK_TIMER3, OFF, CLK_TIMER3_RATE, CLK_TIMER3_MIN_RATE, CLK_TIMER3_MAX_RATE, &clk_ref, clkfr_timer3, \
...
MACRO_CLK(clk_timer4, CLK_TIMER4, OFF, CLK_TIMER4_RATE, CLK_TIMER4_MIN_RATE, CLK_TIMER4_MAX_RATE, &clk_ref, clkfr_timer4, \
...
MACRO_CLK(clk_timer5, CLK_TIMER5, OFF, CLK_TIMER5_RATE, CLK_TIMER5_MIN_RATE, CLK_TIMER5_MAX_RATE, &clk_ref, clkfr_timer5, \
...
MACRO_CLK(clk_timer6, CLK_TIMER6, OFF, CLK_TIMER6_RATE, CLK_TIMER6_MIN_RATE, CLK_TIMER6_MAX_RATE, &clk_ref, clkfr_timer6, \
...
MACRO_CLK(clk_timer7, CLK_TIMER7, OFF, CLK_TIMER7_RATE, CLK_TIMER7_MIN_RATE, CLK_TIMER7_MAX_RATE, &clk_ref, clkfr_timer7, \
...
MACRO_CLK(clk_timer8, CLK_TIMER8, OFF, CLK_TIMER8_RATE, CLK_TIMER8_MIN_RATE, CLK_TIMER8_MAX_RATE, &clk_ref, clkfr_timer8, \
...
/* edc1 clocks */	/* edc1 clocks */
	...
	{_REGISTER_CLOCK(NULL,		"csi1_cfg_clk", 					csi1_cfg_clk)},
	...
	{_REGISTER_CLOCK(NULL,	"clk_ddrio_div", 				clk_ddrio_div)},
	{_REGISTER_CLOCK(NULL,	"clk_ddrio", 					clk_ddrio)},
	{_REGISTER_CLOCK(NULL,	"clk_ddrc_div", 				clk_ddrc_div)},
	{_REGISTER_CLOCK(NULL,	"clk_ddrc", 					clk_ddrc)},
	{_REGISTER_CLOCK(NULL,	"clk_ddrbus_div", 			clk_ddrbus_div)},
	{_REGISTER_CLOCK(NULL,	"clk_ddrphy", 				clk_ddrphy)},
