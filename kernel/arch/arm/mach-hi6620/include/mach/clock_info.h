...
#define CLKIN_SYS_MIN_RATE 		19200000/CLKIN_SYS_DIV_MAX	//时钟最小频率宏定义
#define CLKIN_SYS_MAX_RATE 		19200000	//时钟最大频率宏定义
...
#define CLK_DSPPLL_MIN_RATE 	240000000/CLK_DSPPLL_DIV_MAX	//时钟最小频率宏定义
#define CLK_DSPPLL_MAX_RATE 	240000000	//时钟最大频率宏定义
#define CLK_DSPPLL_RATE 		CLK_DSPPLL_MIN_RATE		//时钟频率宏定义

/* clk_gpll0 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_GPLL0_DIV_MAX 		1
#define CLK_GPLL0_MIN_RATE 		60000000/CLK_GPLL0_DIV_MAX	//时钟最小频率宏定义
#define CLK_GPLL0_MAX_RATE 		60000000	//时钟最大频率宏定义
#define CLK_GPLL0_RATE 			CLK_GPLL0_MIN_RATE		//时钟频率宏定义
	
/* clk_gpll1 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_GPLL1_DIV_MAX 		1
#define CLK_GPLL1_MIN_RATE 		30000000/CLK_GPLL1_DIV_MAX	//时钟最小频率宏定义
#define CLK_GPLL1_MAX_RATE 		30000000	//时钟最大频率宏定义
#define CLK_GPLL1_RATE 			CLK_GPLL1_MIN_RATE		//时钟频率宏定义
	
/* clk_peripll 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_PERIPLL_DIV_MAX 	1
#define CLK_PERIPLL_MIN_RATE 	480000000/CLK_PERIPLL_DIV_MAX	//时钟最小频率宏定义
#define CLK_PERIPLL_MAX_RATE 	480000000	//时钟最大频率宏定义
#define CLK_PERIPLL_RATE 		CLK_PERIPLL_MIN_RATE		//时钟频率宏定义
	
/* clk_hdmipll 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_HDMIPLL_DIV_MAX 	1
#define CLK_HDMIPLL_MIN_RATE 	594000000/CLK_HDMIPLL_DIV_MAX	//时钟最小频率宏定义
#define CLK_HDMIPLL_MAX_RATE 	594000000	//时钟最大频率宏定义
#define CLK_HDMIPLL_RATE 		CLK_HDMIPLL_MIN_RATE		//时钟频率宏定义
	
/* clk_ddrpll 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_DDRPLL_DIV_MAX 		1
#define CLK_DDRPLL_MIN_RATE 	30000000/CLK_DDRPLL_DIV_MAX	//时钟最小频率宏定义
#define CLK_DDRPLL_MAX_RATE 	30000000	//时钟最大频率宏定义
#define CLK_DDRPLL_RATE 		CLK_DDRPLL_MIN_RATE		//时钟频率宏定义
	
/* clk_300m_src 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_300M_SRC_DIV_MAX 	1
#define CLK_300M_SRC_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_300M_SRC_DIV_MAX	//时钟最小频率宏定义
#define CLK_300M_SRC_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_100M_SRC_MIN_RATE 	CLK_300M_SRC_MIN_RATE/CLK_100M_SRC_DIV_MAX	//时钟最小频率宏定义
#define CLK_100M_SRC_MAX_RATE 	CLK_300M_SRC_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_BUS_SRC_RATE 		CLK_BUS_SRC_MIN_RATE		//时钟频率宏定义
/* clk_bus_src 基本信息，包括clock宏名、频率、最小频率，最大频率 */
...
#define CLK_2VPP_SLAVE_CLK_MIN_RATE 	CLK_PERIPLL_VPP_GATED_MIN_RATE/CLK_2VPP_SLAVE_CLK_DIV_MAX	//时钟最小频率宏定义
#define CLK_2VPP_SLAVE_CLK_MAX_RATE 	CLK_PERIPLL_VPP_GATED_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_0VENC_SLAVE_CLK_MIN_RATE 	CLK_PERIPLL_VENC_GATED_MIN_RATE/CLK_0VENC_SLAVE_CLK_DIV_MAX	//时钟最小频率宏定义
#define CLK_0VENC_SLAVE_CLK_MAX_RATE 	CLK_PERIPLL_VENC_GATED_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_1VDEC_SLAVE_CLK_MIN_RATE 	CLK_PERIPLL_VDEC_GATED_MIN_RATE/CLK_1VDEC_SLAVE_CLK_DIV_MAX	//时钟最小频率宏定义
#define CLK_1VDEC_SLAVE_CLK_MAX_RATE 	CLK_PERIPLL_VDEC_GATED_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_PERIPLL_ISP_GATED_MIN_RATE 	CLK_PERIPLL_MIN_RATE/CLK_PERIPLL_ISP_GATED_DIV_MAX	//时钟最小频率宏定义
...
#define CLK_ISP_RATE 		CLK_ISP_MIN_RATE		//时钟频率宏定义
...
#define CLK_DPHY0_REF_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_DPHY0_REF_DIV_MAX	//时钟最小频率宏定义
#define CLK_DPHY0_REF_MAX_RATE 	CLKIN_SYS_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_DPHY0_CFG_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_DPHY0_CFG_DIV_MAX	//时钟最小频率宏定义
#define CLK_DPHY0_CFG_MAX_RATE 	CLKIN_SYS_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_DPHY1_CFG_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_DPHY1_CFG_DIV_MAX	//时钟最小频率宏定义
#define CLK_DPHY1_CFG_MAX_RATE 	CLKIN_SYS_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_DPHY2_CFG_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_DPHY2_CFG_DIV_MAX	//时钟最小频率宏定义
#define CLK_DPHY2_CFG_MAX_RATE 	CLKIN_SYS_MAX_RATE	//时钟最大频率宏定义
#define CLK_DPHY2_CFG_RATE 		CLK_DPHY2_CFG_MIN_RATE		//时钟频率宏定义

	
/* clk_uart0 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_UART0_DIV_MAX 	1
#define CLK_UART0_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_UART0_DIV_MAX	//时钟最小频率宏定义
#define CLK_UART0_MAX_RATE 	CLKIN_SYS_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_UART1_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_UART1_DIV_MAX	//时钟最小频率宏定义
#define CLK_UART1_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_UART2_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_UART2_DIV_MAX	//时钟最小频率宏定义
#define CLK_UART2_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_UART3_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_UART3_DIV_MAX	//时钟最小频率宏定义
#define CLK_UART3_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_UART4_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_UART4_DIV_MAX	//时钟最小频率宏定义
#define CLK_UART4_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_UART5_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_UART5_DIV_MAX	//时钟最小频率宏定义
#define CLK_UART5_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_UART6_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_UART6_DIV_MAX	//时钟最小频率宏定义
#define CLK_UART6_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_DSPPLL_MMC0_GATED_DIV_MAX 	8
...
#define CLK_DSPPLL_MMC1_GATED_DIV_MAX 	8
...
#define CLK_DSPPLL_MMC2_GATED_DIV_MAX 	8
...
#define CLK_MMC0LOW_DIV_MAX 	1
#define CLK_MMC0LOW_MIN_RATE 	CLK_DSPPLL_MMC0_GATED_MIN_RATE/CLK_MMC0LOW_DIV_MAX	//时钟最小频率宏定义
#define CLK_MMC0LOW_MAX_RATE 	CLK_DSPPLL_MMC0_GATED_MAX_RATE	//时钟最大频率宏定义
#define CLK_MMC0LOW_RATE 		CLK_MMC0LOW_MIN_RATE		//时钟频率宏定义

/* clk_mmc1low 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_MMC1LOW_DIV_MAX 	1
#define CLK_MMC1LOW_MIN_RATE 	CLK_DSPPLL_MMC1_GATED_MIN_RATE/CLK_MMC1LOW_DIV_MAX	//时钟最小频率宏定义
#define CLK_MMC1LOW_MAX_RATE 	CLK_DSPPLL_MMC1_GATED_MAX_RATE	//时钟最大频率宏定义
#define CLK_MMC1LOW_RATE 		CLK_MMC1LOW_MIN_RATE		//时钟频率宏定义

/* clk_mmc2low 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_MMC2LOW_DIV_MAX 	1
#define CLK_MMC2LOW_MIN_RATE 	CLK_DSPPLL_MMC2_GATED_MIN_RATE/CLK_MMC2LOW_DIV_MAX	//时钟最小频率宏定义
#define CLK_MMC2LOW_MAX_RATE 	CLK_DSPPLL_MMC2_GATED_MAX_RATE	//时钟最大频率宏定义
#define CLK_MMC2LOW_RATE 		CLK_MMC2LOW_MIN_RATE		//时钟频率宏定义
...
#define CLK_I2C0_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_I2C0_DIV_MAX	//时钟最小频率宏定义
#define CLK_I2C0_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_I2C1_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_I2C1_DIV_MAX	//时钟最小频率宏定义
#define CLK_I2C1_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_I2C2_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_I2C2_DIV_MAX	//时钟最小频率宏定义
#define CLK_I2C2_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_I2C3_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_I2C3_DIV_MAX	//时钟最小频率宏定义
#define CLK_I2C3_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_I2C4_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_I2C4_DIV_MAX	//时钟最小频率宏定义
#define CLK_I2C4_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_I2C5_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_I2C5_DIV_MAX	//时钟最小频率宏定义
#define CLK_I2C5_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_PWM0_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_PWM0_DIV_MAX	//时钟最小频率宏定义
#define CLK_PWM0_MAX_RATE 	CLKIN_SYS_MAX_RATE	//时钟最大频率宏定义
#define CLK_PWM0_RATE 		CLK_PWM0_MIN_RATE		//时钟频率宏定义
	
/* pclk_pwm0 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define PCLK_PWM0_DIV_MAX 	64
...
#define PCLK_PWM0_RATE 		PCLK_PWM0_MIN_RATE		//时钟频率宏定义
	
/* clk_pwm1 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_PWM1_DIV_MAX 	64
#define CLK_PWM1_MIN_RATE 	CLKIN_SYS_MIN_RATE/CLK_PWM1_DIV_MAX	//时钟最小频率宏定义
#define CLK_PWM1_MAX_RATE 	CLKIN_SYS_MIN_RATE	//时钟最大频率宏定义
#define CLK_PWM1_RATE 		CLK_PWM1_MIN_RATE		//时钟频率宏定义
	
/* pclk_pwm1 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define PCLK_PWM1_DIV_MAX 	64
...
#define PCLK_PWM1_RATE 		PCLK_PWM1_MIN_RATE		//时钟频率宏定义
	
/* clk_spi0 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_SPI0_DIV_MAX 	1
#define CLK_SPI0_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_SPI0_DIV_MAX	//时钟最小频率宏定义
#define CLK_SPI0_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_SPI1_MIN_RATE 	CLK_DSPPLL_MIN_RATE/CLK_SPI1_DIV_MAX	//时钟最小频率宏定义
#define CLK_SPI1_MAX_RATE 	CLK_DSPPLL_MAX_RATE	//时钟最大频率宏定义
...
#define CLK_PMUSSI_MIN_RATE   CLK_REF32K_MIN_RATE/CLK_PMUSSI_DIV_MAX   //时钟最小频率宏定义
#define CLK_PMUSSI_MAX_RATE   CLKIN_SYS_MAX_RATE    //时钟最大频率宏定义
...
#define CLK_WATCHDOG0_MIN_RATE   CLKIN_SYS_MIN_RATE/CLK_WATCHDOG0_DIV_MAX   //时钟最小频率宏定义
#define CLK_WATCHDOG0_MAX_RATE   CLKIN_SYS_MAX_RATE    //时钟最大频率宏定义
#define CLK_WATCHDOG0_RATE       CLK_WATCHDOG0_MIN_RATE       //时钟频率宏定义
#define PCLK_WATCHDOG0_DIV_MAX    1
#define PCLK_WATCHDOG0_MIN_RATE   CLKIN_SYS_MIN_RATE/PCLK_WATCHDOG0_DIV_MAX   //时钟最小频率宏定义
#define PCLK_WATCHDOG0_MAX_RATE   CLKIN_SYS_MAX_RATE    //时钟最大频率宏定义
