...
#define CLK_27M_GATED_ENABLE_REG_ADDR NULL    /* 使能寄存器地址转定义宏 */
#define CLK_27M_GATED_ENABLE_BIT_OFFSET   0   /* 时钟使能位偏移 */
...
#define CLK_DSPPLL_EDC0_CORE_GATED_ENABLE_BIT_OFFSET    SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_dsppll_edc0_core_gated_START           //时钟使能位偏移
...
#define CLK_MUX_EDC0_PIX_GATED_ENABLE_BIT_OFFSET    SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_mux_dec0_pix_gated_START           //时钟使能位偏移
...
#define CLK_PERIPLL_VPP_GATED_ENABLE_BIT_OFFSET SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_peripll_vpp_gated_START            //时钟使能位偏移
...
#define CLK_PERIPLL_VENC_GATED_ENABLE_BIT_OFFSET        SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_peripll_venc_gated_START           //时钟使能位偏移
...
#define CLK_PERIPLL_VDEC_GATED_ENABLE_BIT_OFFSET        SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_dsppll_vdec_gated_START            //时钟使能位偏移
...
#define CLK_1VDEC_SLAVE_CLK_ENABLE_BIT_OFFSET       SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_2vpp_slave_clk_START         //时钟使能位偏移
...
#define CLK_DSPPLL_G2DCORE_GATED_ENABLE_REG_ADDR        NULL //使能寄存器地址转定义宏
#define CLK_DSPPLL_G2DCORE_GATED_ENABLE_BIT_OFFSET      0         //时钟使能位偏移
...
#define CLK_P2P_MALI_BRG_S_ENABLE_REG_ADDR      SOC_SCTRL_SC_PERIPH_CLKEN8_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_P2P_MALI_BRG_S_ENABLE_BIT_OFFSET        SOC_SCTRL_SC_PERIPH_CLKEN8_periph_clken8_p2p_mali_brg_s_START           //时钟使能位偏移
...
#define CLK_DSIO_CFG_CLK_ENABLE_REG_ADDR        SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
...
#define CLK_PERIPLL_ISP_GATED_ENABLE_BIT_OFFSET     SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_dsppll_isp_gated_START         //时钟使能位偏移
...
#define CLK_PERIPLL_ISP_REF_GATED_ENABLE_BIT_OFFSET     SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_peripll_isp_ref_gated_START            //时钟使能位偏移
...
#define CLK_DSPPLL_MMC0_GATED_ENABLE_REG_ADDR       NULL   //使能寄存器地址转定义宏
#define CLK_DSPPLL_MMC0_GATED_ENABLE_BIT_OFFSET     0           //时钟使能位偏移
...
#define CLK_DSPPLL_MMC1_GATED_ENABLE_REG_ADDR       NULL    //使能寄存器地址转定义宏
#define CLK_DSPPLL_MMC1_GATED_ENABLE_BIT_OFFSET     0          //时钟使能位偏移
...
#define CLK_DSPPLL_MMC2_GATED_ENABLE_REG_ADDR      NULL    //使能寄存器地址转定义宏
#define CLK_DSPPLL_MMC2_GATED_ENABLE_BIT_OFFSET    0           //时钟使能位偏移
...
#define CLK_DSPPLL_HIFI_CORE_GATED_ENABLE_BIT_OFFSET    SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_dsppll_hifi_core_gated_START           //时钟使能位偏移
...
#define HCLK_USBOTG_ON_ENABLE_REG_ADDR     NULL    /* 使能寄存器地址转定义宏 */
#define HCLK_USBOTG_ON_ENABLE_BIT_OFFSET   0  /* 时钟使能位偏移 */
...
#define CLK_TS_ENABLE_REG_ADDR     NULL   /* 使能寄存器地址转定义宏 */
#define CLK_TS_ENABLE_BIT_OFFSET   0  /* 时钟使能位偏移 */

#define HCLK_TS_ENABLE_REG_ADDR     NULL    /* 使能寄存器地址转定义宏 */
#define HCLK_TS_ENABLE_BIT_OFFSET   0  /* 时钟使能位偏移 */
