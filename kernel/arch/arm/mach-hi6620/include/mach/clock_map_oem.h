...
#define CLK_NFC_ENABLE_REG_ADDR SOC_SCTRL_SC_PERIPH_CLKEN8_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_NFC_ENABLE_BIT_OFFSET   SOC_SCTRL_SC_PERIPH_CLKEN8_periph_clken8_tcxo_pad1_START   /* 时钟使能位偏移 */	
