...
/******************************************************************************/
/*asm 头文件需要定义, GIC*/
#define ACPU_SCU_BASE                       (SOC_ACPU_A9_private_BASE_ADDR)
#define ACPU_GIC_ICC_BASE                   (SOC_ACPU_A9_private_BASE_ADDR + 0x100)
#define ACPU_GIC_DIST_BASE                  (SOC_ACPU_A9_private_BASE_ADDR + 0x1000)
...
#define PWRCTRL_ACPU_PD_IPC_REG             PWRCTRL_SOC_IPC_CPU_RAW_INT_ADDR(SOC_IPC_S_BASE_ADDR, 2)
#define PWRCTRL_ACPU_PD_IPC_BIT             (BIT(16))
...
/*asm 头文件需要定义,AO*/
#define PWRCTRL_SOC_AO_SCTRL_SC_RESERVED32_ADDR(base)         ((base) + (0x3A4))
#define PWRCTRL_ACPU0_L2CACHE_FLUSH_FLAG	PWRCTRL_SOC_AO_SCTRL_SC_RESERVED32_ADDR(SOC_SC_ON_BASE_ADDR)
