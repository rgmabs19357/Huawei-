...
/* clk_nfc 基本信息，包括clock宏名、频率、最小频率，最大频率 */
#define CLK_NFC_DIV_MAX 	1
#define CLK_NFC_MIN_RATE 	19200000/CLK_NFC_DIV_MAX	//时钟最小频率宏定义
#define CLK_NFC_MAX_RATE 	19200000	//时钟最大频率宏定义
#define CLK_NFC_RATE 		CLK_NFC_MIN_RATE		//时钟频率宏定义
