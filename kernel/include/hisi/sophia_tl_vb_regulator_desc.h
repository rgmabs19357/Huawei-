 ...
 ******************************************************************************
  ...
  文 件 名   : sophia_tl_vb_regulator_desc.h
  生成日期   : 2014年5月7日
  
******************************************************************************/


#ifndef __SOPHIA_TL_VB_REGULATOR_DESC_H__
#define __SOPHIA_TL_VB_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_sophia_tl_vb[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
