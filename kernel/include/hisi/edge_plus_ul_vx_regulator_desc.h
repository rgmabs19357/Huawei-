 ...
 ******************************************************************************
  ...
  文 件 名   : edge_plus_ul_vx_regulator_desc.h
  生成日期   : 2014年5月7日
  
******************************************************************************/


#ifndef __EDGE_PLUS_UL_VX_REGULATOR_DESC_H__
#define __EDGE_PLUS_UL_VX_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_edge_plus_ul_vx[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
