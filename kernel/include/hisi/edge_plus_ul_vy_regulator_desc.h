 ...
 ******************************************************************************
  ...
  文 件 名   : edge_plus_ul_vy_regulator_desc.h
  生成日期   : 2014年5月7日
  
******************************************************************************/


#ifndef __EDGE_PLUS_UL_VY_REGULATOR_DESC_H__
#define __EDGE_PLUS_UL_VY_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_edge_plus_ul_vy[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
