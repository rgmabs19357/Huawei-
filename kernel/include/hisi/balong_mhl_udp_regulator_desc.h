 ...
 ******************************************************************************
  ...
  文 件 名   : balong_mhl_udp_regulator_desc.h
  生成日期   : 2014年5月7日
  
******************************************************************************/


#ifndef __BALONG_MHL_UDP_REGULATOR_DESC_H__
#define __BALONG_MHL_UDP_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_balong_mhl_udp[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
