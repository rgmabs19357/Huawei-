 ...
 ******************************************************************************
  ...
  文 件 名   : balong_lpddr3_udp_dcm_rf_regulator_desc.h
  生成日期   : 2014年5月7日
  
******************************************************************************/


#ifndef __BALONG_LPDDR3_UDP_DCM_RF_REGULATOR_DESC_H__
#define __BALONG_LPDDR3_UDP_DCM_RF_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_balong_lpddr3_udp_dcm_rf[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
