 ...
 ******************************************************************************
  ...
  文 件 名   : oscar_cg_vc_regulator_desc.h
  生成日期   : 2014年5月7日
  
******************************************************************************/


#ifndef __OSCAR_CG_VC_REGULATOR_DESC_H__
#define __OSCAR_CG_VC_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_oscar_cg_vc[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
