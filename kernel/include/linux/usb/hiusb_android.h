...
void usb_soft_connect(void);/* add by hisi-balong */
void usb_soft_disconnect(void);/* add by hisi-balong */
#else
#define PER_RST_EN_1_ADDR           (IO_ADDRESS(REG_BASE_SC_OFF + 0x08C))
#define PER_RST_DIS_1_ADDR          (IO_ADDRESS(REG_BASE_SC_OFF + 0x090))
#define PER_RST_STATUS_1_ADDR       (IO_ADDRESS(REG_BASE_SC_OFF + 0x094))

#define IP_RST_HSICPHY              (1 << 25)
#define IP_RST_PICOPHY              (1 << 24)
#define IP_RST_NANOPHY              (1 << 23)

#define PER_RST_EN_3_ADDR           (IO_ADDRESS(REG_BASE_SC_OFF + 0x0A4))
#define PER_RST_DIS_3_ADDR          (IO_ADDRESS(REG_BASE_SC_OFF + 0x0A8))
#define PER_RST_STATUS_3_ADDR       (IO_ADDRESS(REG_BASE_SC_OFF + 0xAC))
...
#define PER_CLK_EN_1_ADDR           (IO_ADDRESS(REG_BASE_SC_OFF + 0x30))
#define PER_CLK_DIS_1_ADDR          (IO_ADDRESS(REG_BASE_SC_OFF + 0x34))
#define PER_CLK_EN_STATUS_1_ADDR    (IO_ADDRESS(REG_BASE_SC_OFF + 0x38))
#define PER_CLK_STATUS_1_ADDR       (IO_ADDRESS(REG_BASE_SC_OFF + 0x3C))
...
#define PER_CLK_EN_3_ADDR           (IO_ADDRESS(REG_BASE_SC_OFF + 0x50))
#define PER_CLK_DIS_3_ADDR          (IO_ADDRESS(REG_BASE_SC_OFF + 0x54))
#define PER_CLK_EN_STATUS_3_ADDR    (IO_ADDRESS(REG_BASE_SC_OFF + 0x58))
#define PER_CLK_STATUS_3_ADDR       (IO_ADDRESS(REG_BASE_SC_OFF + 0x5C))
