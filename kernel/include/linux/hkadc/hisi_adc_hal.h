 ...
 * Version:     V200
 * Filename:    hisi_adc_hal.h
 * Description: hisi_adc_hal.h
 * History:     
*******************************************************************************/
#include <linux/semaphore.h>
#include <linux/spinlock_types.h>

#ifndef __HISI_ADC_HAL_H
#define __HISI_ADC_HAL_H
...
void hisi_adc_set_pmu(unsigned char addr, unsigned char write_reg,unsigned char mask);
void hisi_adc_get_pmu(unsigned char addr, unsigned char *read_reg);
#endif