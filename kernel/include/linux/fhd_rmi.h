...
#define RMI_RO_ATTR_1 (S_IWUGO_1 | S_IRUGO)
 ...
 * registered to the bus using the fhd_rmi_register_function_driver() call.
 *
 */
...
/**
 * fhd_rmi_register_driver - register rmi driver
...
/**
 * fhd_rmi_unregister_driver - unregister rmi driver
...
/**
 * fhd_rmi_register_phys_device - register a physical device connection
...
/**
 * fhd_rmi_unregister_phys_device - unregister a physical device connection
...
/**
 * fhd_rmi_register_function_driver - register an RMI function driver
...
/**
 * fhd_rmi_unregister_function_driver - unregister an RMI function driver
...
/**
 * fhd_rmi_get_function_handler - get a pointer to specified RMI function
...
void fhd_u8_set_bit(u8 *target, int pos);
void fhd_u8_clear_bit(u8 *target, int pos);
bool fhd_u8_is_set(u8 *target, int pos);
bool fhd_u8_is_any_set(u8 *target, int size);
void fhd_u8_or(u8 *dest, u8* target1, u8* target2, int size);
void fhd_u8_and(u8 *dest, u8* target1, u8* target2, int size);
#endif
