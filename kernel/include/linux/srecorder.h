...
#define BOOT_LOG_START_TAG "\n==== KENRL LOG START ====\n"
#define BOOT_LOG_END_TAG "\n==== KENRL LOG END ====\n"
...
#define BOOT_SUCCESSFULLY (0x900db007)
#define BOOT_FAILED (0xdcfa1ded)
...
/* the size of this struct is 256 bytes */
typedef struct
{
    ...
    unsigned long log_buf;
    unsigned long log_buf_len;
    unsigned long boot_successfully_this_time;
    logcat_buf_info logcat_buf_info[LOGCAT_TYPE_MAX];
    unsigned long crc32;
    unsigned char reserved[184];
