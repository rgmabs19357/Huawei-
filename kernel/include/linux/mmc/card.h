...
#define MIN_PACKED_WRITES 3
#define MIN_PACKED_READS 5
#define MAX_PACKED_WRITES 63
#define MAX_PACKED_READS 63
	u8			max_packed_writes; /* 500 */
	u8			max_packed_reads; /* 501 */
};
