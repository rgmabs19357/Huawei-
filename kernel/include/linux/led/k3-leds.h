...
#define DR_LED_CTRL   (0xd6) /* DR3,4,5 control registers */
#define DR_OUT_CTRL   (0xD7) /* DR3,4,5 out_put control registers */

#define DR3_ISET      (0xD8) /* DR3 current select */
#define DR3_START_DEL (0xD9) /* dr3 start delay */
#define DR3_TIM_CONF0 (0xDA) /* dr3 delay_on and delay_off */
#define DR3_TIM_CONF1 (0xDB) /* dr3  rise and fall */

#define DR4_ISET      (0xDC) /* DR4 current select */
#define DR4_START_DEL (0xDD) /* dr4 start delay */
#define DR4_TIM_CONF0 (0xDE) /* dr4 delay_on and delay_off */
#define DR4_TIM_CONF1 (0xDF) /* dr4  rise and fall */

#define DR5_ISET      (0xE0)  /* DR4 current select */
#define DR5_START_DEL (0xE1)  /* dr5 start delay */
#define DR5_TIM_CONF0 (0xE2) /* dr5 delay_on and delay_off */
#define	DR5_TIM_CONF1 (0xE3) /* dr5  rise and fall */
...
#define	DR_BRIGHTNESS_HALF	0x0  /* dr3,4,5 half_brightness config */
#define	DR_BRIGHTNESS_FULL	0x3  /* dr3,4,5 full_brightness config */
