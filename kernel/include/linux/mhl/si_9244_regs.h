 ...
 */
 ...
 #ifndef SII_9244_REGS
 #define SII_9244_REGS
...
/* Write REG data written.*/
#define	MSC_INT2_REQ_WRITE_MSC  	(0x01 << 0)
/* Retry threshold exceeded for sending the Heartbeat*/
#define	MSC_INT2_HEARTBEAT_MAXFAIL	(0x01 << 1)
/* only for WRITE_BURST*/
#define	REG_MSC_WRITE_BURST_LEN         (0x20)
/* Periodic heart beat. TX sends GET_REV_ID MSC command*/
